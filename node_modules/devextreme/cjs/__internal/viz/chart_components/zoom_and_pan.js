/**
 * DevExtreme (cjs/__internal/viz/chart_components/zoom_and_pan.js)
 * Version: 25.2.3
    ...
    init() {
        ...
        function setLastWheelTimer() {
            ...
            lastWheelTimer = setTimeout((() => {
                lastWheelTimer = void 0
            }), SCROLL_PREVENTION_TIMEOUT)
        }

        function preventDefaults(e) {
            let stopChartHandler = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : true;
            if (false !== e.cancelable) {
                e.preventDefault();
                e.stopPropagation()
            }
        ...
        const zoomAndPan = {
            ...
            cleanup() {
                ...
                null === (_zoomAndPan$actionDat = zoomAndPan.actionData) || void 0 === _zoomAndPan$actionDat || null === (_zoomAndPan$actionDat = _zoomAndPan$actionDat.rect) || void 0 === _zoomAndPan$actionDat || _zoomAndPan$actionDat.dispose();
                zoomAndPan.actionData = null;
                renderer.root.css({
                    "touch-action": ""
                })
            ...
            panningVisualRangeEnabled: () => isAxisAvailablePanning(chart._valueAxes) || isAxisAvailablePanning(chart._argumentAxes)
        };
