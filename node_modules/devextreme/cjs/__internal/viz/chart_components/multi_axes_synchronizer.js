/**
 * DevExtreme (cjs/__internal/viz/chart_components/multi_axes_synchronizer.js)
 * Version: 25.2.3
...
const linearConverter = br => ({
    transform: (v, b) => (0, _math2.adjust)((0, _utils.getLogExt)(v, b, br.allowNegatives, br.linearThreshold)),
    getTicks(interval, tickValues, base) {
        const ticks = [];
...
const logConverter = br => ({
    transform: (v, b) => (0, _math2.adjust)((0, _utils.raiseToExt)(v, b, br.allowNegatives, br.linearThreshold)),
    getTicks(interval, tickValues, base) {
        const ticks = [];
        let tick;
...
const multiAxesSynchronizer = {
    synchronize(valueAxes) {
        (0, _iterator.each)(getValueAxesPerPanes(valueAxes), ((_, axes) => {
            if (axes.length <= 1) {
                return
            }
