/**
 * DevExtreme (cjs/__internal/viz/core/utils.js)
 * Version: 25.2.3
...
const patchFontOptions = function(options) {
    const fontOptions = {};
    (0, _iterator.each)(options || {}, ((key, value) => {
...
function normalizePanesHeight(panes) {
    panes.forEach((pane => {
        ...
        if ((0, _type.isString)(height) && height.includes("px") || (0, _type.isNumeric)(height) && height > 1) {
            parsedHeight = _round(parsedHeight);
            unit = 1
        }
        if (!unit && parsedHeight) {
            if ((0, _type.isString)(height) && height.includes("%")) {
                parsedHeight /= 100;
                unit = 2
...
function getLogExt(value, base) {
    ...
    return (0, _math.adjust)((0, _math.sign)(value) * transformValue, Number((base ** (linearThreshold - 1)).toFixed(abs(linearThreshold))))
}
...
function raiseToExt(value, base) {
    ...
    return (0, _math.adjust)((0, _math.sign)(value) * transformValue, Number((base ** linearThreshold).toFixed(abs(linearThreshold))))
}
