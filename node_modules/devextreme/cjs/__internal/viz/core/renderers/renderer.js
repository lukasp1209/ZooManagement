/**
 * DevExtreme (cjs/__internal/viz/core/renderers/renderer.js)
 * Version: 25.2.3
...
var _animation = require("../../../viz/core/renderers/animation");
...
function removeExtraAttrs(html) {
    ...
    return html.replace(/(?:(<[a-z0-9]+\s*))([\s\S]*?)(>|\/>)/gi, ((allTagAttrs, p1, p2, p3) => {
...
SvgElement.prototype = {
    ...
    toBackground() {
        ...
        null === parent || void 0 === parent || parent.insertBefore(elem, parent.firstChild);
        return this
    },
    toForeground() {
        const elem = this.element;
        const parent = elem.parentNode;
        null === parent || void 0 === parent || parent.appendChild(elem);
        return this
    },
    attr(attrs) {
        return baseAttr(this, attrs)
    ...
    stopAnimation(disableComplete) {
        ...
        null === animation || void 0 === animation || animation.stop(disableComplete);
        return this
    },
    setTitle(text) {
...
Renderer.prototype = {
    ...
    _getPointsWithYOffset: (points, offset) => points.map(((point, index) => {
        if (index % 2 !== 0) {
            return point + offset
        }
        return point
