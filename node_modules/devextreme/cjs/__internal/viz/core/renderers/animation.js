/**
 * DevExtreme (cjs/__internal/viz/core/renderers/animation.js)
 * Version: 25.2.3
...
const easingFunctions = exports.easingFunctions = {
    easeOutCubic: (pos, start, end) => 1 === pos ? end : (1 - (1 - pos) ** 3) * (end - start) + +start,
    linear: (pos, start, end) => 1 === pos ? end : pos * (end - start) + +start
};
...
AnimationController.prototype = {
    _loop() {
        ...
        that._timerId = _frame.requestAnimationFrame.call(null, (() => {
            that._loop()
        }), that.element)
    },
