/**
 * DevExtreme (cjs/__internal/viz/core/export.js)
 * Version: 25.2.3
...
var _themes = require("../../../viz/themes");
...
function getRendererWrapper(width, height, backgroundColor) {
    const rendererContainer = (0, _renderer.default)("<div>").get(0);
    const renderer = new _renderer2.Renderer({
...
function validateFormat(format, incidentOccurred, validFormats) {
    ...
    if (-1 !== validFormats.unsupported.indexOf(format)) {
        null === incidentOccurred || void 0 === incidentOccurred || incidentOccurred("W2108", [format])
    }
}
...
let combineMarkups = function(widgets) {
    ...
    const exportItems = widgets.reduce(((r, row, rowIndex) => {
        const rowInfo = row.reduce(((r, item, colIndex) => {
            ...
            const node = (0, _renderer.default)(item.element()).find("svg").get(0).cloneNode(true);
...
const plugin = exports.plugin = {
    ...
    members: {
        ...
        exportTo(fileName, format) {
            ...
            null === menu || void 0 === menu || menu.hide();
            ...
            null === menu || void 0 === menu || menu.show();
            return promise
        },
        print() {
            const menu = this._exportMenu;
