/**
 * DevExtreme (cjs/__internal/viz/core/series_family.js)
 * Version: 25.2.3
...
function updateStackedSeriesValues() {
    ...
    (0, _iterator.each)(series, ((_, singleSeries) => {
        ...
        (0, _iterator.each)(singleSeries.getPoints(), ((index, point) => {
            if (!point.hasValue()) {
                return
            }
            let value = point.initialValue && point.initialValue.valueOf();
...
function updateRangeSeriesValues() {
    ...
    (0, _iterator.each)(series, ((_, singleSeries) => {
        ...
        if (minShownBusinessValue) {
            (0, _iterator.each)(singleSeries.getPoints(), ((_, point) => {
                if (!point.hasValue()) {
                    return
                }
...
function adjustBubbleSeriesDimensions() {
    ...
    let bubbleArea;
    let sizeProportion;
    (0, _iterator.each)(series, ((_, seriesItem) => {
        (0, _iterator.each)(seriesItem.getPoints(), ((_, point) => {
