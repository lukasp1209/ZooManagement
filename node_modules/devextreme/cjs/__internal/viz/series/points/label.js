/**
 * DevExtreme (cjs/__internal/viz/series/points/label.js)
 * Version: 25.2.3
...
var _display_format_parser = require("../../../viz/series/helpers/display_format_parser");
...
function getClosestCoord(point, coords) {
    ...
    let closestCoord;
    (0, _iterator.each)(coords, ((_, coord) => {
...
const barPointStrategy = {
    ...
    isHorizontal: (bBox, figure) => bBox.x > figure.x + figure.width || bBox.x + bBox.width < figure.x,
    getFigureCenter: figure => [_floor(figure.x + figure.width / 2), _floor(figure.y + figure.height / 2)],
...
const symbolPointStrategy = {
    ...
    isHorizontal: (bBox, figure) => bBox.x > figure.x + figure.r || bBox.x + bBox.width < figure.x - figure.r,
...
const piePointStrategy = {
    ...
    prepareLabelPoints(bBox, rotatedBBox, isHorizontal, angle) {
        ...
        if (0 === angle) {
            ...
            points = points.map((pair => pair.map((point => [_round((point[0] - xc) * cosSin.cos + (point[1] - yc) * cosSin.sin + xc), _round(-(point[0] - xc) * cosSin.sin + (point[1] - yc) * cosSin.cos + yc)])))).reduce(((r, pair) => {
    ...
    isHorizontal: (bBox, figure) => bBox.x > figure.x || figure.x > bBox.x + bBox.width,
