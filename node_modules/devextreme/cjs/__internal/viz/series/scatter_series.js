/**
 * DevExtreme (cjs/__internal/viz/series/scatter_series.js)
 * Version: 25.2.3
...
function variance(array, expectedValue) {
    return sum((0, _utils.map)(array, (value => (value - expectedValue) * (value - expectedValue)))) / array.length
}
...
const baseScatterMethods = {
    ...
    groupPointsByCoords(rotated) {
        const cat = [];
        (0, _iterator.each)(this.getVisiblePoints(), ((_, p) => {
    ...
    _animate() {
        ...
        (0, _iterator.each)(that._drawnPoints || [], ((i, p) => {
    ...
    _calculateErrorBars(data) {
        ...
        switch (errorBarType) {
            ...
            case UNDEFINED:
                ...
                break;
            default:
                valueArray = (0, _utils.map)(data, (item => (0, _type.isDefined)(item.data[valueField]) ? item.data[valueField] : null));
    ...
    _patchMarginOptions(options) {
        ...
        const maxSize = [styles.normal, styles.hover, styles.selection].reduce(((max, style) => _max(max, 2 * style.r + style["stroke-width"])), 0);
...
exports.chart = chart = (0, _extend2.extend)({}, baseScatterMethods, {
    drawTrackers() {
        ...
        if (segments.length) {
            ...
            (0, _iterator.each)(segments, ((i, segment) => {
                if (!trackers[i]) {
...
exports.polar = polar = (0, _extend2.extend)({}, baseScatterMethods, {
    drawTrackers() {
        ...
        if (!this.isVisible()) {
            return
        }(0, _iterator.each)(cat, ((i, category) => {
            if (category) {
                index = i;
                return false
            }
