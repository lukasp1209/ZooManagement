/**
 * DevExtreme (cjs/__internal/viz/range_selector/tracker.js)
 * Version: 25.2.3
...
function initializeAreaEvents(controller, area, state, getRootOffsetLeft) {
    ...
    area.on(_pointer.default.down, (e => {
...
function initializeSliderEvents(controller, sliders, state, getRootOffsetLeft) {
    ...
    (0, _iterator.each)(sliders, ((i, slider) => {
        slider.on({
...
function Tracker(params) {
    ...
    (0, _iterator.each)(this._docEvents, ((_, events) => {
