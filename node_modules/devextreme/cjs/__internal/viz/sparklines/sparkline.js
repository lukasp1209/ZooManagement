/**
 * DevExtreme (cjs/__internal/viz/sparklines/sparkline.js)
 * Version: 25.2.3
...
var _base_sparkline = _interopRequireDefault(require("../../viz/sparklines/base_sparkline"));
...
function parseNumericDataSource(data, argField, valField, ignoreEmptyPoints) {
    return (0, _utils.map)(data, ((dataItem, index) => {
        let item = null;
        let isDataNumber;
        let value;
        if (void 0 !== dataItem) {
...
function parseWinlossDataSource(data, argField, valField, target) {
    return (0, _utils.map)(data, (dataItem => {
        const item = {};
...
(0, _utils.map)(["lossColor", "lineColor", "lineWidth", "areaOpacity", "minColor", "maxColor", "barPositiveColor", "barNegativeColor", "winColor", "lessColor", "firstLastColor", "pointSymbol", "pointColor", "pointSize", "type", "argumentField", "valueField", "winlossThreshold", "showFirstLast", "showMinMax", "ignoreEmptyPoints", "minValue", "maxValue"], (name => {
