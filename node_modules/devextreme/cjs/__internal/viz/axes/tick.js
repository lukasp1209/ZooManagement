/**
 * DevExtreme (cjs/__internal/viz/axes/tick.js)
 * Version: 25.2.3
...
function createTick(axis, renderer, tickOptions, gridOptions, skippedCategory, skipLabels, offset) {
    ...
    return function(value) {
        const tick = {
            ...
            updateTickPosition(options, animate) {
            ...
            drawLabel(range, template) {
                ...
                if (templateOption) {
                    ...
                    this._templateDef = (0, _deferred.Deferred)();
                    template.render({
                        model: {
                            valueText: text,
                            value: this.value,
