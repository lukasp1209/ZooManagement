/**
 * DevExtreme (cjs/__internal/viz/axes/tick_generator.js)
 * Version: 25.2.3
...
function discreteGenerator(options) {
    return function(data, screenDelta, tickInterval, forceTickInterval) {
        ...
        } = (0, _utils.getCategoriesInfo)(data.categories, data.min, data.max);
        return {
            ticks: categories,
...
function getMultiplierFactor(interval, factorDelta) {
    return 10 ** (mathFloor((0, _utils.getLogExt)(interval, 10)) + (factorDelta || 0))
}
