/**
 * DevExtreme (cjs/__internal/viz/axes/base_axis.js)
 * Version: 25.2.3
...
var _constant_line = _interopRequireDefault(require("../../viz/axes/constant_line"));
var polarMethods = _interopRequireWildcard(require("../../viz/axes/polar_axes"));
var _smart_formatter = require("../../viz/axes/smart_formatter");
var _strip = _interopRequireDefault(require("../../viz/axes/strip"));
var _tick = require("../../viz/axes/tick");
var _tick_generator = require("../../viz/axes/tick_generator");
var _xy_axes = _interopRequireDefault(require("../../viz/axes/xy_axes"));
var _parse_utils = require("../../viz/components/parse_utils");
...
Axis.prototype = {
    ...
    _drawConstantLineLabelText(text, x, y, _ref2, group) {
        let {
            font: font,
            cssClass: cssClass
        } = _ref2;
    ...
    dispose() {
        [this._axisElementsGroup, this._axisStripGroup, this._axisGroup].forEach((g => {
            g.dispose()
        }));
    ...
    createTicks(canvas) {
        ...
        const minors = (ticks.minorTicks || []).filter((minor => !boundaryTicks.some((boundary => (0, _utils.valueOf)(boundary) === (0, _utils.valueOf)(minor)))));
    ...
    _shouldCorrectValuesToZero(minValue, maxValue) {
        if (this.isArgumentAxis || "datetime" === this._options.dataType) {
            return false
        }
    ...
    draw(canvas, borderOptions) {
        ...
        that._templatesRendered = (0, _deferred.Deferred)();
    ...
    getFullTicks() {
        ...
        if (this._options.type === _axes_constants.default.discrete) {
            ...
            return convertTicksToValues(majors.concat(this._minorTicks, this._boundaryTicks)).sort(((a, b) => (0, _utils.valueOf)(a) - (0, _utils.valueOf)(b)))
        }
    },
    ...
    _createTranslator: () => new _translator2d.Translator2D({}, {}, {}),
    _updateTranslator() {
        const translator = this._translator;
