/**
 * DevExtreme (cjs/__internal/viz/translators/translator2d.js)
 * Version: 25.2.3
...
var _category_translator = _interopRequireDefault(require("../../viz/translators/category_translator"));
var _datetime_translator = _interopRequireDefault(require("../../viz/translators/datetime_translator"));
var _interval_translator = _interopRequireDefault(require("../../viz/translators/interval_translator"));
var _logarithmic_translator = _interopRequireDefault(require("../../viz/translators/logarithmic_translator"));
...
const validateCanvas = function(canvas) {
    (0, _iterator.each)(CANVAS_PROP, ((_, prop) => {
...
_Translator2d.prototype = {
    ...
    _prepareCanvasOptions() {
        ...
        canvasOptions.rangeDoubleError = 10 ** ((0, _utils.getPower)(canvasOptions.rangeMax - canvasOptions.rangeMin) - (0, _utils.getPower)(length) - 2);
    ...
    checkMinBarSize: (value, minShownValue) => _abs(value) < minShownValue ? value >= 0 ? minShownValue : -minShownValue : value,
