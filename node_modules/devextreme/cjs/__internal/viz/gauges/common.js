/**
 * DevExtreme (cjs/__internal/viz/gauges/common.js)
 * Version: 25.2.3
...
var _base_gauge = require("../../viz/gauges/base_gauge");
...
const dxGauge = exports.dxGauge = _base_gauge.BaseGauge.inherit({
    ...
    _renderContent() {
        ...
        const elements = (0, _utils.map)([that._rangeContainer].concat(that._prepareValueIndicators()), (element => element && element.enabled ? element : null));
    ...
    _createSubvalueIndicatorsSet() {
        ...
        return new ValueIndicatorsSet({
            createIndicator: (type, i) => that._createIndicator(type, root, "dxg-subvalue-indicator", "subvalue-indicator", i),
            createPalette: palette => that._themeManager.createPalette(palette)
        })
    },
...
ValueIndicatorsSet.prototype = {
    ...
    render(options, isRecreate) {
        ...
        if (that.enabled) {
            ...
            that._indicators = (0, _utils.map)(that._indicators, ((indicator, i) => {
                if (isRecreate) {
                    indicator.dispose();
    ...
    values(arg, _noAnimation) {
        ...
        return (0, _utils.map)(that._indicators, (indicator => indicator.value()))
    }
};
