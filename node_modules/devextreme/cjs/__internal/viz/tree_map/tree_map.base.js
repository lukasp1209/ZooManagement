/**
 * DevExtreme (cjs/__internal/viz/tree_map/tree_map.base.js)
 * Version: 25.2.3
...
const dxTreeMap = _m_base_widget.default.inherit({
    _handlers: {
        ...
        calculateState: options => (0, _common2.buildRectAppearance)(options)
    },
    ...
    _applyTilesAppearance() {
        const colorizer = (0, _colorizing2.getColorizer)(this._getOption("colorizer"), this._themeManager, this._topNode);
        this._processNodes({
    ...
    _performTiling() {
        const context = {
            algorithm: (0, _tiling2.getAlgorithm)(this._getOption("layoutAlgorithm", true)),
