...
if (null !== _globalize.default && void 0 !== _globalize.default && _globalize.default.formatDate) {
    ...
    const globalizeDateLocalization = {
        ...
        _getFormatStringByPath: path => _globalize.default.locale().main(`dates/calendars/gregorian/${path}`),
        ...
        getTimeSeparator: () => _globalize.default.locale().main("numbers/symbols-numberSystem-latn/timeSeparator"),
        ...
        parse(text, format) {
            ...
            if (!format || "function" === typeof format || (0, _m_type.isObject)(format) && !this._isAcceptableFormat(format)) {
                if (format) {
