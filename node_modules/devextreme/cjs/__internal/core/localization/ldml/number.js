/**
 * DevExtreme (cjs/__internal/core/localization/ldml/number.js)
 * Version: 25.2.3
...
function formatNumberPart(format, valueString) {
    return format.split("'").map(((formatPart, escapeIndex) => {
...
function getFormatter(format, config) {
    ...
    return value => {
        ...
        if (isPercentFormat(numberFormat)) {
            value = (0, _m_math.multiplyInExponentialForm)(value, PERCENT_EXPONENT_SHIFT)
        }
        if (!isPositive) {
            value = -value
        }
        ...
        const floatPrecision = (0, _m_math.fitIntoRange)(maxFloatPrecision, 0, MAXIMUM_NUMBER_LENGTH - integerLength);
