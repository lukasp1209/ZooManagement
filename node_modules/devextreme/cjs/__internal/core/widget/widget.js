...
class Widget extends _dom_component.default {
    ...
    _innerWidgetOptionChanged(innerWidget, args) {
        ...
        if (fullName.indexOf(".") > -1) {
            ...
            null === innerWidget || void 0 === innerWidget || innerWidget.option(innerWidgetOptionName, value)
        } else {
            null === innerWidget || void 0 === innerWidget || innerWidget.option(value)
        }
    ...
    _toggleFocusClass(isFocused, $element) {
        ...
        null === $focusTarget || void 0 === $focusTarget || $focusTarget.toggleClass(FOCUSED_STATE_CLASS, isFocused)
    }
    ...
    _cleanFocusState() {
        ...
        null === $element || void 0 === $element || $element.removeAttr("tabIndex");
    ...
    _hover($el, $previous) {
        ...
        null === (_$previous = $previous) || void 0 === _$previous || _$previous.toggleClass(HOVER_STATE_CLASS, false);
        if ($el && hoverStateEnabled && !disabled && !isActive) {
            const newHoveredElement = this._findHoverTarget($el);
            null === newHoveredElement || void 0 === newHoveredElement || newHoveredElement.toggleClass(HOVER_STATE_CLASS, true)
        }
    }
