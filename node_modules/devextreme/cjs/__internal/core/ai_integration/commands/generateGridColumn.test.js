...
(0, _globals.describe)("GenerateGridColumnCommand", (() => {
    ...
    (0, _globals.describe)("execute", (() => {
        ...
        (0, _globals.it)("promptManager.buildPrompt should should return prompt with passed values", (() => {
            ...
            command.execute(params, callbacks);
            const expectedUserPrompt = null === (_templates$generateGr = _templates.templates.generateGridColumn.user) || void 0 === _templates$generateGr ? void 0 : _templates$generateGr.replace("{{text}}", USER_TEXT).replace("{{data}}", PROCESSED_DATA);
