/**
 * DevExtreme (cjs/__internal/core/ai_integration/commands/shorten.test.js)
 * Version: 25.2.3
...
(0, _globals.describe)("ShortenCommand", (() => {
    const params = {
    ...
    (0, _globals.beforeEach)((() => {
        ...
        command = new _commands.ShortenCommand(promptManager, requestManager)
    }));
    (0, _globals.describe)("getTemplateName", (() => {
        (0, _globals.it)("should return the name of the corresponding template", (() => {
            ...
            (0, _globals.expect)(templateName).toBe("shorten")
        }))
    }));
    ...
    (0, _globals.describe)("execute", (() => {
        ...
        (0, _globals.it)("promptManager.buildPrompt should be called with parameters containing the passed values", (() => {
            ...
            (0, _globals.expect)(promptManager.buildPrompt).toHaveBeenCalledWith("shorten", {
                user: {
                    text: params.text
                }
            })
