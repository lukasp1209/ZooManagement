/**
 * DevExtreme (cjs/__internal/core/ai_integration/commands/changeStyle.test.js)
 * Version: 25.2.3
...
(0, _globals.describe)("ChangeStyleCommand", (() => {
    const params = {
    ...
    (0, _globals.beforeEach)((() => {
        ...
        command = new _commands.ChangeStyleCommand(promptManager, requestManager)
    }));
    (0, _globals.describe)("getTemplateName", (() => {
        (0, _globals.it)("should return the name of the corresponding template", (() => {
            ...
            (0, _globals.expect)(templateName).toBe("changeStyle")
        }))
    }));
    ...
    (0, _globals.describe)("parseResult", (() => {
        (0, _globals.it)("should return the string without changes", (() => {
            ...
            (0, _globals.expect)(result).toBe("Shorten text")
        }))
    }));
    (0, _globals.describe)("execute", (() => {
        ...
        (0, _globals.it)("promptManager.buildPrompt should be called with parameters containing the passed values", (() => {
            ...
            (0, _globals.expect)(promptManager.buildPrompt).toHaveBeenCalledWith("changeStyle", {
                system: {
                    writingStyle: params.writingStyle
                },
                user: {
