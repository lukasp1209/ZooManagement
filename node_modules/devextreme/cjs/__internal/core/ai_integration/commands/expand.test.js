/**
 * DevExtreme (cjs/__internal/core/ai_integration/commands/expand.test.js)
 * Version: 25.2.3
...
(0, _globals.describe)("ExpandCommand", (() => {
    const params = {
    ...
    (0, _globals.beforeEach)((() => {
        ...
        command = new _commands.ExpandCommand(promptManager, requestManager)
    }));
    (0, _globals.describe)("getTemplateName", (() => {
        (0, _globals.it)("should return the name of the corresponding template", (() => {
            ...
            (0, _globals.expect)(templateName).toBe("expand")
        }))
    }));
    ...
    (0, _globals.describe)("parseResult", (() => {
        (0, _globals.it)("should return the string without changes", (() => {
            const result = command.parseResult("Expanded text");
            (0, _globals.expect)(result).toBe("Expanded text")
        }))
    }));
    (0, _globals.describe)("execute", (() => {
        ...
        (0, _globals.it)("promptManager.buildPrompt should be called with parameters containing the passed values", (() => {
            ...
            (0, _globals.expect)(promptManager.buildPrompt).toHaveBeenCalledWith("expand", {
                user: {
                    text: params.text
                }
            })
