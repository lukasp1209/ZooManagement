/**
 * DevExtreme (cjs/__internal/core/ai_integration/commands/execute.test.js)
 * Version: 25.2.3
...
(0, _globals.describe)("ExecuteCommand", (() => {
    const params = {
    ...
    (0, _globals.beforeEach)((() => {
        ...
        command = new _commands.ExecuteCommand(promptManager, requestManager)
    }));
    (0, _globals.describe)("getTemplateName", (() => {
        (0, _globals.it)("should return the name of the corresponding template", (() => {
            ...
            (0, _globals.expect)(templateName).toBe("execute")
        }))
    }));
    ...
    (0, _globals.describe)("parseResult", (() => {
        (0, _globals.it)("should return the string without changes", (() => {
            const result = command.parseResult("Executed text");
            (0, _globals.expect)(result).toBe("Executed text")
        }))
    }));
    (0, _globals.describe)("execute", (() => {
        ...
        (0, _globals.it)("promptManager.buildPrompt should be called with parameters containing the passed values", (() => {
            ...
            (0, _globals.expect)(promptManager.buildPrompt).toHaveBeenCalledWith("execute", {
                user: {
                    text: params.text
                }
            })
