...
const GroupingHeaderPanelExtender = Base => class extends((0, _m_column_context_menu_mixin.ColumnContextMenuMixin)(Base)) {
    _getToolbarItems() {
    ...
    _columnOptionChanged(e) {
        if (!this._requireReady && !_m_core.default.checkChanges(e.optionNames, ["width", "visibleWidth"])) {
            ...
            const $groupPanel = null === $toolbarElement || void 0 === $toolbarElement ? void 0 : $toolbarElement.find(`.${_const.CLASSES.groupPanel}`);
    ...
    getColumnElements() {
        ...
        return null === $element || void 0 === $element ? void 0 : $element.find(`.${_const.CLASSES.groupPanelItem}`)
    }
    getColumns() {
    ...
    getBoundingRect() {
        const $element = this.element();
        if (null !== $element && void 0 !== $element && $element.find(`.${_const.CLASSES.groupPanel}`).length) {
