...
function isHideableColumn(column) {
    const isGroup = ((null === column || void 0 === column ? void 0 : column.groupIndex) ?? -1) >= 0;
    return true === column.visible && (!(0, _type.isDefined)(column.type) || HIDEABLE_COMMAND_COLUMNS.includes(column.type)) && !column.fixed && !isGroup
}
