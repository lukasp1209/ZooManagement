...
const getColumnWidths = columns => columns.map((column => {
    ...
    return (0, _m_type.isNumeric)(width) ? parseFloat(width) : 50
}));
...
var _default = exports.default = {
    ...
    getDisplayValue(column, value, data, rowType) {
        ...
        const isCalculatedFromLookup = column.lookup && column.type !== _const.AI_COLUMN_NAME && ("group" !== rowType || !column.calculateGroupValue && !column.calculateDisplayValue);
