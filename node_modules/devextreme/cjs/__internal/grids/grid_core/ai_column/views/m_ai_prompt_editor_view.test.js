/**
 * DevExtreme (cjs/__internal/grids/grid_core/ai_column/views/m_ai_prompt_editor_view.test.js)
 * Version: 25.2.3
...
(0, _globals.describe)("AIPromptEditorView", (() => {
        ...
        (0, _globals.describe)("show", (() => {
            (0, _globals.it)("should create new AIPromptEditor instance", (async () => {
                const {
                    ...
                    aiPromptEditorView: aiPromptEditorView,
                    aiPromptEditorPOM: aiPromptEditorPOM
                } = createAIPromptEditorView();
    ...
    (0, _globals.describe)("event handlers in AIPromptEditor config", (() => {
        (0, _globals.describe)("onSubmit", (() => {
            ...
            (0, _globals.it)("should not trigger loading state when prompt has not changed", (async () => {
                const {
                    cellElement: cellElement,
                    aiPromptEditorView: aiPromptEditorView,
                    aiPromptEditorPOM: aiPromptEditorPOM
                ...
                aiPromptEditorPOM.getApplyButton().getElement().click();
                (0, _globals.expect)(aiPromptEditorView.getPromptEditorInstance().updateStateOnAction).not.toHaveBeenCalled();
                (0, _globals.expect)(mockColumnsController.columnOption).not.toHaveBeenCalled()
            }));
            (0, _globals.it)("should trigger loading state only when prompt has changed", (async () => {
                const {
                    cellElement: cellElement,
                    aiPromptEditorView: aiPromptEditorView,
                    aiPromptEditorPOM: aiPromptEditorPOM
                ...
                aiPromptEditorPOM.getApplyButton().getElement().click();
                (0, _globals.expect)(aiPromptEditorView.getPromptEditorInstance().updateStateOnAction).toHaveBeenCalledWith("apply");
                (0, _globals.expect)(mockColumnsController.columnOption).toHaveBeenCalledWith(2, "ai.prompt", "new prompt", true)
            }))
        }));
