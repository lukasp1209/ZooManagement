...
class AIPromptEditorView extends _m_modules.View {
    ...
    show(cellElement, column) {
        ...
        if (!(null !== $cellElement && void 0 !== $cellElement && $cellElement.length) || (null === column || void 0 === column ? void 0 : column.type) !== _const.AI_COLUMN_NAME) {
    ...
    aiColumnOptionChanged(column, optionName, value) {
        ...
        if (isPromptOptionName && ((0, _utils.isAIColumnAutoMode)(column) || null !== (_this$promptEditorIns6 = this.promptEditorInstance) && void 0 !== _this$promptEditorIns6 && _this$promptEditorIns6.isApplying())) {
