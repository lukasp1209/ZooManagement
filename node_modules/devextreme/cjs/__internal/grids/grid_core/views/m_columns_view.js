...
const subscribeToRowEvents = function(that, $table) {
    ...
    _events_engine.default.on($table, "touchstart touchend", ".dx-row", (e => {
        var _e$event;
        if (null !== e && void 0 !== e && null !== (_e$event = e.event) && void 0 !== _e$event && _e$event.target && !_m_utils.default.isElementInCurrentGrid(that, (0, _renderer.default)(e.event.target))) {
            return
        }
    ...
    _events_engine.default.on($table, [_click.name, _double_click.name, _pointer.default.down].join(" "), ".dx-row", that.createAction((e => {
        ...
        if (null !== e && void 0 !== e && null !== (_e$event2 = e.event) && void 0 !== _e$event2 && _e$event2.target && !_m_utils.default.isElementInCurrentGrid(that, (0, _renderer.default)(event.target))) {
            return
        }
        if (touchTarget) {
