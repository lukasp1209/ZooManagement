...
class ColumnsController extends _m_modules.default.Controller {
    getCommonColumnSettings(column) {
        switch (true) {
            case !(null !== column && void 0 !== column && column.type):
                return this.option("commonColumnSettings");
            case (null === column || void 0 === column ? void 0 : column.type) === _const.AI_COLUMN_NAME:
    ...
    _updateRequireResize(args) {
        ...
        if ("width" === args.fullName.replace(_const3.COLUMN_OPTION_REGEXP, "") && component._updateLockCount) {
    ...
    getExpandColumns() {
        ...
        expandColumns = (0, _iterator.map)(expandColumns, (column => (0, _extend.extend)({}, Object.assign({}, column, {
            ownerBand: void 0
        }), {
            visibleWidth: null,
            minWidth: null,
    ...
    _createCalculatedColumnOptions(columnOptions, bandColumn) {
        ...
        if (columnOptions.lookup && columnOptions.type !== _const.AI_COLUMN_NAME) {
    ...
    getRowIndex(columnIndex, alwaysGetRowIndex) {
        ...
        const bandColumnsCache = this.getBandColumnsCache();
        return (0, _m_columns_controller_utils.getParentBandColumns)(columnIndex, bandColumnsCache.columnParentByIndex).length
    }
