...
var _utils = require("../../../grids/grid_core/columns_resizing_reordering/utils");
...
class DraggingHeaderView extends _m_modules.default.View {
    ...
    updateDragElement() {
        ...
        }).addClass(this.addWidgetPrefix("drag-action"));
    ...
    _getDraggingPanelByPos(pos) {
        let result;
        (0, _iterator.each)(this._dragOptions.draggingPanelBoundingRects, ((_, _ref) => {
            let {
    ...
    _generatePointsByColumns() {
        ...
        if (cells && cells.length > 0) {
            that._pointsByColumns = _m_utils.default.getPointsByColumns(cells, (point => that._pointCreated((point => {
                ...
                return point
            })(point), columns, cells)), false, 0, needToCheckPrevPoint)
        }
    }
...
class DraggingHeaderViewController extends _m_modules.default.ViewController {
    ...
    _generatePointsByColumns(options) {
        ...
        const points = _m_utils.default.getPointsByColumns(options.columnElements, (point => this._pointCreated({
            point: point,
