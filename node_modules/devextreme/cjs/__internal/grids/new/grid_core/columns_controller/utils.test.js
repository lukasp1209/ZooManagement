/**
 * DevExtreme (cjs/__internal/grids/new/grid_core/columns_controller/utils.test.js)
 * Version: 25.2.3
...
(0, _globals.describe)("getVisibleIndexes", (() => {
    (0, _globals.it)("should create visible indexes if not present", (() => {
        (0, _globals.expect)((0, _utils.getVisibleIndexes)([void 0, void 0, void 0, void 0])).toEqual([0, 1, 2, 3])
    }));
    ...
    (0, _globals.it)("should fill in missing indexes", (() => {
        (0, _globals.expect)((0, _utils.getVisibleIndexes)([3, void 0, 0, void 0])).toEqual([3, 1, 0, 2])
    }))
}));
