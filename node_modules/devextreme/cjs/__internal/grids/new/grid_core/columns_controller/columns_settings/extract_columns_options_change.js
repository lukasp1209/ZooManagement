...
const extractColumnsOptionsChange = _ref => {
    ...
    switch (true) {
        ...
        case 1 === updatePath.length && Array.isArray(value):
            return {
                type: "allColumns", value: value ?? null
            };
        case 2 === updatePath.length && (0, _utils.isAllowedColumnValue)(value) && (0, _utils.isCorrectColumnIdx)(updatePath[1]):
            return {
                type: "column", columnIdx: (0, _utils.getColumnIdxFromPath)(updatePath), value: value
            };
        case updatePath.length > 2 && (0, _utils.isCorrectColumnIdx)(updatePath[1]):
            return {
                type: "columnOption", columnIdx: (0, _utils.getColumnIdxFromPath)(updatePath), optionPath: (0, _utils.getColumnOptionPathStr)(updatePath), value: value
            };
        default:
            return null
    }
