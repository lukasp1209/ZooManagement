/**
 * DevExtreme (cjs/__internal/grids/new/grid_core/column_chooser/view.test.js)
 * Version: 25.2.3
    ...
    (0, _globals.describe)("View", (() => {
        ...
        (0, _globals.describe)("Select mode", (() => {
            (0, _globals.it)("popup has correct css classes", (() => {
                ...
                (0, _globals.expect)(null === popup || void 0 === popup ? void 0 : popup.content().classList).toContain(CLASS.list);
                (0, _globals.expect)(null === popup || void 0 === popup ? void 0 : popup.content().classList).toContain(CLASS.plain);
                (0, _globals.expect)(null === wrapperElement || void 0 === wrapperElement ? void 0 : wrapperElement.classList).toContain(CLASS.root);
                (0, _globals.expect)(null === wrapperElement || void 0 === wrapperElement ? void 0 : wrapperElement.classList).toContain(CLASS.selectMode)
            }))
        }));
        (0, _globals.describe)("Drag mode", (() => {
            (0, _globals.it)("popup has correct css classes", (() => {
                ...
                (0, _globals.expect)(null === popup || void 0 === popup ? void 0 : popup.content().classList).toContain(CLASS.list);
                (0, _globals.expect)(null === overlayElement || void 0 === overlayElement ? void 0 : overlayElement.classList).toContain(CLASS.root);
                (0, _globals.expect)(null === overlayElement || void 0 === overlayElement ? void 0 : overlayElement.classList).toContain(CLASS.dragMode)
            }))
        }))
    }))
}));
