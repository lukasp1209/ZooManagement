...
class AccessibilityController {
    constructor(columnsController, dataController) {
        ...
        this.description = (0, _index.computed)((() => _message.default.format("dxCardView-ariaCardView", this.dataController.totalCount.value, this.columnsController.visibleColumns.value.length)));
