/**
 * DevExtreme (cjs/__internal/grids/new/grid_core/filtering/header_filter/utils.test.js)
 * Version: 25.2.3
...
`.it("should take into account allowFiltering and allowHeaderFiltering", (_ref6 => {
            ...
            (0, _jestEach.default)`
      column                                                      | expectedResult
      ${Object.assign({},allowFilteringColumnConfig,{filterValues:[]})}                                                          | ${false}
      ${Object.assign({},allowFilteringColumnConfig,{filterValues:[1,2,3]})}                                                          | ${true}
      ${Object.assign({},allowFilteringColumnConfig,{filterValues:null})}                                                          | ${false}
      ${Object.assign({},allowFilteringColumnConfig,{filterValues:"test"})}                                                          | ${true}
      ${Object.assign({},allowFilteringColumnConfig,{filterValues:[null]})}                                                          | ${true}
