/**
 * DevExtreme (cjs/__internal/grids/new/grid_core/filtering/filter_sync/__intergation__/index.js)
 * Version: 25.2.3
...
Object.keys(_date_type).forEach((function(key) {
    ...
    if (key in exports && exports[key] === _date_type[key]) {
        return
    }
...
Object.keys(_number_type).forEach((function(key) {
    ...
    if (key in exports && exports[key] === _number_type[key]) {
        return
    }
    Object.defineProperty(exports, key, {
        enumerable: true,
...
Object.keys(_string_type).forEach((function(key) {
    ...
    if (key in exports && exports[key] === _string_type[key]) {
        return
    }
    Object.defineProperty(exports, key, {
        enumerable: true,
