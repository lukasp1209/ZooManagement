...
const getHeaderItemText = (displayValue, column, currentLevel, headerFilterOptions) => {
...
const getDataSourceOptions = (storeLoadAdapter, popupOptions, headerFilterOptions, filter) => {
    ...
    options.dataSource.postProcess = data => {
        let items = data;
        items = (null === origPostProcess || void 0 === origPostProcess ? void 0 : origPostProcess.call(void 0, items)) || items;
