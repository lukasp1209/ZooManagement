...
const getSortIndexA11yLabel = (sortOrder, sortIndex) => sortOrder && (0, _type.isDefined)(sortIndex) ? _message.default.format(_const.I18N_KEYS.sortIndex, sortIndex + 1) : null;
exports.getSortIndexA11yLabel = getSortIndexA11yLabel;
const getHeaderItemA11yLabel = (columnName, _ref) => {
    let {
        sortOrder: sortOrder,
        sortIndex: sortIndex,
        hasHeaderFilterValue: hasHeaderFilterValue
    } = _ref;
