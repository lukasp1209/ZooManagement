/**
 * DevExtreme (cjs/__internal/exporter/exceljs/export_merged_ranges_manager.js)
 * Version: 25.2.3
...
class MergedRangesManager {
    ...
    isCellInMergedRanges(rowIndex, cellIndex) {
        ...
        return null === (_this$mergedCells$row = this.mergedCells[rowIndex]) || void 0 === _this$mergedCells$row ? void 0 : _this$mergedCells$row[cellIndex]
    }
