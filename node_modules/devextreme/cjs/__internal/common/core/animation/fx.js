/**
 * DevExtreme (cjs/__internal/common/core/animation/fx.js)
 * Version: 25.2.3
        ...
        config.frameAnimation = {
            ...
            draw() {
                ...
                if (currentValue.transform) {
                    currentValue.transform = (0, _iterator.map)(currentValue.transform, ((value, prop) => {
                        if ("translate" === prop) {
...
const FallbackToNoAnimationStrategy = {
    initAnimation() {},
    animate: () => (new _deferred.Deferred).resolve().promise(),
    stop: _common.noop,
    isSynchronous: true
};
...
const isStringConfigValidator = function(config, animationType) {
    return baseConfigValidator(config, animationType, (target => "string" === typeof target), "a string")
};
...
const PopAnimationConfigurator = {
    ...
    _getCssTransform: (translate, scale) => `${(0,_translator.getTranslateCss)(translate)}scale(${scale})`
};
...
const startAnimationOnElement = function() {
    ...
    return animation.strategy.animate($element, config).done((() => {
