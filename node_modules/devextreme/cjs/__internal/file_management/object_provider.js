...
class ObjectFileSystemProvider extends _provider_base.default {
    ...
    _findFileItemObj(pathInfo) {
        ...
        for (let i = 0; i < pathInfo.length && (0 === i || fileItemObj); i += 1) {
            ...
            if (fileItemObj) {
                ...
                currentPath = (0, _utils.pathCombine)(currentPath, null === (_this$_nameGetter4 = this._nameGetter) || void 0 === _this$_nameGetter4 ? void 0 : _this$_nameGetter4.call(this, fileItemObj));
    ...
    _getKeyFromDataObject(dataObj, defaultKeyPrefix) {
        ...
        const relativeName = (0, _utils.pathCombine)(defaultKeyPrefix, null === (_this$_nameGetter5 = this._nameGetter) || void 0 === _this$_nameGetter5 ? void 0 : _this$_nameGetter5.call(this, dataObj));
