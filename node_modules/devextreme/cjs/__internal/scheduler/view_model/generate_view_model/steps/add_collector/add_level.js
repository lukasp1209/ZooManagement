/**
 * DevExtreme (cjs/__internal/scheduler/view_model/generate_view_model/steps/add_collector/add_level.js)
 * Version: 25.2.3
...
const addLevel = (entities, _ref) => {
    ...
    return entities.map((entity => {
        ...
        if (isIntersectWithPrevious) {
            ...
            stack.push(extended);
            stack.forEach((item => {
                item.maxLevel = -1 === maxLevel ? levelsEndDate.length : between(levelsEndDate.length, minMaxLevel, maxLevel);
