/**
 * DevExtreme (cjs/__internal/scheduler/view_model/generate_view_model/options/get_minutes_cell_intervals.test.js)
 * Version: 25.2.3
...
(0, _globals.describe)("getMinutesCellIntervals", (() => {
    (0, _globals.it)("should return cells in range of [startDayHour, endDayHour] for timeline interval", (() => {
        (0, _globals.expect)((0, _get_minutes_cell_intervals.getMinutesCellIntervals)({
            intervals: [{
    ...
    (0, _globals.it)("should return cells in range of [0, 24] for timeline interval", (() => {
        (0, _globals.expect)((0, _get_minutes_cell_intervals.getMinutesCellIntervals)({
            intervals: [{
    ...
    (0, _globals.it)("should return cells in range of [startDayHour, endDayHour] for one day interval", (() => {
        (0, _globals.expect)((0, _get_minutes_cell_intervals.getMinutesCellIntervals)({
            intervals: [{
                min: Date.UTC(2021, 8, 26, 4),
                max: Date.UTC(2021, 8, 26, 16)
    ...
    (0, _globals.it)("should return cells in range of [0, 24] and skip days", (() => {
        (0, _globals.expect)((0, _get_minutes_cell_intervals.getMinutesCellIntervals)({
            intervals: [{
                min: Date.UTC(2021, 8, 26),
                max: Date.UTC(2021, 8, 28)
