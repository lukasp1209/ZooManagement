...
(0, _globals.describe)("getAppointmentRecurrenceOccurrences", (() => {
    ...
    (0, _globals.describe)("with recurrence rule", (() => {
        ...
        (0, _globals.it)("should return appointment occurrences for appointment with exceptions", (() => {
            const exception1 = (0, _base.getAsciiStringByDate)(new Date(Date.UTC(2e3, 0, 11, 10)));
            const exception2 = (0, _base.getAsciiStringByDate)(new Date(Date.UTC(2e3, 0, 12, 10)));
            const exception3 = (0, _base.getAsciiStringByDate)(new Date(Date.UTC(2e3, 0, 13, 10)));
            const appointment = {
                source: {
                    startDate: Date.UTC(2e3, 0, 9, 10),
                    endDate: Date.UTC(2e3, 0, 9, 11)
