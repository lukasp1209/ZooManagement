...
(0, _globals.describe)("replaceIncorrectEndDate", (() => {
    (0, _globals.it)("should process endDate correctly", (() => {
        ...
        (0, _globals.expect)((0, _replace_incorrect_end_date.replaceIncorrectEndDate)(items, 30, _appointment_data_accessor.mockAppointmentDataAccessor)).toEqual([Object.assign({}, items[0], {
    ...
    (0, _globals.it)("should return false for incorrect startDate", (() => {
        (0, _globals.expect)((0, _replace_incorrect_end_date.replaceIncorrectEndDate)([{}, {
            startDate: "Invalid date format"
        }], 30, _appointment_data_accessor.mockAppointmentDataAccessor)).toEqual([])
    }))
}));
