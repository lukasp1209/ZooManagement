...
class SchedulerWorkSpace extends _ui2.default {
    ...
    get cache() {
        if (!this._cache) {
            this._cache = new _global_cache.Cache
        }
        return this._cache
    }
    get resourceManager() {
    ...
    _getScrollCoordinates(hours, minutes, date, groupIndex, allDay) {
        ...
        return this.virtualScrollingDispatcher.calculateCoordinatesByDataAndPosition(null === cell || void 0 === cell ? void 0 : cell.cellData, null === cell || void 0 === cell ? void 0 : cell.position, currentDate, (0, _index3.isDateAndTimeView)(this.type), "vertical" === this.viewDirection)
    }
    ...
    _getSelectedCellsData() {
        ...
        return null === selected || void 0 === selected ? void 0 : selected.map(this._normalizeCellData.bind(this))
    }
    getCellData($cell) {
    ...
    getPanelDOMSize(panelName) {
        return "allDayPanel" === panelName ? this.cache.memo("allDayPanelSize", (() => (0, _position.getBoundingRect)(this._$allDayPanel.get(0)))) : this.cache.memo("regularPanelSize", (() => (0, _position.getBoundingRect)(this._getDateTable().get(0))))
    }
