/**
 * DevExtreme (cjs/__internal/scheduler/utils/resource_manager/appointment_color_utils.test.js)
 * Version: 25.2.3
...
(0, _globals.describe)("appointment color utils", (() => {
    (0, _globals.describe)("getPaintedResources", (() => {
        ...
        (0, _globals.it)("should return undefined for empty groups", (() => {
            const manager = (0, _resource_manager.getResourceManagerMock)();
            (0, _globals.expect)((0, _appointment_color_utils.getPaintedResource)(manager.resources, [], [])).toEqual(void 0)
        }));
        (0, _globals.it)("should return undefined for resource out of groups", (() => {
            const manager = (0, _resource_manager.getResourceManagerMock)();
            (0, _globals.expect)((0, _appointment_color_utils.getPaintedResource)(manager.resources, ["unknown"], [])).toEqual(void 0)
        }));
