/**
 * DevExtreme (cjs/__internal/scheduler/appointment_popup/m_legacy_form.js)
 * Version: 25.2.3
...
const validateAppointmentFormDate = (editor, value, previousValue) => {
    const isCurrentDateCorrect = null === value || Boolean(value);
    const isPreviousDateCorrect = null === previousValue || Boolean(previousValue);
