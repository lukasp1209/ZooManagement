...
class PopupModel {
    constructor(element) {
        ...
        this.setInputValue = (editorName, value) => {
            ...
            null === (_this$form$getEditor = this.form.getEditor(editorName)) || void 0 === _this$form$getEditor || _this$form$getEditor.option("value", value)
        };
        ...
        this.getLabelIdByText = labelText => {
            ...
            const label = labels.find((l => {
                var _l$textContent;
                return null === l || void 0 === l || null === (_l$textContent = l.textContent) || void 0 === _l$textContent || null === (_l$textContent = _l$textContent.trim()) || void 0 === _l$textContent ? void 0 : _l$textContent.startsWith(labelText)
            }));
            if (!label) {
        ...
        this.selectRadio = value => {
            ...
            const target = radios.find((radio => {
                ...
                const label = null === (_radio$getAttribute = radio.getAttribute("aria-label")) || void 0 === _radio$getAttribute ? void 0 : _radio$getAttribute.trim();
                const text = null === (_radio$textContent = radio.textContent) || void 0 === _radio$textContent ? void 0 : _radio$textContent.trim();
        ...
        this.getSelectedRadioValue = () => {
            ...
            return (null === selected || void 0 === selected ? void 0 : selected.getAttribute("aria-label")) ?? (null === selected || void 0 === selected || null === (_selected$textContent = selected.textContent) || void 0 === _selected$textContent ? void 0 : _selected$textContent.trim()) ?? null
        };
        ...
        this.openRecurrenceSettings = () => {
            ...
            const settingsButton = null === buttons || void 0 === buttons ? void 0 : buttons.find((btn => "settings" === btn.name));
            if (null !== settingsButton && void 0 !== settingsButton && null !== (_settingsButton$optio = settingsButton.options) && void 0 !== _settingsButton$optio && _settingsButton$optio.onClick) {
        ...
        this.openRecurrenceForm = function() {
            let freq = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "Daily";
