/**
 * DevExtreme (cjs/__internal/ui/form/components/field_item.js)
 * Version: 25.2.3
...
function renderFieldItem(_ref2) {
    ...
    const $validationTarget = getValidationTarget($fieldEditorContainer);
    const validationTargetInstance = null === $validationTarget || void 0 === $validationTarget ? void 0 : $validationTarget.data(VALIDATION_TARGET_CLASS);
