...
class Lookup extends _m_drop_down_list.default {
    ...
    _scrollToSelectedItem() {
        ...
        const {
            ...
            items: listItems
        } = (null === (_this$_list2 = this._list) || void 0 === _this$_list2 ? void 0 : _this$_list2.option()) ?? {};
        const itemsCount = listItems.length;
        if (0 !== itemsCount) {
            var _this$_list3, _this$_list6;
            if (null !== (_this$_list3 = this._list) && void 0 !== _this$_list3 && _this$_list3.option("grouped")) {
                var _this$_list4;
                null === (_this$_list4 = this._list) || void 0 === _this$_list4 || _this$_list4.scrollToItem({
                    group: itemsCount - 1,
                    item: listItems[itemsCount - 1].items.length - 1
                })
            } else {
                var _this$_list5;
                null === (_this$_list5 = this._list) || void 0 === _this$_list5 || _this$_list5.scrollToItem(itemsCount - 1)
            }
            null === (_this$_list6 = this._list) || void 0 === _this$_list6 || _this$_list6.scrollToItem(selectedIndex)
        }
    }
    ...
    _getPopupHeight() {
        var _this$_list7;
        if (null !== (_this$_list7 = this._list) && void 0 !== _this$_list7 && _this$_list7.itemElements().length) {
            return this._calculateListHeight(this.option("grouped")) + (this._$searchWrapper ? (0, _size.getOuterHeight)(this._$searchWrapper) : 0) + (this._popup.bottomToolbar() ? (0, _size.getOuterHeight)(this._popup.bottomToolbar()) : 0) + (this._popup.topToolbar() ? (0, _size.getOuterHeight)(this._popup.topToolbar()) : 0)
        }
        return "auto"
    }
    ...
    _renderPopup() {
        ...
        null === (_this$_popup$$wrapper = this._popup.$wrapper()) || void 0 === _this$_popup$$wrapper || _this$_popup$$wrapper.addClass("dx-lookup-popup-wrapper")
    }
    _renderPopover() {
    ...
    _filterDataSource() {
        if (this._list && !this._list._dataSource && this._isMinSearchLengthExceeded()) {
            var _this$_list8;
            null === (_this$_list8 = this._list) || void 0 === _this$_list8 || _this$_list8._scrollView.startLoading()
        }
    ...
    _dataSourceFiltered() {
        ...
        null === (_this$_list9 = this._list) || void 0 === _this$_list9 || _this$_list9._scrollView.finishLoading()
    }
    ...
    _toggleSearchClass(isSearchEnabled) {
        if (this._popup) {
            ...
            null === (_this$_popup$$wrapper2 = this._popup.$wrapper()) || void 0 === _this$_popup$$wrapper2 || _this$_popup$$wrapper2.toggleClass("dx-lookup-popup-search", isSearchEnabled)
        }
    }
    ...
    _setFocusPolicy() {
        ...
        this._runWithoutCloseOnScroll((() => {
            if (this.option("searchEnabled")) {
                ...
                var _this$_list10;
                null === (_this$_list10 = this._list) || void 0 === _this$_list10 || _this$_list10.focus()
            }
        }))
    }
    _focusTarget() {
    ...
    _selectListItem(itemData, target) {
        var _this$_list11;
        null === (_this$_list11 = this._list) || void 0 === _this$_list11 || _this$_list11.selectItem(target);
        const {
            applyValueMode: applyValueMode
        } = this.option();
    ...
    _currentSelectedItem() {
        var _this$_list12;
        return this.option("grouped") ? this._list.option("selectedItems[0]").items[0] : null === (_this$_list12 = this._list) || void 0 === _this$_list12 ? void 0 : _this$_list12.option("selectedItems[0]")
    }
    _resetValue(e) {
        this._saveValueChangeEvent(e.event);
