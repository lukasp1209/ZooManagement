/**
 * DevExtreme (cjs/__internal/ui/scroll_view/scrollable.simulated.js)
 * Version: 25.2.3
...
class SimulatedStrategy {
    ...
    _validateMove(e) {
        ...
        if (!scrollByContent && !(0, _renderer.default)(e.target).closest(".dx-scrollable-scrollbar").length) {
            return false
        }
