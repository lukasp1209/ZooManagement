/**
 * DevExtreme (cjs/__internal/ui/scroll_view/scrollable.native.js)
 * Version: 25.2.3
...
class NativeStrategy {
    ...
    _renderScrollbar(direction) {
        ...
        this._scrollbars[direction] = new _scrollbar.default((0, _renderer.default)("<div>").appendTo(this._$element), {
            direction: direction,
