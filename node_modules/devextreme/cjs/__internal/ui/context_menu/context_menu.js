...
class ContextMenu extends _menu_base.default {
    ...
    _itemContainer() {
        var _this$_overlay;
        return (null === (_this$_overlay = this._overlay) || void 0 === _this$_overlay ? void 0 : _this$_overlay.$content()) ?? (0, _renderer.default)()
    }
    _eventBindingTarget() {
    ...
    itemsContainer() {
        var _this$_overlay2;
        return (null === (_this$_overlay2 = this._overlay) || void 0 === _this$_overlay2 ? void 0 : _this$_overlay2.$content()) ?? (0, _renderer.default)()
    }
    _supportedKeys() {
    ...
    _isTargetOutOfComponent(relatedTarget) {
        const isInsideContextMenu = 0 !== (0, _renderer.default)(relatedTarget).closest(`.${DX_CONTEXT_MENU_CLASS}`).length;
    ...
    _getItemsContainers() {
        var _this$_overlay3;
        return (null === (_this$_overlay3 = this._overlay) || void 0 === _this$_overlay3 || null === (_this$_overlay3 = _this$_overlay3.$content()) || void 0 === _this$_overlay3 ? void 0 : _this$_overlay3.find(".dx-menu-items-container")) ?? (0, _renderer.default)()
    }
    ...
    _setOverlayMaxHeight($subMenu) {
        ...
        null === (_this$_overlay4 = this._overlay) || void 0 === _this$_overlay4 || _this$_overlay4.option({
            maxHeight: () => {
    ...
    _setSubmenuVisible($submenu) {
        ...
        const $item = null === $submenu || void 0 === $submenu ? void 0 : $submenu.closest(`.${DX_MENU_ITEM_CLASS}`);
        this._setSubMenuHeight($submenu, $item);
    ...
    _drawSubmenu($itemElement) {
        ...
        if (null !== (_this$_overlay5 = this._overlay) && void 0 !== _this$_overlay5 && _this$_overlay5.option("visible")) {
    ...
    _updateSubmenuVisibilityOnClick(actionArgs) {
        ...
        if (0 === $submenu.length) {
            ...
            if (!actionArgs.canceled && null !== (_this$_overlay6 = this._overlay) && void 0 !== _this$_overlay6 && _this$_overlay6.option("visible")) {
    ...
    _hideAllShownSubmenus() {
        var _this$_overlay7;
        const shownSubmenus = (0, _extend.extend)([], this._shownSubmenus);
        const $expandedItems = (null === (_this$_overlay7 = this._overlay) || void 0 === _this$_overlay7 || null === (_this$_overlay7 = _this$_overlay7.$content()) || void 0 === _this$_overlay7 ? void 0 : _this$_overlay7.find(`.${DX_MENU_ITEM_EXPANDED_CLASS}`)) ?? (0, _renderer.default)();
        $expandedItems.removeClass(DX_MENU_ITEM_EXPANDED_CLASS);
    ...
    _show(event) {
        ...
        if (position) {
            ...
            if (!this._overlay) {
                ...
                null === (_this$_overlay$$conte = this._overlay.$content()) || void 0 === _this$_overlay$$conte || _this$_overlay$$conte.addClass(this._widgetClass());
                this._renderFocusState();
                this._attachHoverEvents();
                this._attachClickEvent();
                this._renderItems(this._dataAdapter.getRootNodes())
            }
            const $subMenu = (0, _renderer.default)(null === (_this$_overlay8 = this._overlay) || void 0 === _this$_overlay8 ? void 0 : _this$_overlay8.content()).children(".dx-submenu");
            this._setOptionWithoutOptionChange("visible", true);
            null === (_this$_overlay9 = this._overlay) || void 0 === _this$_overlay9 || _this$_overlay9.option({
    ...
    _renderItems(nodes, submenuContainer) {
        ...
        const $submenu = (0, _renderer.default)(null === (_this$_overlay10 = this._overlay) || void 0 === _this$_overlay10 ? void 0 : _this$_overlay10.content()).children(".dx-submenu");
        if ($submenu.length) {
            this._initScrollable($submenu)
        }
    }
    _setAriaAttributes() {
        var _this$_overlay11;
        this._overlayContentId = `dx-${new _guid.default}`;
        this.setAria("owns", this._overlayContentId);
        this.setAria({
            id: this._overlayContentId,
            role: "menu"
        }, null === (_this$_overlay11 = this._overlay) || void 0 === _this$_overlay11 ? void 0 : _this$_overlay11.$content())
    }
    ...
    _getTarget() {
        ...
        return target || (null === position || void 0 === position ? void 0 : position.of) || (0, _renderer.default)(_dom_adapter.default.getDocument())
    }
