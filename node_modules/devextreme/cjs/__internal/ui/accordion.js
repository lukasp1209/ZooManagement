...
class Accordion extends _collection_widget.default {
    ...
    _updateItems(addedSelection, removedSelection) {
        ...
        iteratorUtils.each(addedSelection, ((_i, addedIndex) => {
            ...
            null === (_this$_deferredItems$ = this._deferredItems[addedIndex]) || void 0 === _this$_deferredItems$ || _this$_deferredItems$.resolve();
            const $item = $items.eq(addedIndex).addClass("dx-accordion-item-opened").removeClass("dx-accordion-item-closed");
            this.setAria("hidden", false, $item.find(".dx-accordion-item-body"))
        }));
        iteratorUtils.each(removedSelection, ((_i, removedIndex) => {
            const $item = $items.eq(removedIndex).removeClass("dx-accordion-item-opened");
    ...
    _splitFreeSpace(freeSpace) {
        ...
        if (!freeSpace || !(null !== selectedItems && void 0 !== selectedItems && selectedItems.length)) {
            return freeSpace
        }
