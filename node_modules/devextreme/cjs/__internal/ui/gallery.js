/**
 * DevExtreme (cjs/__internal/ui/gallery.js)
 * Version: 25.2.3
...
class Gallery extends _collection_widget.default {
    ...
    _renderItemSizes(startIndex) {
        ...
        $items.each(((_index, element) => {
            (0, _size.setOuterWidth)((0, _renderer.default)(element), 100 * itemWidth + "%");
            return true
        }))
    }
    _renderItemPositions() {
        ...
        this._itemElements().each(((index, item) => {
            let realIndex = index;
            const isLoopItem = (0, _renderer.default)(item).hasClass("dx-gallery-item-loop");
            ...
            if (!isLoopItem && 0 !== realIndex) {
                if (isGapBetweenImages) {
                    (0, _renderer.default)(item).css(`margin${side}`, 100 * freeSpace + "%")
                }
                return true
            }
            ...
            (0, _renderer.default)(item).css(property, 100 * itemPosition + "%");
            return true
        }));
    ...
    _renderIndicator() {
        ...
        this._$indicator = (0, _renderer.default)("<div>").addClass("dx-gallery-indicator").appendTo(this._$wrapper);
        const {
            indicatorEnabled: indicatorEnabled
        } = this.option();
        for (let i = 0; i < this._pagesCount(); i += 1) {
            const $indicatorItem = (0, _renderer.default)("<div>").addClass("dx-gallery-indicator-item").appendTo(this._$indicator);
            if (indicatorEnabled) {
    ...
    _toggleIndicatorInteraction(clickEnabled) {
        ...
        const $indicatorItems = (null === (_this$_$indicator = this._$indicator) || void 0 === _this$_$indicator ? void 0 : _this$_$indicator.find(".dx-gallery-indicator-item")) ?? (0, _renderer.default)();
