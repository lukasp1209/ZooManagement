...
class CollectionWidget extends _widget.default {
    ...
    _attachClickEvent() {
        ...
        _events_engine.default.on(this._itemContainer(), pointerDownEventNamespace, itemSelector, (e => {
            pointerDownAction.execute({
                element: (0, _renderer.default)(e.target),
                event: e
            })
        }));
        _events_engine.default.on(this._itemContainer(), pointerUpEventNamespace, itemSelector, (e => {
    ...
    _setAttributes($element) {
        const {
            _itemAttributes: _itemAttributes
        } = this.option();
    ...
    _renderEmptyMessage(rootNodes) {
        ...
        if (!hideNoData) {
            ...
            const {
                encodeNoDataText: encodeNoDataText
            } = this.option();
            if (encodeNoDataText) {
