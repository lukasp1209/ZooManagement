/**
 * DevExtreme (cjs/__internal/ui/file_manager/ui.file_manager.file_actions_button.js)
 * Version: 25.2.3
...
class FileManagerFileActionsButton extends _widget.default {
    _initMarkup() {
    ...
    _raiseClick(e) {
        ...
        null === (_this$_clickAction = this._clickAction) || void 0 === _this$_clickAction || _this$_clickAction.call(this, e)
    }
    _getDefaultOptions() {
    ...
    setActive(active) {
        ...
        setTimeout((() => {
            var _this$_button;
            return null === (_this$_button = this._button) || void 0 === _this$_button ? void 0 : _this$_button.$element().toggleClass("dx-state-active", active)
        }))
    }
}
