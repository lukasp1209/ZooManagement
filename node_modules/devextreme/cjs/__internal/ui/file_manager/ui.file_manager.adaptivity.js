...
class FileManagerAdaptivityControl extends _widget.default {
    ...
    _createDrawerTemplate(container) {
        ...
        this._splitter = this._createComponent("<div>", _splitter_control.default, {
            ...
            leftElement: (0, _renderer.default)(null === (_this$_drawer = this._drawer) || void 0 === _this$_drawer ? void 0 : _this$_drawer.content()),
            rightElement: (0, _renderer.default)(null === (_this$_drawer2 = this._drawer) || void 0 === _this$_drawer2 ? void 0 : _this$_drawer2.viewContent()),
    ...
    _onApplyPanelSize(e) {
        ...
        if (!(null !== (_this$_splitter = this._splitter) && void 0 !== _this$_splitter && _this$_splitter.isSplitterMoved())) {
            ...
            return
        }(0, _renderer.default)(null === (_this$_drawer3 = this._drawer) || void 0 === _this$_drawer3 ? void 0 : _this$_drawer3.content()).removeClass(DRAWER_PANEL_CONTENT_INITIAL);
    ...
    _setDrawerWidth(width) {
        ...
        (0, _renderer.default)(null === (_this$_drawer4 = this._drawer) || void 0 === _this$_drawer4 ? void 0 : _this$_drawer4.content()).css("width", width);
        this._updateDrawerMaxSize();
    ...
    _checkAdaptiveState() {
        ...
        if (oldState !== this._isInAdaptiveState) {
            ...
            (0, _renderer.default)(null === (_this$_drawer7 = this._drawer) || void 0 === _this$_drawer7 ? void 0 : _this$_drawer7.content()).toggleClass(DRAWER_PANEL_CONTENT_ADAPTIVE, this._isInAdaptiveState);
