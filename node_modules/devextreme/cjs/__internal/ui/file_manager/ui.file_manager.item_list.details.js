/**
 * DevExtreme (cjs/__internal/ui/file_manager/ui.file_manager.item_list.details.js)
 * Version: 25.2.3
...
var _uiFile_manager2 = _interopRequireDefault(require("../../ui/file_manager/ui.file_manager.file_actions_button"));
var _uiFile_manager3 = _interopRequireDefault(require("../../ui/file_manager/ui.file_manager.item_list"));
...
class FileManagerDetailsItemList extends _uiFile_manager3.default {
    _initMarkup() {
        this._itemCount = 0;
    ...
    _onContextMenuPreparing(e) {
        ...
        const eventArgs = (0, _extend.extend)({}, {
            targetElement: "content" === e.target && (0, _type.isDefined)(e.row) ? null === (_this$_filesView4 = this._filesView) || void 0 === _this$_filesView4 ? void 0 : _this$_filesView4.getRowElement(e.rowIndex) : void 0,
            itemData: item,
    ...
    _createNameColumnCell(container, cellInfo) {
        ...
        this._createComponent($button, _uiFile_manager2.default, {
