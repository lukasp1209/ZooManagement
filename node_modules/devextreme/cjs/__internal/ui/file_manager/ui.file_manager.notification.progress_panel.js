/**
 * DevExtreme (cjs/__internal/ui/file_manager/ui.file_manager.notification.progress_panel.js)
 * Version: 25.2.3
...
class FileManagerProgressPanel extends _widget.default {
    _initMarkup() {
        super._initMarkup();
        this._initActions();
    ...
    addOperation(commonText, showCloseButtonAlways, allowProgressAutoUpdate) {
        if (this._operationCount) {
            ...
            null === (_this$_$infosContaine = this._$infosContainer) || void 0 === _this$_$infosContaine || _this$_$infosContaine.empty()
        }
    ...
    _raiseOperationClosed(info) {
        ...
        null === (_this$_actions$onOper = (_this$_actions = this._actions).onOperationClosed) || void 0 === _this$_actions$onOper || _this$_actions$onOper.call(_this$_actions, {
            info: info
        })
    }
    _raiseOperationCanceled(info) {
        var _this$_actions$onOper2, _this$_actions2;
        null === (_this$_actions$onOper2 = (_this$_actions2 = this._actions).onOperationCanceled) || void 0 === _this$_actions$onOper2 || _this$_actions$onOper2.call(_this$_actions2, {
            info: info
        })
    }
    _raiseOperationItemCanceled(item, itemIndex) {
        var _this$_actions$onOper3, _this$_actions3;
        null === (_this$_actions$onOper3 = (_this$_actions3 = this._actions).onOperationItemCanceled) || void 0 === _this$_actions$onOper3 || _this$_actions$onOper3.call(_this$_actions3, {
            item: item,
            itemIndex: itemIndex
        })
    }
    _raisePanelClosed() {
        ...
        null === (_this$_actions$onPane = (_this$_actions4 = this._actions).onPanelClosed) || void 0 === _this$_actions$onPane || _this$_actions$onPane.call(_this$_actions4)
    }
}
