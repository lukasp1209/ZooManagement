/**
 * DevExtreme (cjs/__internal/ui/file_manager/ui.file_manager.toolbar.js)
 * Version: 25.2.3
...
class FileManagerToolbar extends _widget.default {
    ...
    _configureItemByCommandName(commandName, item) {
        ...
        if (!(0, _type.isDefined)(null === (_result$options2 = result.options) || void 0 === _result$options2 ? void 0 : _result$options2.stylingMode)) {
            if ("dxButton" === result.widget) {
