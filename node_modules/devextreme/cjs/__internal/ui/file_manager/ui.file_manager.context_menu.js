/**
 * DevExtreme (cjs/__internal/ui/file_manager/ui.file_manager.context_menu.js)
 * Version: 25.2.3
...
class FileManagerContextMenu extends _widget.default {
    ...
    showAt(fileItems, element, event, target) {
        ...
        null === (_this$_contextMenu = this._contextMenu) || void 0 === _this$_contextMenu || _this$_contextMenu.option({
            target: element,
            position: position
        });
        null === (_this$_contextMenu2 = this._contextMenu) || void 0 === _this$_contextMenu2 || _this$_contextMenu2.show()
    }
    ...
    _isContextMenuItemAvailable(menuItem, fileItems) {
        ...
        if (this._isIsolatedCreationItemCommand(menuItem.name) && null !== fileItems && void 0 !== fileItems && fileItems.length) {
            return false
        }
        return null === (_this$_commandManager = this._commandManager) || void 0 === _this$_commandManager ? void 0 : _this$_commandManager.isCommandAvailable(menuItem.name, fileItems)
    }
    _isIsolatedCreationItemCommand(commandName) {
        const {
            isolateCreationItemCommands: isolateCreationItemCommands
        } = this.option();
        return ("create" === commandName || "upload" === commandName) && isolateCreationItemCommands
    }
    ...
    _createMenuItemByCommandName(commandName) {
        ...
        const {
            text: text,
            icon: icon
        } = (null === (_this$_commandManager2 = this._commandManager) || void 0 === _this$_commandManager2 ? void 0 : _this$_commandManager2.getCommandByName(commandName)) ?? {};
        const menuItem = {
            name: commandName,
            text: text,
            icon: icon
    ...
    _onContextMenuItemClick(commandName, args) {
        ...
        null === (_this$_actions = this._actions) || void 0 === _this$_actions || null === (_this$_actions$onItem = _this$_actions.onItemClick) || void 0 === _this$_actions$onItem || _this$_actions$onItem.call(_this$_actions, changedArgs);
        if (this._isDefaultItem(commandName)) {
            ...
            null === (_this$_commandManager3 = this._commandManager) || void 0 === _this$_commandManager3 || _this$_commandManager3.executeCommand(commandName, targetFileItems)
        }
    }
    _initActions() {
        this._actions = {
    ...
    _onContextMenuShowing(e) {
        ...
        null === (_this$_actions2 = this._actions) || void 0 === _this$_actions2 || null === (_this$_actions2$onCon = _this$_actions2.onContextMenuShowing) || void 0 === _this$_actions2$onCon || _this$_actions2$onCon.call(_this$_actions2, e);
        if (!e.cancel) {
            ...
            null === (_this$_contextMenu3 = this._contextMenu) || void 0 === _this$_contextMenu3 || _this$_contextMenu3.option("dataSource", items)
        }
    }
    tryUpdateVisibleContextMenu() {
        if (this._isVisible) {
            ...
            null === (_this$_contextMenu4 = this._contextMenu) || void 0 === _this$_contextMenu4 || _this$_contextMenu4.option("dataSource", items)
        }
    }
    _onContextMenuShown() {
    ...
    _onContextMenuHidden(preserveContext) {
        ...
        null === (_this$_contextMenu5 = this._contextMenu) || void 0 === _this$_contextMenu5 || _this$_contextMenu5.option("visible", false);
        this._raiseContextMenuHidden()
    }
    _raiseContextMenuHidden() {
        var _this$_actions3, _this$_actions3$onCon;
        null === (_this$_actions3 = this._actions) || void 0 === _this$_actions3 || null === (_this$_actions3$onCon = _this$_actions3.onContextMenuHidden) || void 0 === _this$_actions3$onCon || _this$_actions3$onCon.call(_this$_actions3)
    }
    _getDefaultOptions() {
        return Object.assign({}, super._getDefaultOptions(), {
            commandManager: void 0,
            onContextMenuHidden: void 0,
            onItemClick: void 0
        })
    }
    _optionChanged(args) {
