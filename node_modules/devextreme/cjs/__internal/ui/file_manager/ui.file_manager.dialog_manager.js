/**
 * DevExtreme (cjs/__internal/ui/file_manager/ui.file_manager.dialog_manager.js)
 * Version: 25.2.3
...
class FileManagerDialogManager {
    constructor($element, options) {
        ...
        this._renameItemDialog = new _uiFile_managerDialog3.default($renameDialog, (0, _extend.extend)(baseDialogOptions, {
        ...
        this._createItemDialog = new _uiFile_managerDialog3.default($createDialog, (0, _extend.extend)(baseDialogOptions, {
        ...
        this._deleteItemDialog = new _uiFile_managerDialog.default($deleteItemDialog, baseDialogOptions)
    }
