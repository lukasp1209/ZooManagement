...
class FileItemsController {
    ...
    abortFileUpload(fileData, chunksInfo, destinationDirectory) {
        ...
        return (0, _deferred.when)(null === (_this$_fileProvider8 = this._fileProvider) || void 0 === _this$_fileProvider8 ? void 0 : _this$_fileProvider8.abortFileUpload(fileData, chunksInfo, destinationDirectory))
    }
    ...
    downloadItems(itemInfos) {
        ...
        return (0, _deferred.when)(...deferreds).then((() => {
            ...
            return (0, _deferred.when)(this._getItemActionResult(null === (_this$_fileProvider10 = this._fileProvider) || void 0 === _this$_fileProvider10 ? void 0 : _this$_fileProvider10.downloadItems(items))).then((() => {}), (errorInfo => {
    ...
    getItemContent(itemInfos) {
        ...
        const items = itemInfos.map((i => i.fileItem));
        return (0, _deferred.when)(null === (_this$_fileProvider11 = this._fileProvider) || void 0 === _this$_fileProvider11 ? void 0 : _this$_fileProvider11.getItemsContent(items))
    }
