...
class NotificationManagerBase {
    ...
    _createProgressBox($container, options) {
        ...
        if (options.imageUrl) {
            ...
            null === (_getImageContainer = (0, _icon.getImageContainer)(options.imageUrl)) || void 0 === _getImageContainer || _getImageContainer.addClass("dx-filemanager-progress-box-image").appendTo($container)
        }
