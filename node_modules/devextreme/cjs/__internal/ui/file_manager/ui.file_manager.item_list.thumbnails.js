/**
 * DevExtreme (cjs/__internal/ui/file_manager/ui.file_manager.item_list.thumbnails.js)
 * Version: 25.2.3
...
var _uiFile_manager2 = _interopRequireDefault(require("../../ui/file_manager/ui.file_manager.item_list"));
var _uiFile_managerItems_listThumbnails = _interopRequireDefault(require("../../ui/file_manager/ui.file_manager.items_list.thumbnails.list_box"));
...
class FileManagerThumbnailsItemList extends _uiFile_manager2.default {
    _initMarkup() {
        ...
        const contextMenuEvent = (0, _utils.addNamespace)(_contextmenu.name, "dxFileManager_thumbnails");
