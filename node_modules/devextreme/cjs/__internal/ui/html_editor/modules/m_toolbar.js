...
if (_devextremeQuill.default) {
    ...
    ToolbarModule = class extends _m_base.default {
        ...
        _createCommandMenuItem(command, text, commandOptions) {
            const options = (null === commandOptions || void 0 === commandOptions ? void 0 : commandOptions.map(_capitalize.capitalize)) ?? (0, _ai.getDefaultOptionsByCommand)(command);
            const item = {
                id: command,
                name: command,
            ...
            const items = null === commands || void 0 === commands ? void 0 : commands.map((command => {
                if ("object" === typeof command) {
                    if ("custom" === command.name) {
                        ...
                        const capitalized = null === options || void 0 === options ? void 0 : options.map(_capitalize.capitalize);
                        const item = {
                            id: id,
                            name: "custom",
                            text: command.text,
        ...
        _prepareAIMenuItemConfig(item) {
            ...
            const {
                ...
                commands: commands = Object.keys(_ai.commandMessageKeys)
            } = item;
