...
function prepareAITextTrasformHandler(module) {
    return options => {
        ...
        const hasSelection = (null === selection || void 0 === selection ? void 0 : selection.length) > 0;
        ...
        promise.done((_ref6 => {
            ...
            switch (insertionMode) {
                case "replace":
                    ...
                    quill.deleteText(insertIndex, hasSelection ? selection.length : quill.getLength(), "silent");
                    break;
                case "insertAbove":
                    insertIndex = hasSelection ? selection.index : 0;
...
function getTablePropertiesFormConfig(module, _ref10) {
    ...
    const alignment = formats.tableAlign || "left";
    const formData = {
        width: tableWidth,
        ...
        borderWidth: (0, _type.isDefined)(formats.tableBorderWidth) ? parseFloat(formats.tableBorderWidth) : null,
        alignment: alignment
    };
    const items = [{
        itemType: "group",
        ...
        items: [{
            ...
            template: () => {
                ...
                editorInstance._createComponent($content, _button_group.default, {
                    ...
                    keyExpr: "value",
                    selectedItemKeys: ["start" === alignment ? "left" : alignment],
                    onInitialized: event => {
...
function getCellPropertiesFormConfig(module, _ref11) {
    ...
    const defaultAlignment = "tableHeaderCell" === rowBlot.childFormatName ? "center" : "left";
    const alignment = formats.cellTextAlign || defaultAlignment;
    const verticalAlignment = formats.cellVerticalAlign || "middle";
    const rawVerticalPadding = formats.cellPaddingTop ?? (null === (_formats$cellPadding = formats.cellPadding) || void 0 === _formats$cellPadding ? void 0 : _formats$cellPadding.split(" ")[0]);
    const rawHorizontalPadding = formats.cellPaddingLeft ?? (null === (_formats$cellPadding2 = formats.cellPadding) || void 0 === _formats$cellPadding2 ? void 0 : _formats$cellPadding2.split(" ")[1]);
    const formData = {
        width: cellWidth,
        ...
        borderWidth: (0, _type.isDefined)(formats.cellBorderWidth) ? parseFloat(formats.cellBorderWidth) : null,
        alignment: alignment,
        verticalAlignment: verticalAlignment,
        verticalPadding: (0, _type.isDefined)(rawVerticalPadding) ? parseFloat(rawVerticalPadding) : null,
        horizontalPadding: (0, _type.isDefined)(rawHorizontalPadding) ? parseFloat(rawHorizontalPadding) : null
    };
    const items = [{
        itemType: "group",
        caption: _message.default.format("dxHtmlEditor-border"),
