/**
 * DevExtreme (cjs/__internal/ui/selection/selection.strategy.standard.js)
 * Version: 25.2.3
...
class StandardStrategy extends _selection.default {
    ...
    _updateKeysByLastRequestData(keys, isDeselect, isSelectAll) {
        ...
        if (this._isMultiSelectEnabled() && this._shouldMergeWithLastRequest && this._lastRequestData && !isDeselect && !isSelectAll) {
            ...
            currentKeys = (0, _array.removeDuplicates)([...keys, ...this._lastRequestData.addedItems], null === (_this$_lastRequestDat = this._lastRequestData) || void 0 === _this$_lastRequestDat ? void 0 : _this$_lastRequestDat.removedItems);
