...
ready((() => {
    ...
    _events_engine.default.subscribeGlobal(element, _pointer.default.down, (e => {
...
class Toast extends _ui.default {
    ...
    _defaultOptionsRules() {
        const tabletAndMobileCommonOptions = {
            displayTime: (0, _themes.isMaterialBased)((0, _themes.current)()) ? 4e3 : 2e3,
        ...
        const toastRules = [{
            ...
            device: device => (0, _themes.isMaterialBased)((0, _themes.current)()) && "desktop" === device.deviceType,
            options: {
                minWidth: 344,
                maxWidth: 568,
                displayTime: 4e3
    ...
    _renderContentImpl() {
        ...
        if ($content) {
            this._message = (0, _renderer.default)("<div>").addClass("dx-toast-message").text(message ?? "").appendTo($content)
        }
        this.setAria("role", "alert", this._message);
        if (type && toastTypes.includes(type.toLowerCase())) {
            null === $content || void 0 === $content || $content.prepend((0, _renderer.default)("<div>").addClass("dx-toast-icon"))
        }
    ...
    _render() {
        ...
        super._render();
        null === (_this$$element = this.$element()) || void 0 === _this$$element || _this$$element.addClass(TOAST_CLASS);
        ...
        if (type) {
            var _this$$content;
            null === (_this$$content = this.$content()) || void 0 === _this$$content || _this$$content.addClass(`${TOAST_CLASS}-${type.toLowerCase()}`)
        }
    ...
    _optionChanged(args) {
        ...
        switch (name) {
            case "type":
                null === (_this$$content3 = this.$content()) || void 0 === _this$$content3 || _this$$content3.removeClass(`${TOAST_CLASS}-${previousValue}`);
                if (value) {
                    var _this$$content4;
                    null === (_this$$content4 = this.$content()) || void 0 === _this$$content4 || _this$$content4.addClass(`${TOAST_CLASS}-${String(value).toLowerCase()}`)
                }
                break;
            case "message":
                if (this._message) {
