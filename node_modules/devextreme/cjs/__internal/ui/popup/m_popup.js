...
const getLocalizationKey = itemType => "done" === itemType.toLowerCase() ? "OK" : (0, _inflector.camelize)(itemType, true);
...
class Popup extends _overlay.default {
    ...
    _init() {
        ...
        this._$popupContent = null === (_this$_$content = this._$content) || void 0 === _this$_$content ? void 0 : _this$_$content.wrapInner((0, _renderer.default)("<div>").addClass(POPUP_CONTENT_CLASS)).children().eq(0);
    ...
    _renderTopToolbarImpl() {
        ...
        const $toolbarContainer = (0, _renderer.default)("<div>").addClass("dx-popup-title").addClass(_constants.TOOLBAR_CLASS).insertBefore($content);
    ...
    _renderBottomToolbarImpl() {
        ...
        const $toolbarContainer = (0, _renderer.default)("<div>").addClass("dx-popup-bottom").addClass(_constants.TOOLBAR_CLASS).insertAfter($content);
    ...
    _getToolbarButtonType(shortcut) {
        if ((0, _themes.isFluent)((0, _themes.current)()) && "done" === shortcut || this.option("useDefaultToolbarButtons")) {
            return "default"
        }
        return "normal"
    }
    ...
    _toggleContentScrollClass() {
        ...
        null === (_this$$content2 = this.$content()) || void 0 === _this$$content2 || _this$$content2.toggleClass(POPUP_CONTENT_SCROLLABLE_CLASS, isNativeScrollingEnabled)
    }
    ...
    _splitPopupHeight() {
        ...
        return {
            ...
            popupVerticalOffsets: (0, _size.getVerticalOffsets)(null === (_this$$content5 = this.$content()) || void 0 === _this$$content5 ? void 0 : _this$$content5.get(0), true),
            popupVerticalPaddings: (0, _size.getVerticalOffsets)(null === (_this$$content6 = this.$content()) || void 0 === _this$$content6 ? void 0 : _this$$content6.get(0), false)
        }
    }
    _isAllWindowCovered() {
        const {
