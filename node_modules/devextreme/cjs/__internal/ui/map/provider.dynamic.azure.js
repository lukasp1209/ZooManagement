/**
 * DevExtreme (cjs/__internal/ui/map/provider.dynamic.azure.js)
 * Version: 25.2.3
...
let azureMapsLoader;
class AzureProvider extends _provider.default {
    _mapType(type) {
        const mapTypes = {
            roadmap: "road",
            satellite: "satellite",
    ...
    _renderTooltip(location, options) {
        ...
        const $content = (0, _renderer.default)("<div>").html(parsedOptions.text).addClass("dx-map-marker-tooltip");
