/**
 * DevExtreme (cjs/__internal/ui/diagram/ui.diagram.toolbar.js)
 * Version: 25.2.3
...
var _uiDiagram2 = _interopRequireDefault(require("../../ui/diagram/ui.diagram.panel"));
...
class DiagramToolbar extends _uiDiagram2.default {
    ...
    _createMainElement() {
        return (0, _renderer.default)("<div>").addClass("dx-diagram-toolbar").appendTo(this.$element())
    }
    _getCommands() {
        const {
            commands: commands
    ...
    _renderToolbar($toolbar) {
        ...
        const beforeCommands = null === (_this$_commands = this._commands) || void 0 === _this$_commands ? void 0 : _this$_commands.filter((command => !["after", "center"].includes(command.location)));
        const centerCommands = null === (_this$_commands2 = this._commands) || void 0 === _this$_commands2 ? void 0 : _this$_commands2.filter((command => "center" === command.location));
        const afterCommands = null === (_this$_commands3 = this._commands) || void 0 === _this$_commands3 ? void 0 : _this$_commands3.filter((command => "after" === command.location));
    ...
    _createSelectBoxItemOptions(command, hint, items, valueExpr, displayExpr) {
        ...
        const isSelectButton = null === items || void 0 === items ? void 0 : items.every((i => void 0 !== i.icon));
        if (isSelectButton) {
            options = (0, _extend.extend)(true, options, {
                options: {
                    fieldAddons: {
                        beforeTemplate: (data, container) => {
                            (0, _renderer.default)("<i>").addClass((null === data || void 0 === data ? void 0 : data.icon) || "dx-diagram-i-selectbox-null-icon dx-diagram-i").appendTo(container)
                        }
                    },
    ...
    _toggleContextMenu(contextMenu) {
        ...
        null === (_this$_contextMenuLis = this._contextMenuList) || void 0 === _this$_contextMenuLis || _this$_contextMenuLis.forEach((cm => {
            if (contextMenu !== cm) {
                cm.hide()
            }
        }));
        ...
        if (("dxButton" === widget.NAME || "dxTextBox" === widget.NAME) && item.items) {
            ...
            widget._contextMenu = this._createComponent($menuContainer, _context_menu.default, {
                ...
                onItemClick: _ref2 => {
                    ...
                    if (!(null !== itemData && void 0 !== itemData && null !== (_itemData$items = itemData.items) && void 0 !== _itemData$items && _itemData$items.length)) {
                        component.hide()
                    }
                },
                onShowing: e => {
    ...
    _onContextMenuInitialized(widget, item, rootWidget) {
        ...
        null === (_this$_contextMenuLis2 = this._contextMenuList) || void 0 === _this$_contextMenuLis2 || _this$_contextMenuLis2.push(widget);
        if (item.command) {
    ...
    _onContextMenuDisposing(widget, item) {
        ...
        null === (_this$_contextMenuLis3 = this._contextMenuList) || void 0 === _this$_contextMenuLis3 || _this$_contextMenuLis3.splice(this._contextMenuList.indexOf(widget), 1);
    ...
    _executeCommand(command, name, value) {
        ...
        if ("number" === typeof command) {
            ...
            if (null !== valueConverter && void 0 !== valueConverter && valueConverter.getCommandValue) {
    ...
    _setEnabled(enabled) {
        ...
        null === (_this$_toolbarInstanc = this._toolbarInstance) || void 0 === _this$_toolbarInstanc || _this$_toolbarInstanc.option("disabled", !enabled);
        null === (_this$_contextMenuLis4 = this._contextMenuList) || void 0 === _this$_contextMenuLis4 || _this$_contextMenuLis4.forEach((contextMenu => {
    ...
    _setItemValue(command, value) {
        try {
            ...
            if (command in this._itemHelpers) {
                ...
                if (helper.canUpdate(this._showingSubMenu)) {
                    const valueConverter = this._valueConverters[command];
                    if (null !== valueConverter && void 0 !== valueConverter && valueConverter.getEditorValue) {
                        value = valueConverter.getEditorValue(value)
                    }
                    let displayValue;
                    if (null !== valueConverter && void 0 !== valueConverter && valueConverter.getEditorDisplayValue) {
