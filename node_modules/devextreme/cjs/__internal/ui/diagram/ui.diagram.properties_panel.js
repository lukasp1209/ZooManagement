...
class DiagramPropertiesPanel extends _uiDiagram.default {
    ...
    _renderTabPanel($parent) {
        ...
        this._tabPanel = this._createComponent($tabPanel, _tab_panel.default, {
            ...
            onContentReady: e => {
                var _this$_popup;
                null === (_this$_popup = this._popup) || void 0 === _this$_popup || _this$_popup.option("height", (0, _size.getHeight)(e.component.$element()) + this._getVerticalPaddingsAndBorders());
    ...
    _renderTabContent($parent, tab, index, isSingleTab) {
        ...
        if (isSingleTab) {
            var _this$_popup2;
            null === (_this$_popup2 = this._popup) || void 0 === _this$_popup2 || _this$_popup2.option("height", (0, _size.getHeight)(scrollView.$element()) + this._getVerticalPaddingsAndBorders())
        } else {
