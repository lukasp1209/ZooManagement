...
class MultiView extends _uiCollection_widget.default {
    ...
    _updateItemsPosition(selectedIndex, newIndex) {
        ...
        if ((0, _type.isDefined)(newIndex) && (0, _type.isDefined)(positionSign)) {
            _multi_view._translator.move($itemElements.eq(newIndex), 100 * positionSign + "%")
        }
    }
    _isItemVisible(index) {
        ...
        return ((0, _type.isDefined)(index) && (null === (_items$index = items[index]) || void 0 === _items$index ? void 0 : _items$index.visible)) ?? true
    }
