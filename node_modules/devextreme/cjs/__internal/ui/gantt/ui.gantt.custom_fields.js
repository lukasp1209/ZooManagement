/**
 * DevExtreme (cjs/__internal/ui/gantt/ui.gantt.custom_fields.js)
 * Version: 25.2.3
...
var _uiGantt = require("../../ui/gantt/ui.gantt.cache");
var _uiGantt2 = require("../../ui/gantt/ui.gantt.helper");
...
class GanttCustomFieldsManager {
    ...
    _getTaskCustomFields() {
        ...
        const columnFields = null === columns || void 0 === columns ? void 0 : columns.map((c => c.dataField));
        const mappedFields = this._mappingHelper.getTaskMappedFieldNames();
        return columnFields ? columnFields.filter((f => !mappedFields.includes(f))) : []
    }
    ...
    addCustomFieldsData(key, data) {
        if (data) {
            ...
            const modelData = null === (_this$_gantt$_tasksOp = this._gantt._tasksOption) || void 0 === _this$_gantt$_tasksOp ? void 0 : _this$_gantt$_tasksOp._getItems();
            const keyGetter = (0, _data.compileGetter)(this._gantt.option("tasks.keyExpr"));
            const modelItem = null === modelData || void 0 === modelData ? void 0 : modelData.filter((obj => keyGetter(obj) === key))[0];
    ...
    appendCustomFields(data) {
        ...
        const modelData = null === (_this$_gantt$_tasksOp2 = this._gantt._tasksOption) || void 0 === _this$_gantt$_tasksOp2 ? void 0 : _this$_gantt$_tasksOp2._getItems();
                ...
                if (dataOption && data) {
                    dataOption.update(key, data, ((data, key) => {
                        ...
                        dataOption._reloadDataSource().done((data => {
                            ...
                            null === (_this$_gantt$_ganttTr = this._gantt._ganttTreeList) || void 0 === _this$_gantt$_ganttTr || _this$_gantt$_ganttTr.updateDataSource(data ?? dataOption._dataSource, false, isCustomFieldsUpdateOnly)
                        }));
                        const selectedRowKey = this._gantt.option("selectedRowKey");
                        null === (_this$_gantt$_ganttVi = this._gantt._ganttView) || void 0 === _this$_gantt$_ganttVi || _this$_gantt$_ganttVi._selectTask(selectedRowKey);
                        null === (_this$_gantt$_actions = this._gantt._actionsManager) || void 0 === _this$_gantt$_actions || _this$_gantt$_actions.raiseUpdatedAction("tasks", updatedCustomFields, key)
                    }))
                }
            };
