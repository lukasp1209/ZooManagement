/**
 * DevExtreme (cjs/__internal/ui/gantt/ui.gantt.bars.js)
 * Version: 25.2.3
...
class Bar {
    ...
    createItems(items) {
        ...
        null === (_this$_menu = this._menu) || void 0 === _this$_menu || _this$_menu.option("items", this._items)
    }
    ...
    setEnabled(enabled) {
        var _this$_menu2;
        null === (_this$_menu2 = this._menu) || void 0 === _this$_menu2 || _this$_menu2.option("disabled", !enabled)
    }
    updateItemsList() {}
    isVisible() {
        return true
...
class GanttToolbar extends Bar {
    ...
    completeUpdate() {
        var _this$_menu3;
        null === (_this$_menu3 = this._menu) || void 0 === _this$_menu3 || _this$_menu3.option("items", this._items)
    }
}
...
class GanttContextMenuBar extends Bar {
    ...
    show(point, items) {
        ...
        null === (_this$_menu4 = this._menu) || void 0 === _this$_menu4 || _this$_menu4.option("items", items || this._items);
        null === (_this$_menu5 = this._menu) || void 0 === _this$_menu5 || _this$_menu5.option("position.offset", {
            x: point.x,
            y: point.y
        });
        null === (_this$_menu6 = this._menu) || void 0 === _this$_menu6 || _this$_menu6.option("position.collision", "fit");
        this._menu.show()
    }
    hide() {
        this._menu.hide()
