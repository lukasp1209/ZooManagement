/**
 * DevExtreme (cjs/__internal/ui/gantt/ui.gantt.treelist.js)
 * Version: 25.2.3
...
class GanttTreeList {
    ...
    getRowHeight() {
        ...
        let height = null !== $row && void 0 !== $row && $row.length ? (0, _position.getBoundingRect)(null === $row || void 0 === $row ? void 0 : $row.last().get(0)).height : 34;
        if (!height) {
            height = 34
        }
    ...
    getHeaderHeight() {
        ...
        return (0, _position.getBoundingRect)(null === (_this$_treeList8 = this._treeList) || void 0 === _this$_treeList8 ? void 0 : _this$_treeList8.$element().find(".dx-treelist-headers").get(0)).height
    }
    getColumns() {
        const {
            columns: columns
