    ...
    _optionChanged(args) {
        ...
        switch (name) {
            ...
            case "endDateRange":
                ...
                break;
            case "selectedRowKey":
                null === (_this$_ganttTreeList18 = this._ganttTreeList) || void 0 === _this$_ganttTreeList18 || _this$_ganttTreeList18.selectRows(_uiGantt7.GanttHelper.getArrayFromOneElement(value));
                break;
            ...
            case "onScaleCellPrepared":
                ...
                break;
            case "allowSelection":
                null === (_this$_ganttTreeList19 = this._ganttTreeList) || void 0 === _this$_ganttTreeList19 || _this$_ganttTreeList19.setOption("selection.mode", _uiGantt7.GanttHelper.getSelectionMode(value));
            ...
            case "height":
                super._optionChanged(args);
                null === (_this$_sizeHelper8 = this._sizeHelper) || void 0 === _this$_sizeHelper8 || _this$_sizeHelper8.setGanttHeight((0, _size.getHeight)(this.$element()));
                break;
            case "sorting":
