...
class TreeViewBase extends _hierarchical_collection_widget.default {
    ...
    _supportedKeys() {
        const click = e => {
            ...
            const expandByClick = expandEventName === (0, _utils.addNamespace)(_click.name, "dxTreeView_expand");
            if (expandByClick) {
    ...
    _getEventNameByOption(name) {
        ...
        return (0, _utils.addNamespace)(event, "dxTreeView_expand")
    }
    _getNode(identifier) {
    ...
    _attachClickEvent() {
        ...
        _events_engine.default.on($itemContainer, clickEventNamespace, itemSelector, (e => {
            if ((0, _renderer.default)(e.target).hasClass("dx-checkbox-icon") || (0, _renderer.default)(e.target).hasClass(CHECK_BOX_CLASS)) {
                return
            }
