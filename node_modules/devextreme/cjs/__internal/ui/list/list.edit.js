...
class ListEdit extends _list.ListBase {
    ...
    _isItemStrictEquals(item1, item2) {
        const privateKey = null === item1 || void 0 === item1 ? void 0 : item1[_collection_widget2.PRIVATE_KEY_FIELD];
    ...
    _getFlatIndex() {
        const {
            selectedIndex: selectedIndex = _collection_widget.NOT_EXISTING_INDEX
        } = this.option();
