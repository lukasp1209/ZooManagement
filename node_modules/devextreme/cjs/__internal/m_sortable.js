...
class Sortable extends _m_draggable.default {
    ...
    _createPlaceholder() {
        ...
        this._$placeholderElement = (0, _renderer.default)("<div>").addClass(this._addWidgetPrefix("placeholder")).addClass(customCssClass ?? "").insertBefore(this._getSourceDraggable()._$dragElement);
