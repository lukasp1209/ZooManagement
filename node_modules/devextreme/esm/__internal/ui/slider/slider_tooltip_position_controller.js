/**
 * DevExtreme (esm/__internal/ui/slider/slider_tooltip_position_controller.js)
 * Version: 25.2.3
...
export class SliderTooltipPositionController extends PopoverPositionController {
    _normalizePosition(position) {
        ...
        const sliderElement = null === $sliderHandle || void 0 === $sliderHandle || null === (_$sliderHandle$closes = $sliderHandle.closest(".dx-slider")) || void 0 === _$sliderHandle$closes ? void 0 : _$sliderHandle$closes.get(0);
    ...
    _fitIntoSlider() {
        ...
        const left = (null === (_this$_visualPosition = this._visualPosition) || void 0 === _this$_visualPosition ? void 0 : _this$_visualPosition.left) ?? 0;
