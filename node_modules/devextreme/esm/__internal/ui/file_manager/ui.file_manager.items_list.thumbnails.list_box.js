/**
 * DevExtreme (esm/__internal/ui/file_manager/ui.file_manager.items_list.thumbnails.list_box.js)
 * Version: 25.2.3
...
class FileManagerThumbnailListBox extends CollectionWidget {
    ...
    _initTemplates() {
        ...
        this._templateManager.addDefaultTemplates({
            item: new BindableTemplate((($container, data, itemModel) => {
    ...
    _beforeKeyProcessing(e) {
        ...
        e.preventDefault();
        null === (_this$_layoutUtils = this._layoutUtils) || void 0 === _this$_layoutUtils || _this$_layoutUtils.reset()
    }
    _processArrowKeys(offset, horizontal, eventArgs) {
        ...
        if (item) {
            if (!horizontal) {
                ...
                const layout = null === (_this$_layoutUtils2 = this._layoutUtils) || void 0 === _this$_layoutUtils2 ? void 0 : _this$_layoutUtils2.getLayoutModel();
                if (!layout) {
                    return
                }
    ...
    _processPageChange(pageUp, eventArgs) {
        ...
        const layout = null === (_this$_layoutUtils3 = this._layoutUtils) || void 0 === _this$_layoutUtils3 ? void 0 : _this$_layoutUtils3.getLayoutModel();
        if (!layout) {
            return
        }
        const itemLayout = null === (_this$_layoutUtils4 = this._layoutUtils) || void 0 === _this$_layoutUtils4 ? void 0 : _this$_layoutUtils4.createItemLayoutModel(this._getIndexByItem(item));
        const rowOffset = pageUp ? layout.rowPerPageRate : -layout.rowPerPageRate;
        const newRowRate = (null === itemLayout || void 0 === itemLayout ? void 0 : itemLayout.itemRowIndex) - rowOffset;
        const roundFunc = pageUp ? Math.ceil : Math.floor;
        const newRowIndex = roundFunc(newRowRate);
        let newItemIndex = newRowIndex * layout.itemPerRowCount + (null === itemLayout || void 0 === itemLayout ? void 0 : itemLayout.itemColumnIndex);
        if (newItemIndex < 0) {
            newItemIndex = 0
    ...
    _focusItem(item, scrollToItem) {
        ...
        if (scrollToItem) {
            ...
            null === (_this$_layoutUtils5 = this._layoutUtils) || void 0 === _this$_layoutUtils5 || _this$_layoutUtils5.scrollToItem(this._getIndexByItem(item))
        }
    }
    ...
    _syncFocusedItemKey() {
        ...
        if (null !== (_this$_dataSource = this._dataSource) && void 0 !== _this$_dataSource && _this$_dataSource.isLoading()) {
            return null === deferred || void 0 === deferred ? void 0 : deferred.promise()
        }
        ...
        if (isDefined(focusedItemKey)) {
            ...
            const focusedItem = null === items || void 0 === items ? void 0 : items.find((item => this.keyOf(item) === focusedItemKey));
            if (focusedItem) {
                this._focusItem(focusedItem, true);
                null === deferred || void 0 === deferred || deferred.resolve()
            } else {
                this.option("focusedItemKey", void 0);
                null === deferred || void 0 === deferred || deferred.reject()
            }
        } else {
            null === deferred || void 0 === deferred || deferred.resolve()
        }
        ...
        switch (name) {
            ...
            case "focusedItemKey":
                ...
                if (isDefined(value)) {
                    ...
                    null === (_this$_syncFocusedIte = this._syncFocusedItemKey()) || void 0 === _this$_syncFocusedIte || _this$_syncFocusedIte.done((() => {
                        const focusedItem = this._getFocusedItem();
                        this._raiseFocusedItemChanged(focusedItem)
                    }))
                } else {
