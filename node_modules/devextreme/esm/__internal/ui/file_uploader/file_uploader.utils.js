/**
 * DevExtreme (esm/__internal/ui/file_uploader/file_uploader.utils.js)
 * Version: 25.2.3
...
export const getFileIconName = function() {
    let filename = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
    const lastDotIndex = filename.lastIndexOf(".");
    if (-1 === lastDotIndex || lastDotIndex === filename.length - 1) {
        return "file"
    }
    const extension = filename.slice(lastDotIndex + 1).toLowerCase();
    return EXTENTIONS_MAP[extension] || "file"
};
