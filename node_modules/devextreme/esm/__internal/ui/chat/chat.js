...
class Chat extends Widget {
    ...
    _getAttachmentDownloadHandler() {
        ...
        return e => {
            ...
            null === (_this$_attachmentDown = this._attachmentDownloadAction) || void 0 === _this$_attachmentDown || _this$_attachmentDown.call(this, e)
        }
    }
    on(eventName) {
        ...
        if ("attachmentDownloadClick" === eventName) {
    ...
    _updateAttachmentDownloadHandler() {
        ...
        null === (_this$_messageList2 = this._messageList) || void 0 === _this$_messageList2 || _this$_messageList2.option("onAttachmentDownloadClick", this._getAttachmentDownloadHandler())
    }
    ...
    _getRenderTemplateFunction(optionName) {
        ...
        if (templateOption) {
            return (data, $container) => {
                ...
                const dataFieldName = "messageTemplate" === optionName ? "message" : "texts";
                template.render({
                    container: $container,
                    model: {
                        component: this,
