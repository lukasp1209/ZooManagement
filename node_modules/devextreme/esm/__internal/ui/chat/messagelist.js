...
class MessageList extends Widget {
    ...
    _getContextMenuButtons(message) {
        const {
            ...
            onMessageEditingStart: onMessageEditingStart,
            onMessageDeleting: onMessageDeleting
        } = this.option();
        ...
        const buttons = [];
        if (allowUpdating(message) && "image" !== message.type) {
            buttons.push({
                icon: "edit",
                text: editText,
                disabled: isEditActionDisabled(message),
                onClick: e => {
                    const onMessageEditStarted = null === onMessageEditingStart || void 0 === onMessageEditingStart ? void 0 : onMessageEditingStart({
                        event: e.event,
                        message: message
                    });
                    const onContextMenuHidden = () => {
                        this._contextMenu.off("hidden", onContextMenuHidden);
                        null === onMessageEditStarted || void 0 === onMessageEditStarted || onMessageEditStarted()
                    };
        ...
        if (allowDeleting(message)) {
            buttons.push({
                ...
                text: deleteText,
                onClick(e) {
                    null === onMessageDeleting || void 0 === onMessageDeleting || onMessageDeleting({
                        event: e.event,
                        message: message
                    })
                }
    ...
    _renderContextMenu() {
        ...
        this._contextMenu = this._createComponent($contextMenu, ContextMenu, {
            ...
            elementAttr: {
                class: "dx-messagelist-context-menu"
            },
        ...
        this._contextMenu.registerKeyHandler("escape", (event => {
            ...
            null === onEscapeKeyPressed || void 0 === onEscapeKeyPressed || onEscapeKeyPressed(event)
        }));
    ...
    _onContextMenuShowing(e) {
        ...
        if (null !== message && void 0 !== message && message.isDeleted) {
            e.cancel = true;
            return
        }
    ...
    _updateMessageByKey(key, data) {
        if (isDefined(key)) {
            ...
            if ("image" !== data.type) {
                ...
                const group = MessageGroup.getInstance($currentMessageGroup);
                const isEdited = true === data.isEdited && !data.isDeleted;
    ...
    _dimensionChanged() {
        ...
        null === (_this$_contextMenu = this._contextMenu) || void 0 === _this$_contextMenu || _this$_contextMenu.hide()
    }
    _clean() {
        this._lastMessageDate = null;
