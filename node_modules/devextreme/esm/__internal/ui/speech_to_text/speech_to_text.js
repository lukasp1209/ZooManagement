...
} from "../../core/speech_recognition_adapter";
...
class SpeechToText extends Widget {
    ...
    _isCustomSpeechRecognitionEnabled() {
        ...
        return Boolean(null === customSpeechRecognizer || void 0 === customSpeechRecognizer ? void 0 : customSpeechRecognizer.enabled)
    }
    _init() {
        this._actions = {};
        super._init();
    ...
    _emitNativeEvent(name, event) {
        ...
        null === (_this$_actions$name = (_this$_actions = this._actions)[name]) || void 0 === _this$_actions$name || _this$_actions$name.call(_this$_actions, {
            component: this,
    ...
    _emitDxEvent(name, event) {
        ...
        null === (_this$_actions$name2 = (_this$_actions2 = this._actions)[name]) || void 0 === _this$_actions$name2 || _this$_actions$name2.call(_this$_actions2, {
            component: this,
            element: this.element(),
            event: event
        })
    ...
    _handleStartClick(e) {
        ...
        const isSRAvailable = null === (_this$_speechRecognit = this._speechRecognitionAdapter) || void 0 === _this$_speechRecognit ? void 0 : _this$_speechRecognit.isAvailable();
        if (!isCustomEnabled && isSRAvailable) {
            var _this$_speechRecognit2;
            this._setState(SpeechToTextState.LISTENING);
            null === (_this$_speechRecognit2 = this._speechRecognitionAdapter) || void 0 === _this$_speechRecognit2 || _this$_speechRecognit2.start()
        }
    ...
    _handleStopClick(e) {
        if (!this._isCustomSpeechRecognitionEnabled()) {
            ...
            null === (_this$_speechRecognit3 = this._speechRecognitionAdapter) || void 0 === _this$_speechRecognit3 || _this$_speechRecognit3.stop()
        }
    ...
    _stopRecognitionOnDisable(disabled) {
        if (disabled) {
            ...
            null === (_this$_speechRecognit4 = this._speechRecognitionAdapter) || void 0 === _this$_speechRecognit4 || _this$_speechRecognit4.stop()
        }
    }
    _setState(newState) {
    ...
    _updateButtonState() {
        var _this$_button;
        null === (_this$_button = this._button) || void 0 === _this$_button || _this$_button.option({
            icon: this._getCurrentIcon(),
            text: this._getCurrentText(),
            elementAttr: {
    ...
    _updateCssClasses() {
        this.$element().toggleClass("dx-speech-to-text-listening", this._isListening())
    }
    _updateSpeechRecognitionConfig(args) {
        var _this$_speechRecognit5;
        const options = Widget.getOptionsFromContainer(args);
        null === (_this$_speechRecognit5 = this._speechRecognitionAdapter) || void 0 === _this$_speechRecognit5 || _this$_speechRecognit5.applyConfig(options)
    }
    _optionChanged(args) {
        ...
        switch (name) {
            ...
            case "type":
            case "width":
                null === (_this$_button2 = this._button) || void 0 === _this$_button2 || _this$_button2.option(name, value);
                break;
            case "disabled":
                null === (_this$_button3 = this._button) || void 0 === _this$_button3 || _this$_button3.option(name, value);
    ...
    _handleCustomEngineState() {
        ...
        const isListening = enabled && void 0 !== isListeningState ? isListeningState : false;
    ...
    _cleanButton() {
        var _this$_button4;
        null === (_this$_button4 = this._button) || void 0 === _this$_button4 || _this$_button4.dispose();
        this._button = void 0
    }
    _clean() {
        this._cleanButton();
    ...
    _dispose() {
        ...
        this._actions = {};
        null === (_this$_speechRecognit6 = this._speechRecognitionAdapter) || void 0 === _this$_speechRecognit6 || _this$_speechRecognit6.dispose();
