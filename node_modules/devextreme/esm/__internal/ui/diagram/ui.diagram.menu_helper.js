/**
 * DevExtreme (esm/__internal/ui/diagram/ui.diagram.menu_helper.js)
 * Version: 25.2.3
...
const DiagramMenuHelper = {
    ...
    getItemOptionText(contextMenu, indexPath) {
        if (contextMenu) {
            ...
            if (null !== (_contextMenu$_origina = contextMenu._originalItemsInfo) && void 0 !== _contextMenu$_origina && _contextMenu$_origina[parentItemOptionText]) {
    ...
    updateContextMenuItemValue(contextMenu, itemOptionText, rootCommandKey, value) {
        ...
        if ("boolean" === typeof value && !(null !== items && void 0 !== items && items.length)) {
