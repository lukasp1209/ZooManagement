...
class DiagramToolbar extends DiagramPanel {
    ...
    _createMainElement() {
        return $("<div>").addClass("dx-diagram-toolbar").appendTo(this.$element())
    }
    _getCommands() {
        const {
            commands: commands
                ...
                options: {
                    fieldAddons: {
                        beforeTemplate: (data, container) => {
                            $("<i>").addClass((null === data || void 0 === data ? void 0 : data.icon) || "dx-diagram-i-selectbox-null-icon dx-diagram-i").appendTo(container)
                        }
                    },
