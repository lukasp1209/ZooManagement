/**
 * DevExtreme (esm/__internal/ui/diagram/diagram.commands_manager.js)
 * Version: 25.2.3
...
import {
    fileSaver
} from "../../../__internal/exporter/file_saver";
...
const DiagramCommandsManager = {
        ...
        groups.forEach((g => {
            ...
            if (g.groups) {
                ...
                g.groups.forEach((sg => {
                    ...
                    null === (_subGroups = subGroups) || void 0 === _subGroups || _subGroups.push({
                        title: sg.title,
    ...
    _getPreparedCommands(allCommands, commands) {
        return commands.map((c => {
            ...
            if (c.text || c.icon || c.name) {
                ...
                const command = {
                    command: null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.command,
                    name: c.name,
                    location: c.location,
                    text: c.text || (null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.text),
                    hint: c.text || (null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.hint),
                    icon: c.icon || (null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.icon),
                    menuIcon: c.icon || (null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.menuIcon),
                    widget: null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.widget,
                    cssClass: null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.cssClass,
                    getParameter: null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.getParameter,
                    getCommandValue: null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.getCommandValue,
                    getEditorValue: null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.getEditorValue,
                    getEditorDisplayValue: null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.getEditorDisplayValue,
                    iconChecked: null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.iconChecked,
                    iconUnchecked: null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.iconUnchecked,
                    items: Array.isArray(c.items) ? this._getPreparedCommands(allCommands, c.items) : null === internalCommand || void 0 === internalCommand ? void 0 : internalCommand.items
                };
                return command
            }
        })).filter((c => c))
    ...
    _prepareContextMenuCommands(commands, excludeCommands, rootCommand) {
        ...
        return commands.map((c => {
            ...
            if (c.widget && c.widget === SEPARATOR) {
                ...
                command.rootCommand = !command.command ? null === rootCommand || void 0 === rootCommand ? void 0 : rootCommand.command : void 0;
                beginGroup = false;
                return command
            }
        })).filter((c => c))
    ...
    _exportTo(widget, dataURI, format, mimeString) {
        ...
        if (null !== window && void 0 !== window && window.atob && isFunction(window.Blob)) {
