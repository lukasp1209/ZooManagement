/**
 * DevExtreme (esm/__internal/ui/diagram/diagram.options_update.js)
 * Version: 25.2.3
...
class DiagramOptionsUpdateBar extends DiagramBar {
    ...
    setItemValue(key, value) {
        ...
        try {
            ...
            if ("function" === typeof(null === (_this$commandOptions = this.commandOptions) || void 0 === _this$commandOptions ? void 0 : _this$commandOptions[key])) {
                var _this$commandOptions2;
                null === (_this$commandOptions2 = this.commandOptions) || void 0 === _this$commandOptions2 || _this$commandOptions2[key].call(this, value)
            } else {
                var _this$commandOptions3;
                this._setOption(null === (_this$commandOptions3 = this.commandOptions) || void 0 === _this$commandOptions3 ? void 0 : _this$commandOptions3[key], value)
            }
        } finally {
            this.endUpdate()
        }
