...
import {
    ...
    getAICommandName
} from "../../../ui/html_editor/utils/ai";
import {
    isSmallScreen
} from "../../../ui/html_editor/utils/small_screen";
import {
    AnimationType
...
function getActionButtonWidth() {
    return isCompact(current()) ? 100 : 110
}
var DialogState;
...
export default class AIDialog extends BaseDialog {
    ...
    _renderContent($contentElem) {
        ...
        const $controls = $("<div>").addClass("dx-aidialog-controls").appendTo($contentElem);
    ...
    _renderInformer($container) {
        ...
        this._informer = new Informer($informer.get(0), {
    ...
    _getTitleItem() {
        return {
            ...
            template: (data, index, titleElement) => {
                ...
                const $text = $("<span>").addClass("dx-aidialog-title-text").text(localizationMessage.format("dxHtmlEditor-aiDialogTitle"));
    ...
    _getCopyButtonItem() {
        const text = isSmallScreen() ? void 0 : localizationMessage.format("dxHtmlEditor-aiCopy");
        return {
            name: "copy",
            toolbar: "bottom",
            location: "after",
    ...
    _getRegenerateButtonItem() {
        const text = isSmallScreen() ? void 0 : localizationMessage.format("dxHtmlEditor-aiRegenerate");
        return {
            name: "regenerate",
            toolbar: "bottom",
            location: "before",
    ...
    _executeAICommand() {
        ...
        const aiCommandName = uiCommand && getAICommandName(null === (_this$_commandsMap$ui = this._commandsMap[uiCommand]) || void 0 === _this$_commandsMap$ui ? void 0 : _this$_commandsMap$ui.name);
    ...
    _isCommandWithOptionsSelected() {
        ...
        if (this._currentCommand && (null === (_this$_commandsMap$th = this._commandsMap[this._currentCommand]) || void 0 === _this$_commandsMap$th ? void 0 : _this$_commandsMap$th.name) === AI_DIALOG_CUSTOM_COMMAND_NAME) {
    ...
    _refreshDialogAria() {
        ...
        const $title = $overlayContent.find(".dx-aidialog-title");
        $title.attr("id", id);
