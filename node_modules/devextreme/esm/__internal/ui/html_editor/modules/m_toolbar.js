...
if (Quill) {
    ...
    ToolbarModule = class extends BaseModule {
        ...
        _createCommandMenuItem(command, text, commandOptions) {
            const options = (null === commandOptions || void 0 === commandOptions ? void 0 : commandOptions.map(capitalize)) ?? getDefaultOptionsByCommand(command);
            const item = {
                id: command,
                name: command,
        ...
        _prepareAIMenuItemConfig(item) {
            ...
            const {
                ...
                commands: commands = Object.keys(commandMessageKeys)
            } = item;
