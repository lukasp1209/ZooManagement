...
class ColorBox extends DropDownEditor {
    ...
    _renderNoColorIcon() {
        if (!this._$noColorIcon || !this._$noColorIcon.length) {
            this._$noColorIcon = $("<i>").addClass(`dx-icon ${DX_ICON_COLOR_DISMISS}`).appendTo(this._$colorResultPreview)
        }
    }
    ...
    _cleanNoColorIcon() {
        ...
        null === (_this$_$noColorIcon = this._$noColorIcon) || void 0 === _this$_$noColorIcon || _this$_$noColorIcon.remove();
