...
export default class SplitterControl extends Widget {
    ...
    _onMouseDownHandler(e) {
        ...
        e.preventDefault();
        this._offsetX = e.pageX - (null === (_this$_$splitterBorde = this._$splitterBorder.offset()) || void 0 === _this$_$splitterBorde ? void 0 : _this$_$splitterBorde.left) <= this._getSplitterBorderWidth() ? e.pageX - (null === (_this$_$splitterBorde2 = this._$splitterBorder.offset()) || void 0 === _this$_$splitterBorde2 ? void 0 : _this$_$splitterBorde2.left) : 0;
        this._containerWidth = this._$container.get(0).clientWidth;
    ...
    _getContainerLeftOffset() {
        ...
        let offsetLeft = null === (_this$_$container$off = this._$container.offset()) || void 0 === _this$_$container$off ? void 0 : _this$_$container$off.left;
        if (window) {
    ...
    _toggleActive(isActive) {
        ...
        null === (_this$_actions$onActi = (_this$_actions = this._actions).onActiveStateChanged) || void 0 === _this$_actions$onActi || _this$_actions$onActi.call(_this$_actions, {
            isActive: isActive
        })
    }
    ...
    _setSplitterPositionLeft() {
        ...
        null === (_this$_actions$onAppl = (_this$_actions2 = this._actions).onApplyPanelSize) || void 0 === _this$_actions$onAppl || _this$_actions$onAppl.call(_this$_actions2, {
