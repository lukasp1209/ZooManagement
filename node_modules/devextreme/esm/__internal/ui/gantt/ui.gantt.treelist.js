/**
 * DevExtreme (esm/__internal/ui/gantt/ui.gantt.treelist.js)
 * Version: 25.2.3
...
} from "../../ui/gantt/ui.gantt.treelist.nodes_state";
...
export class GanttTreeList {
    ...
    _initGanttOnContentReady(e) {
        ...
        null === (_this$_gantt$_sizeHel = this._gantt._sizeHelper) || void 0 === _this$_gantt$_sizeHel || _this$_gantt$_sizeHel.updateGanttRowHeights()
    }
    _onSelectionChanged(e) {
        ...
        null === (_this$_gantt$_actions = this._gantt._actionsManager) || void 0 === _this$_gantt$_actions || _this$_gantt$_actions.raiseSelectionChangedAction(selectedRowKey)
    }
    _onRowCollapsed(e) {
    ...
    _onScroll(treeListScrollView) {
        ...
        const ganttViewTaskAreaContainer = null === (_this$_gantt$_ganttVi = this._gantt._ganttView) || void 0 === _this$_gantt$_ganttVi ? void 0 : _this$_gantt$_ganttVi.getTaskAreaContainer();
    ...
    _correctRowsViewRowHeight(height) {
        var _this$_treeList;
        const view = null === (_this$_treeList = this._treeList) || void 0 === _this$_treeList || null === (_this$_treeList = _this$_treeList._views) || void 0 === _this$_treeList ? void 0 : _this$_treeList.rowsView;
    ...
    scrollBy(scrollTop) {
        ...
        const treeListScrollable = null === (_this$_treeList2 = this._treeList) || void 0 === _this$_treeList2 ? void 0 : _this$_treeList2.getScrollable();
        if (treeListScrollable) {
    ...
    updateDataSource(data) {
        ...
        if (!this._skipUpdateTreeListDataSource() || forceUpdate) {
            ...
            const data = null === (_this$_treeList3 = this._treeList) || void 0 === _this$_treeList3 ? void 0 : _this$_treeList3.option("dataSource");
    ...
    onRowClick(e) {
        ...
        null === (_this$_gantt$_actions2 = this._gantt._actionsManager) || void 0 === _this$_gantt$_actions2 || _this$_gantt$_actions2.raiseTaskClickAction(e.key, e.event)
    }
    onRowDblClick(e) {
        var _this$_gantt$_actions3;
        if (null !== (_this$_gantt$_actions3 = this._gantt._actionsManager) && void 0 !== _this$_gantt$_actions3 && _this$_gantt$_actions3.raiseTaskDblClickAction(e.key, e.event)) {
            var _this$_gantt$_ganttVi2;
            null === (_this$_gantt$_ganttVi2 = this._gantt._ganttView) || void 0 === _this$_gantt$_ganttVi2 || _this$_gantt$_ganttVi2._ganttViewCore.showTaskEditDialog()
        }
    }
    saveExpandedKeys() {
    ...
    _onNodesInitialized() {
        ...
        if (this.isExpandedStateChanged(savedKeys, expandedKeys)) {
            ...
            null === (_this$_gantt$_ganttVi3 = this._gantt._ganttView) || void 0 === _this$_gantt$_ganttVi3 || _this$_gantt$_ganttVi3.applyTasksExpandedState(expandedState)
        }
        state.clear()
    }
    getNodesState() {
    ...
    getAllNodes() {
        ...
        const store = null === (_this$_treeList4 = this._treeList) || void 0 === _this$_treeList4 || null === (_this$_treeList4 = _this$_treeList4.getDataSource()) || void 0 === _this$_treeList4 ? void 0 : _this$_treeList4.store();
        if (!store || !(null !== (_this$_treeList5 = this._treeList) && void 0 !== _this$_treeList5 && _this$_treeList5.getNodeByKey)) {
            return []
        }
        const keyGetter = compileGetter(store.key());
        return store._array.map((item => {
            var _this$_treeList6;
            return null === (_this$_treeList6 = this._treeList) || void 0 === _this$_treeList6 ? void 0 : _this$_treeList6.getNodeByKey(keyGetter(item))
        })).filter((item => !!item))
    }
    ...
    getOffsetHeight() {
        ...
        return null === (_this$_gantt$_treeLis = this._gantt._treeList) || void 0 === _this$_gantt$_treeLis ? void 0 : _this$_gantt$_treeLis.$element().get(0).offsetHeight
    }
    getRowHeight() {
        var _this$_treeList7;
        const $row = null === (_this$_treeList7 = this._treeList) || void 0 === _this$_treeList7 ? void 0 : _this$_treeList7.$element().find(".dx-data-row");
        let height = null !== $row && void 0 !== $row && $row.length ? getBoundingRect(null === $row || void 0 === $row ? void 0 : $row.last().get(0)).height : 34;
        if (!height) {
            height = 34
        }
    ...
    getHeaderHeight() {
        ...
        return getBoundingRect(null === (_this$_treeList8 = this._treeList) || void 0 === _this$_treeList8 ? void 0 : _this$_treeList8.$element().find(".dx-treelist-headers").get(0)).height
    }
    getColumns() {
        const {
            columns: columns
    ...
    getSievedItems() {
        ...
        const rootNode = null === (_this$_treeList9 = this._treeList) || void 0 === _this$_treeList9 ? void 0 : _this$_treeList9.getRootNode();
        if (!rootNode) {
            return
        }
        const resultArray = [];
    ...
    setOption(optionName, value) {
        ...
        null === (_this$_treeList10 = this._treeList) || void 0 === _this$_treeList10 || _this$_treeList10.option(optionName, value)
    }
    getOption(optionName) {
        var _this$_treeList11;
        return null === (_this$_treeList11 = this._treeList) || void 0 === _this$_treeList11 ? void 0 : _this$_treeList11.option(optionName)
    }
    ...
    getDataSource() {
        ...
        return null === (_this$_treeList12 = this._treeList) || void 0 === _this$_treeList12 ? void 0 : _this$_treeList12.getDataSource()
    }
}
