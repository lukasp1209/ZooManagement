/**
 * DevExtreme (esm/__internal/ui/gantt/ui.gantt.dialogs.js)
 * Version: 25.2.3
...
import "../../../ui/list_light";
import "../../ui/list/modules/deleting";
...
class DialogInfoBase {
    ...
    getFormData() {
        var _this$_form;
        const formData = null === (_this$_form = this._form) || void 0 === _this$_form ? void 0 : _this$_form.option("formData");
        return formData
    }
    isValidated() {
        return true
...
class TaskEditDialogInfo extends DialogInfoBase {
    ...
    _updateParameters(formData) {
        ...
        this._parameters.progress = Math.round(100 * formData.progress);
        this._parameters.assigned = formData.assigned
    }
    isValidated() {
        var _this$_form2;
        const validationResult = null === (_this$_form2 = this._form) || void 0 === _this$_form2 ? void 0 : _this$_form2.validate();
...
export class GanttDialog {
    ...
    show(name, parameters, callback, afterClosing, editingOptions) {
        ...
        const isRefresh = (null === (_this$_popupInstance = this._popupInstance) || void 0 === _this$_popupInstance ? void 0 : _this$_popupInstance._isVisible()) && this._dialogInfo && this._dialogInfo instanceof this.infoMap[name];
        this._dialogInfo = new this.infoMap[name](parameters, this._apply.bind(this), this.hide.bind(this), editingOptions, this);
        null === (_this$_popupInstance2 = this._popupInstance) || void 0 === _this$_popupInstance2 || _this$_popupInstance2.option({
        ...
        if (this._afterClosing) {
            ...
            null === (_this$_popupInstance3 = this._popupInstance) || void 0 === _this$_popupInstance3 || _this$_popupInstance3.option("onHidden", this._afterClosing)
        }
        if (!isRefresh) {
            var _this$_popupInstance4;
            null === (_this$_popupInstance4 = this._popupInstance) || void 0 === _this$_popupInstance4 || _this$_popupInstance4.show()
        }
    }
    hide() {
        if (this._dialogInfo.shouldHidePopup()) {
            var _this$_popupInstance5;
            null === (_this$_popupInstance5 = this._popupInstance) || void 0 === _this$_popupInstance5 || _this$_popupInstance5.hide()
        }
        if (this._afterClosing) {
            this._afterClosing()
        }
