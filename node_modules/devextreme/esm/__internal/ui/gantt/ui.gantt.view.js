...
import {
    getGanttViewCore
} from "../../ui/gantt/gantt_importer";
import {
    TaskAreaContainer
} from "../../ui/gantt/ui.gantt.task.area.container";
...
export class GanttView extends Widget {
    ...
    _initMarkup() {
        ...
        this._ganttViewCore = new GanttView(this.$element().get(0), this, {
            ...
            stripLines: {
                stripLines: null === (_this$option = this.option("stripLines")) || void 0 === _this$option ? void 0 : _this$option.map((item => Object.assign({}, item)))
            },
    ...
    prepareExternalTaskAreaContainer(element, info) {
        if (null !== info && void 0 !== info && info.height) {
            ...
            null === (_this$_taskAreaContai = this._taskAreaContainer) || void 0 === _this$_taskAreaContai || _this$_taskAreaContai._scrollView.option("height", info.height)
        }
    }
    changeGanttTaskSelection(id, selected) {
        var _this$_onSelectionCha;
        null === (_this$_onSelectionCha = this._onSelectionChanged) || void 0 === _this$_onSelectionCha || _this$_onSelectionCha.call(this, {
            id: id,
            selected: selected
        })
    }
    onGanttScroll(scrollTop) {
        var _this$_onScroll;
        null === (_this$_onScroll = this._onScroll) || void 0 === _this$_onScroll || _this$_onScroll.call(this, {
            scrollTop: scrollTop
        })
    }
    showDialog(name, parameters, callback, afterClosing) {
        var _this$_onDialogShowin;
        null === (_this$_onDialogShowin = this._onDialogShowing) || void 0 === _this$_onDialogShowin || _this$_onDialogShowin.call(this, {
            name: name,
    ...
    showPopupMenu(info) {
        ...
        null === (_this$_onPopupMenuSho = this._onPopupMenuShowing) || void 0 === _this$_onPopupMenuSho || _this$_onPopupMenuSho.call(this, info)
    }
    hidePopupMenu(info) {
        var _this$_onPopupMenuHid;
        null === (_this$_onPopupMenuHid = this._onPopupMenuHiding) || void 0 === _this$_onPopupMenuHid || _this$_onPopupMenuHid.call(this, info)
    }
    getMainElement() {
    ...
    adjustControl() {
        ...
        null === (_this$_onAdjustContro = this._onAdjustControl) || void 0 === _this$_onAdjustContro || _this$_onAdjustContro.call(this)
    }
    ...
    collapseAll() {
        ...
        null === (_this$_collapseAll = this._collapseAll) || void 0 === _this$_collapseAll || _this$_collapseAll.call(this)
    }
    expandAll() {
        var _this$_expandAll;
        null === (_this$_expandAll = this._expandAll) || void 0 === _this$_expandAll || _this$_expandAll.call(this)
    }
    onTaskClick(key, event) {
        var _this$_taskClick;
        null === (_this$_taskClick = this._taskClick) || void 0 === _this$_taskClick || _this$_taskClick.call(this, {
            key: key,
            event: event
        });
        return true
    ...
    onTaskDblClick(key, event) {
        ...
        return null === (_this$_taskDblClick = this._taskDblClick) || void 0 === _this$_taskDblClick ? void 0 : _this$_taskDblClick.call(this, {
            key: key,
            event: event
        })
    }
    ...
    onTaskAreaSizeChanged(info) {
        ...
        const scrollView = null === (_this$_taskAreaContai2 = this._taskAreaContainer) || void 0 === _this$_taskAreaContai2 ? void 0 : _this$_taskAreaContai2._scrollView;
        if (isDefined(null === info || void 0 === info ? void 0 : info.height)) {
            var _this$_taskAreaContai3;
            const direction = (null === info || void 0 === info ? void 0 : info.height) > (null === (_this$_taskAreaContai3 = this._taskAreaContainer) || void 0 === _this$_taskAreaContai3 ? void 0 : _this$_taskAreaContai3.getHeight()) ? "both" : "horizontal";
            scrollView.option("direction", direction)
        }
    }
    updateGanttViewType(type) {
        var _this$_onViewTypeChan;
        null === (_this$_onViewTypeChan = this._onViewTypeChanged) || void 0 === _this$_onViewTypeChan || _this$_onViewTypeChan.call(this, {
            type: type
        })
    }
