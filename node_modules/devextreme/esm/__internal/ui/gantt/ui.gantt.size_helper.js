/**
 * DevExtreme (esm/__internal/ui/gantt/ui.gantt.size_helper.js)
 * Version: 25.2.3
...
export class GanttSizeHelper {
    ...
    updateGanttRowHeights() {
        ...
        const rowHeight = null === (_this$_gantt$_ganttTr2 = this._gantt._ganttTreeList) || void 0 === _this$_gantt$_ganttTr2 ? void 0 : _this$_gantt$_ganttTr2.getRowHeight();
    ...
    adjustHeight() {
        if (!this._gantt._hasHeight) {
            ...
            this._gantt._setGanttViewOption("height", null === (_this$_gantt$_ganttTr3 = this._gantt._ganttTreeList) || void 0 === _this$_gantt$_ganttTr3 ? void 0 : _this$_gantt$_ganttTr3.getOffsetHeight())
        }
    }
    setInnerElementsWidth(widths) {
        ...
        this._setTreeListDimension("width", null === (_widths = widths) || void 0 === _widths ? void 0 : _widths.leftPanelWidth);
        this._setGanttViewDimension("width", null === (_widths2 = widths) || void 0 === _widths2 ? void 0 : _widths2.rightPanelWidth);
        if (takeWithFromOption) {
            var _this$_gantt$_splitte;
            null === (_this$_gantt$_splitte = this._gantt._splitter) || void 0 === _this$_gantt$_splitte || _this$_gantt$_splitte._setSplitterPositionLeft()
        }
    }
    updateGanttWidth() {
        var _this$_gantt$_splitte2;
        null === (_this$_gantt$_splitte2 = this._gantt._splitter) || void 0 === _this$_gantt$_splitte2 || _this$_gantt$_splitte2._dimensionChanged()
    }
