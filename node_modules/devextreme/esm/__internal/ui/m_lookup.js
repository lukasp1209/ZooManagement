...
class Lookup extends DropDownList {
    ...
    _getPopupHeight() {
        ...
        if (null !== (_this$_list7 = this._list) && void 0 !== _this$_list7 && _this$_list7.itemElements().length) {
            return this._calculateListHeight(this.option("grouped")) + (this._$searchWrapper ? getOuterHeight(this._$searchWrapper) : 0) + (this._popup.bottomToolbar() ? getOuterHeight(this._popup.bottomToolbar()) : 0) + (this._popup.topToolbar() ? getOuterHeight(this._popup.topToolbar()) : 0)
        }
        return "auto"
    }
