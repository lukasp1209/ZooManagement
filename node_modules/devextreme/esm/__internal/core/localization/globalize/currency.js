...
if (null !== Globalize && void 0 !== Globalize && Globalize.formatCurrency) {
    ...
    const globalizeCurrencyLocalization = {
        _formatNumberCore(value, format, formatConfig) {
            if ("currency" === format) {
                const currency = (null === formatConfig || void 0 === formatConfig ? void 0 : formatConfig.currency) ?? config().defaultCurrency;
