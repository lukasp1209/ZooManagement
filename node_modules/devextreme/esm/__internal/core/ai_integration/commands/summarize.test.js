/**
 * DevExtreme (esm/__internal/core/ai_integration/commands/summarize.test.js)
 * Version: 25.2.3
...
describe("SummarizeCommand", (() => {
    ...
    describe("parseResult", (() => {
        it("should return the string without changes", (() => {
            const result = command.parseResult("Summarized text");
    ...
    describe("execute", (() => {
        ...
        it("promptManager.buildPrompt should be called with parameters containing the passed values", (() => {
            ...
            expect(promptManager.buildPrompt).toHaveBeenCalledWith("summarize", {
                user: {
                    text: params.text
                }
            })
