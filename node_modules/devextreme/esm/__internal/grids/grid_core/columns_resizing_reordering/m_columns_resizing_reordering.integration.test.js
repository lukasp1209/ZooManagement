...
import {
    DataGridModel
} from "../../../grids/data_grid/__tests__/__mock__/model/data_grid";
const SELECTORS = {
...
describe("Performance optimization", (() => {
    ...
    describe("DraggingHeaderViewController", (() => {
        ...
        it('should call "getBoundingRect" once for each dragging panel view', (async () => {
            ...
            const dragStartEvent = getDragEvent(dragEventStart, headerOffset, {
                left: 10,
                top: 10
            });
            null === (_$headerCell$get = $headerCell.get(0)) || void 0 === _$headerCell$get || _$headerCell$get.dispatchEvent(dragStartEvent);
            const dragMoveEvent = getDragEvent(dragEventMove, headerOffset, {
                left: 500,
                top: 10
            });
            null === (_$headerCell$get2 = $headerCell.get(0)) || void 0 === _$headerCell$get2 || _$headerCell$get2.dispatchEvent(dragMoveEvent);
            const dragEndEvent = getDragEvent(dragEventEnd, headerOffset, {
                left: 500,
                top: 10
            });
            null === (_$headerCell$get3 = $headerCell.get(0)) || void 0 === _$headerCell$get3 || _$headerCell$get3.dispatchEvent(dragEndEvent);
