/**
 * DevExtreme (esm/__internal/grids/new/card_view/content_view/content/content.js)
 * Version: 25.2.3
...
export class Content extends Component {
    ...
    render() {
        ...
        this.cardElementRefs = new Array(this.props.items.length).fill(void 0).map((() => createRef()));
