/**
 * DevExtreme (esm/__internal/grids/new/grid_core/filtering/filter_sync/__intergation__/number_type.js)
 * Version: 25.2.3
...
export const NUMBER_HEADER_FILTER = [{
    caseName: "one value",
    filteredIds: [0],
    changes: {
...
export const NUMBER_FILTER_PANEL = [{
    caseName: "less one",
    filteredIds: [0],
    changes: {
        filterPanel: ["value", "<", 1]
