/**
 * DevExtreme (esm/__internal/grids/new/grid_core/filtering/filter_sync/__intergation__/date_type.js)
 * Version: 25.2.3
...
export const DATE_HEADER_FILTER = [{
...
export const DATE_FILTER_PANEL = [{
    caseName: "equal date",
    filteredIds: [4],
    changes: {
