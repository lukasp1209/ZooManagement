...
export const withKeyDownHandler = WrappedComponent => {
    class WithKeyDownHandler extends Component {
        ...
        onKeyDown(event) {
            const {
                ...
                onKeyDown: onKeyDown,
                caughtEventPreventDefault: caughtEventPreventDefault
            } = this.props;
            const ref = this.getActualRef();
            const fullKeyName = getKeyWithModifications(event);
            const handler = null === keyDownConfig || void 0 === keyDownConfig ? void 0 : keyDownConfig[fullKeyName];
            if (handler) {
                handler(event, ref);
    ...
    __decorate([eventHandler, __metadata("design:type", Function), __metadata("design:paramtypes", [Object]), __metadata("design:returntype", void 0)], WithKeyDownHandler.prototype, "onKeyDown", null);
