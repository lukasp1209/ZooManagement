...
import {
    defaultOptions as columnChooserDefaultOptions
} from "./options";
const SELECTORS = {
...
const getTreeViewInstance = () => {
    ...
    const instance = $(treeViewElement ?? void 0).dxTreeView("instance");
    return instance
};
describe("Options", (() => {
    afterEach((() => {
    ...
    describe("Column options related to ColumnChooser", (() => {
        ...
        it.each([{
            ...
            const treeView = getTreeViewInstance();
            expect(null === (_treeView$getNodes$0$ = treeView.getNodes()[0].itemData) || void 0 === _treeView$getNodes$0$ ? void 0 : _treeView$getNodes$0$.columnName).toEqual(result)
        }))
    }))
}));
