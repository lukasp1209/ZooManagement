...
import {
    getTreeNodeByPath,
    setTreeNodeByPath
} from "../../../../grids/new/grid_core/utils/tree/index";
import {
...
export function normalizeColumn(column, templateNormalizationFunc, columnFromDataOptions) {
    const dataType = column.dataType ?? (null === columnFromDataOptions || void 0 === columnFromDataOptions ? void 0 : columnFromDataOptions.dataType) ?? defaultColumnProperties.dataType;
