/**
 * DevExtreme (esm/__internal/file_management/object_provider.js)
 * Version: 25.2.3
...
class ObjectFileSystemProvider extends FileSystemProviderBase {
    ...
    _validateDirectoryExists(directoryInfo) {
        ...
        if (!this._isFileItemExists(directoryInfo) || null !== (_this$_isDirGetter = this._isDirGetter) && void 0 !== _this$_isDirGetter && _this$_isDirGetter.call(this, directoryInfo.fileItem)) {
    ...
    _createCopy(dataObj) {
        ...
        const copyObj = {};
        this._nameSetter(copyObj, null === (_this$_nameGetter = this._nameGetter) || void 0 === _this$_nameGetter ? void 0 : _this$_nameGetter.call(this, dataObj));
        this._getIsDirSetter(copyObj, null === (_this$_isDirGetter2 = this._isDirGetter) || void 0 === _this$_isDirGetter2 ? void 0 : _this$_isDirGetter2.call(this, dataObj));
    ...
    _ensureKeysForDuplicateNameItems(dataObjects) {
        ...
        dataObjects.forEach((obj => {
            ...
            const name = null === (_this$_nameGetter2 = this._nameGetter) || void 0 === _this$_nameGetter2 ? void 0 : _this$_nameGetter2.call(this, obj);
            if (names[name]) {
    ...
    _findFileItemObj(pathInfo) {
        ...
        for (let i = 0; i < pathInfo.length && (0 === i || fileItemObj); i += 1) {
            fileItemObj = fileItemObjects.find((item => {
                var _this$_isDirGetter3, _this$_nameGetter3;
                const hasCorrectFileItemType = (null === (_this$_isDirGetter3 = this._isDirGetter) || void 0 === _this$_isDirGetter3 ? void 0 : _this$_isDirGetter3.call(this, item)) || i === pathInfo.length - 1;
                return this._getKeyFromDataObject(item, currentPath) === pathInfo[i].key && (null === (_this$_nameGetter3 = this._nameGetter) || void 0 === _this$_nameGetter3 ? void 0 : _this$_nameGetter3.call(this, item)) === pathInfo[i].name && hasCorrectFileItemType
            }));
            if (fileItemObj) {
                var _this$_nameGetter4;
                currentPath = pathCombine(currentPath, null === (_this$_nameGetter4 = this._nameGetter) || void 0 === _this$_nameGetter4 ? void 0 : _this$_nameGetter4.call(this, fileItemObj));
    ...
    _getKeyFromDataObject(dataObj, defaultKeyPrefix) {
        ...
        const relativeName = pathCombine(defaultKeyPrefix, null === (_this$_nameGetter5 = this._nameGetter) || void 0 === _this$_nameGetter5 ? void 0 : _this$_nameGetter5.call(this, dataObj));
    ...
    _ensureDataObjectKey(dataObj) {
        ...
        let key = null === (_this$_keyGetter2 = this._keyGetter) || void 0 === _this$_keyGetter2 ? void 0 : _this$_keyGetter2.call(this, dataObj);
        if (!key) {
            key = String(new Guid);
    ...
    _hasSubDirs(dataObj) {
        ...
        for (let i = 0; i < subItems.length; i += 1) {
            ...
            if (true === (null === (_this$_isDirGetter4 = this._isDirGetter) || void 0 === _this$_isDirGetter4 ? void 0 : _this$_isDirGetter4.call(this, subItems[i]))) {
                return true
            }
        }
        return false
