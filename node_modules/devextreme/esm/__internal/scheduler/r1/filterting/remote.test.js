/**
 * DevExtreme (esm/__internal/scheduler/r1/filterting/remote.test.js)
 * Version: 25.2.3
...
describe("Remote filtering", (() => {
    describe("combineRemoteFilter", (() => {
        ...
        it("should return correct filter", (() => {
            ...
            expect(combinedFilter[FilterPosition_dateFilter]).toEqual(dateFilter)
        }));
        it("should return correct filter if recurrenceRuleExpr", (() => {
            ...
            expect(combinedFilter).toHaveLength(1);
            expect(combinedFilter[FilterPosition_dateFilter]).toEqual([
                [
                    ["endDate", ">=", new Date(2021, 10, 23)],
                    ["startDate", "<", new Date(2021, 10, 24)]
        ...
        describe("userFilter", (() => {
            it("should return correct filter if userFilter is present", (() => {
                ...
                expect(combinedFilter[FilterPosition_dateFilter]).toEqual(dateFilter);
                expect(combinedFilter[FilterPosition_userFilter]).toEqual(userFilter)
            }));
            it("should return correct filter if userFilter is present and dateSerializationFormat", (() => {
                ...
                expect(combinedFilter[FilterPosition_userFilter]).toEqual(["startDate", ">", "2021"])
            }));
