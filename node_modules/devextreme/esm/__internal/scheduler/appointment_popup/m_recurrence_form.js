...
export class RecurrenceForm {
    ...
    createWeekDayItems() {
        ...
        const firstDayOfWeek = this.scheduler.getFirstDayOfWeek() ?? dateLocalization.firstDayOfWeekIndex();
        ...
        return {
            ...
            template: () => {
                ...
                this.weekDayItems.forEach((item => {
                    var _this$_weekDayButtons;
                    const buttonContainer = $("<div>").appendTo($container);
                    null === (_this$_weekDayButtons = this._weekDayButtons[item.key]) || void 0 === _this$_weekDayButtons || _this$_weekDayButtons.dispose();
    ...
    createRecurrenceRule(recurrenceRuleRaw, startDate) {
        ...
        if (0 === recurrenceRule.byDay.length) {
            const defaultByDay = [weekDays[(null === startDate || void 0 === startDate ? void 0 : startDate.getDay()) ?? this.scheduler.getFirstDayOfWeek()]];
