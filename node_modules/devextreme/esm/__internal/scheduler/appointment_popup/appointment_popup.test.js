...
describe("Appointment Form", (() => {
    ...
    describe("Resources", (() => {
        ...
        it("should create resourceEditorsGroup when resources have no custom icons", (async () => {
            ...
            expect(null === resourcesGroup || void 0 === resourcesGroup || null === (_resourcesGroup$items = resourcesGroup.items) || void 0 === _resourcesGroup$items ? void 0 : _resourcesGroup$items.length).toBe(2);
            expect(null === resourcesGroup || void 0 === resourcesGroup ? void 0 : resourcesGroup.items).toEqual(expect.arrayContaining([expect.objectContaining({
        ...
        it("should create individual resource groups when resources have custom icons", (async () => {
            ...
            expect(resourcesGroup).toBeDefined();
            expect(null === resourcesGroup || void 0 === resourcesGroup || null === (_resourcesGroup$items2 = resourcesGroup.items) || void 0 === _resourcesGroup$items2 ? void 0 : _resourcesGroup$items2.length).toBe(2);
            expect(null === resourcesGroup || void 0 === resourcesGroup ? void 0 : resourcesGroup.items).toEqual(expect.arrayContaining([expect.objectContaining({
                name: "roomIdGroup",
                itemType: "group",
                items: expect.arrayContaining([expect.objectContaining({
    ...
    describe("Recurrence Form", (() => {
        ...
        it("should have disabled week day buttons when allowUpdating is false", (async () => {
            ...
            expect(null === buttonInstance || void 0 === buttonInstance ? void 0 : buttonInstance.option("disabled")).toBe(true)
        }));
        it("should be visible after changing repeat editor's value", (async () => {
            ...
            expect(null === (_POM$popup$mainGroup = POM.popup.mainGroup) || void 0 === _POM$popup$mainGroup ? void 0 : _POM$popup$mainGroup.getAttribute("tabindex")).toBeNull();
            expect(POM.popup.isRecurrenceGroupVisible()).toBe(false);
            expect(null === (_POM$popup$recurrence = POM.popup.recurrenceGroup) || void 0 === _POM$popup$recurrence ? void 0 : _POM$popup$recurrence.getAttribute("tabindex")).toBe("-1");
            ...
            expect(null === (_POM$popup$mainGroup2 = POM.popup.mainGroup) || void 0 === _POM$popup$mainGroup2 ? void 0 : _POM$popup$mainGroup2.getAttribute("tabindex")).toBe("-1");
            expect(POM.popup.isRecurrenceGroupVisible()).toBe(true);
            expect(null === (_POM$popup$recurrence2 = POM.popup.recurrenceGroup) || void 0 === _POM$popup$recurrence2 ? void 0 : _POM$popup$recurrence2.getAttribute("tabindex")).toBeNull();
            POM.popup.getBackButton().click();
            expect(POM.popup.component.option("height")).toBe("auto");
            expect(POM.popup.isMainGroupVisible()).toBe(true);
            expect(null === (_POM$popup$mainGroup3 = POM.popup.mainGroup) || void 0 === _POM$popup$mainGroup3 ? void 0 : _POM$popup$mainGroup3.getAttribute("tabindex")).toBeNull();
            expect(POM.popup.isRecurrenceGroupVisible()).toBe(false);
            expect(null === (_POM$popup$recurrence3 = POM.popup.recurrenceGroup) || void 0 === _POM$popup$recurrence3 ? void 0 : _POM$popup$recurrence3.getAttribute("tabindex")).toBe("-1")
        }));
        ...
        describe("State", (() => {
            ...
            it("should have correct input values for appointment with week frequency", (async () => {
                ...
                expect(POM.popup.getWeekDaysSelection()).toEqual([true, false, true, false, true, false, false]);
                expect(POM.popup.getInputValue("recurrenceEndCountEditor")).toBe("10 occurrence(s)")
            }));
            ...
            it("should have correct input values when opening second weekly recurring appointment", (async () => {
                ...
                expect(POM.popup.getInputValue("recurrencePeriodEditor")).toBe("Week(s)");
                expect(POM.popup.getWeekDaysSelection()).toEqual([false, true, false, true, false, false, false]);
        ...
        describe("Repeat End Values Preservation", (() => {
            it("should preserve count value when switching between recurrence types", (async () => {
                ...
                POM.popup.selectRepeatValue("weekly");
                POM.popup.openRecurrenceSettings();
                expect(POM.popup.getInputValue("recurrenceEndCountEditor")).toBe("15 occurrence(s)");
                scheduler.hideAppointmentPopup()
            }));
        ...
        describe("Repeat End Editors Disabled State", (() => {
            ["never", "until", "count"].forEach((repeatEndValue => {
                it(`should set correct disabled state when repeatEnd is ${repeatEndValue}`, (async () => {
                    ...
                    expect(null === untilEditor || void 0 === untilEditor ? void 0 : untilEditor.option("disabled")).toBe("until" !== repeatEndValue);
                    expect(null === countEditor || void 0 === countEditor ? void 0 : countEditor.option("disabled")).toBe("count" !== repeatEndValue)
                }))
            }))
        }))
    }));
    describe("firstDayOfWeek", (() => {
        ...
        it("should apply firstDayOfWeek to recurrence form startDate calendar", (async () => {
            ...
            expect(null === recurrenceStartDateEditor || void 0 === recurrenceStartDateEditor ? void 0 : recurrenceStartDateEditor.option("calendarOptions.firstDayOfWeek")).toBe(1);
            scheduler.option("firstDayOfWeek", 0);
            scheduler.showAppointmentPopup(commonAppointment);
            POM.popup.selectRepeatValue("weekly");
            ...
            expect(null === recurrenceStartDateEditorAfter || void 0 === recurrenceStartDateEditorAfter ? void 0 : recurrenceStartDateEditorAfter.option("calendarOptions.firstDayOfWeek")).toBe(0)
        }));
        it("should apply firstDayOfWeek to startDate calendar", (async () => {
            ...
            expect(null === startDateEditor || void 0 === startDateEditor ? void 0 : startDateEditor.option("calendarOptions.firstDayOfWeek")).toBe(1);
            scheduler.option("firstDayOfWeek", 0);
            scheduler.showAppointmentPopup(commonAppointment);
            const startDateEditorAfter = POM.popup.form.getEditor("startDateEditor");
            expect(startDateEditorAfter).toBeDefined();
            expect(null === startDateEditorAfter || void 0 === startDateEditorAfter ? void 0 : startDateEditorAfter.option("calendarOptions.firstDayOfWeek")).toBe(0)
        }));
        it("should apply firstDayOfWeek to endDate calendar", (async () => {
            ...
            expect(null === endDateEditor || void 0 === endDateEditor ? void 0 : endDateEditor.option("calendarOptions.firstDayOfWeek")).toBe(1);
            scheduler.option("firstDayOfWeek", 0);
            scheduler.showAppointmentPopup(commonAppointment);
            const endDateEditorAfter = POM.popup.form.getEditor("endDateEditor");
            expect(endDateEditorAfter).toBeDefined();
            expect(null === endDateEditorAfter || void 0 === endDateEditorAfter ? void 0 : endDateEditorAfter.option("calendarOptions.firstDayOfWeek")).toBe(0)
        }))
    }));
    describe("Icons", (() => {
        describe("Subject icon", (() => {
            ...
            it("has resource color when appointment has resource", (async () => {
                ...
                await new Promise(process.nextTick);
                const $icon = $(POM.popup.subjectIcon);
                expect($icon.css("color")).toBe("rgb(255, 0, 0)");
                POM.popup.setInputValue("roomId", 2);
                await new Promise(process.nextTick);
                expect($icon.css("color")).toBe("rgb(0, 0, 255)")
            }))
        }));
...
describe("Appointment Popup", (() => {
    ...
    describe("Toolbar", (() => {
        describe("Popup Title", (() => {
            it('should display "New Appointment" when creating new appointment', (async () => {
                ...
                expect(null === titleItem || void 0 === titleItem ? void 0 : titleItem.text).toBe("New Appointment")
            }));
            it('should display "Edit Appointment" when editing existing appointment', (async () => {
                ...
                const toolbarItems = POM.popup.component.option("toolbarItems");
                const titleItem = null === toolbarItems || void 0 === toolbarItems ? void 0 : toolbarItems.find((item => "dx-toolbar-label" === item.cssClass));
                expect(null === titleItem || void 0 === titleItem ? void 0 : titleItem.text).toBe("Edit Appointment")
            }))
        }));
        it.each([{
            allowUpdating: false,
    ...
    describe("Customization", (() => {
        ...
        it("should preserve custom toolbarItems when popup is reopened", (async () => {
            ...
            expect(null === toolbarItems || void 0 === toolbarItems || null === (_toolbarItems$ = toolbarItems[0]) || void 0 === _toolbarItems$ ? void 0 : _toolbarItems$.text).toBe("Custom Toolbar")
        }));
...
describe("Customize form items", (() => {
    ...
    describe("Basic form customization", (() => {
        it("should use default form when editing.items is not set", (async () => {
            ...
            expect(null === formItems || void 0 === formItems ? void 0 : formItems.length).toBeGreaterThan(0)
        }));
        it("should show empty form when editing.items is empty array", (async () => {
            ...
            const formItems = form.option("items");
            expect((null === formItems || void 0 === formItems ? void 0 : formItems.length) ?? 0).toBe(0)
        }));
        it("should show mainGroup when specified in string array", (async () => {
            ...
            const formItems = form.option("items");
            expect(null === formItems || void 0 === formItems ? void 0 : formItems.length).toBe(1);
            expect(null === formItems || void 0 === formItems || null === (_formItems$ = formItems[0]) || void 0 === _formItems$ ? void 0 : _formItems$.name).toBe("mainGroup")
        }));
        it("should hide group when visible is false", (async () => {
            ...
            const formItems = form.option("items");
            expect(null === formItems || void 0 === formItems ? void 0 : formItems.length).toBe(1);
            expect(null === formItems || void 0 === formItems || null === (_formItems$2 = formItems[0]) || void 0 === _formItems$2 ? void 0 : _formItems$2.visible).toBe(false)
        }));
        it("should show group when visible is true", (async () => {
            ...
            const formItems = form.option("items");
            expect(null === formItems || void 0 === formItems ? void 0 : formItems.length).toBe(1);
            expect(null === formItems || void 0 === formItems || null === (_formItems$3 = formItems[0]) || void 0 === _formItems$3 ? void 0 : _formItems$3.visible).toBe(true)
        }));
        it("should filter children when items array is specified", (async () => {
            ...
            expect(null === formItems || void 0 === formItems ? void 0 : formItems.length).toBe(1);
            expect(null === mainGroup || void 0 === mainGroup || null === (_mainGroup$items3 = mainGroup.items) || void 0 === _mainGroup$items3 ? void 0 : _mainGroup$items3.length).toBe(1);
            expect(null === mainGroup || void 0 === mainGroup || null === (_mainGroup$items4 = mainGroup.items) || void 0 === _mainGroup$items4 || null === (_mainGroup$items4 = _mainGroup$items4[0]) || void 0 === _mainGroup$items4 ? void 0 : _mainGroup$items4.name).toBe("subjectGroup")
        }));
        it("should handle non-existent groups gracefully", (async () => {
            ...
            const formItems = form.option("items");
            expect((null === formItems || void 0 === formItems ? void 0 : formItems.length) ?? 0).toBe(1)
        }));
    ...
    describe("Form customization with editing.items", (() => {
        it("should handle empty items array", (async () => {
            ...
            const formItems = form.option("items");
            expect(null === formItems || void 0 === formItems ? void 0 : formItems.length).toBe(0)
        }));
        it("should handle string array configuration", (async () => {
            ...
            const formItems = form.option("items");
            expect(null === formItems || void 0 === formItems ? void 0 : formItems.length).toBe(1);
            expect(null === formItems || void 0 === formItems || null === (_formItems$4 = formItems[0]) || void 0 === _formItems$4 ? void 0 : _formItems$4.name).toBe("mainGroup")
        }));
        it("should handle object configuration with visible false", (async () => {
            ...
            const formItems = form.option("items");
            expect(null === formItems || void 0 === formItems ? void 0 : formItems.length).toBe(1);
            expect(null === formItems || void 0 === formItems || null === (_formItems$5 = formItems[0]) || void 0 === _formItems$5 ? void 0 : _formItems$5.visible).toBe(false)
        }));
        it("should handle object configuration with custom items", (async () => {
            ...
            const formItems = form.option("items");
            const mainGroup = null === formItems || void 0 === formItems ? void 0 : formItems[0];
            expect(null === mainGroup || void 0 === mainGroup || null === (_mainGroup$items5 = mainGroup.items) || void 0 === _mainGroup$items5 ? void 0 : _mainGroup$items5.length).toBe(2);
            expect(null === mainGroup || void 0 === mainGroup || null === (_mainGroup$items6 = mainGroup.items) || void 0 === _mainGroup$items6 || null === (_mainGroup$items6 = _mainGroup$items6[0]) || void 0 === _mainGroup$items6 ? void 0 : _mainGroup$items6.name).toBe("subjectGroup");
            expect(null === mainGroup || void 0 === mainGroup || null === (_mainGroup$items7 = mainGroup.items) || void 0 === _mainGroup$items7 || null === (_mainGroup$items7 = _mainGroup$items7[1]) || void 0 === _mainGroup$items7 ? void 0 : _mainGroup$items7.name).toBe("dateGroup")
        }));
        ...
        it("should handle mixed configurations", (async () => {
            ...
            const formItems = form.option("items");
            expect(null === formItems || void 0 === formItems ? void 0 : formItems.length).toBe(2);
            expect(null === formItems || void 0 === formItems || null === (_formItems$6 = formItems[0]) || void 0 === _formItems$6 ? void 0 : _formItems$6.name).toBe("mainGroup");
            expect(null === formItems || void 0 === formItems || null === (_formItems$7 = formItems[1]) || void 0 === _formItems$7 ? void 0 : _formItems$7.name).toBe("mainGroup");
            expect(null === formItems || void 0 === formItems || null === (_formItems$8 = formItems[1]) || void 0 === _formItems$8 ? void 0 : _formItems$8.visible).toBe(false)
        }));
        it("should handle empty items array in object config", (async () => {
            ...
            const formItems = form.option("items");
            const mainGroup = null === formItems || void 0 === formItems ? void 0 : formItems[0];
            expect(null === mainGroup || void 0 === mainGroup || null === (_mainGroup$items8 = mainGroup.items) || void 0 === _mainGroup$items8 ? void 0 : _mainGroup$items8.length).toBe(0)
        }))
    }))
}));
