/**
 * DevExtreme (esm/__internal/scheduler/view_model/generate_view_model/options/get_month_intervals.js)
 * Version: 25.2.3
...
import {
    shiftIntervals
} from "../../common/shift_intervals";
import {
    trimInterval
} from "../../common/trim_interval";
import {
...
export const getMonthIntervals = (_ref, viewOffset, isTimeline) => {
    ...
    } = _ref, dateInterval = _objectWithoutPropertiesLoose(_ref, _excluded);
