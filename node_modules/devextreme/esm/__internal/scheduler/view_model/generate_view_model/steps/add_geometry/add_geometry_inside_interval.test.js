/**
 * DevExtreme (esm/__internal/scheduler/view_model/generate_view_model/steps/add_geometry/add_geometry_inside_interval.test.js)
 * Version: 25.2.3
...
describe("addGeometryInsideInterval", (() => {
    it("should position appointment inside horizontal interval", (() => {
        ...
        expect(addGeometryInsideInterval(entity, {
            intervals: intervals,
            cells: cells,
