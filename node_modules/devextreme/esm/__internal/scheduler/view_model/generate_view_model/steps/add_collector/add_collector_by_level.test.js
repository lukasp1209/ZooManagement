/**
 * DevExtreme (esm/__internal/scheduler/view_model/generate_view_model/steps/add_collector/add_collector_by_level.test.js)
 * Version: 25.2.3
...
describe("addCollectorByLevel", (() => {
    it("should add empty collector for non-overlapping appointments", (() => {
        ...
        expect(addCollectorByLevel(items, {
            cells: monthCells,
            minLevel: 3,
            maxLevel: 3,
