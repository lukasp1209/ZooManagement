...
} from "./utils/view_provider_utils";
export default class ViewDataProvider {
    ...
    getCellData(rowIndex, columnIndex) {
        let isAllDay = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : false;
        let rtlEnabled = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : false;
    ...
    hasGroupAllDayPanel(groupIndex) {
        ...
        if (this._options.isVerticalGrouping) {
            ...
            return Boolean(null === (_this$groupedDataMap$ = this.groupedDataMap.dateTableGroupedMap[groupIndex]) || void 0 === _this$groupedDataMap$ ? void 0 : _this$groupedDataMap$[0][0].cellData.allDay)
        }
