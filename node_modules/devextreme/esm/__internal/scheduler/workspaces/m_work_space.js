...
class SchedulerWorkSpace extends Widget {
    ...
    _getScrollCoordinates(hours, minutes, date, groupIndex, allDay) {
        ...
        return this.virtualScrollingDispatcher.calculateCoordinatesByDataAndPosition(null === cell || void 0 === cell ? void 0 : cell.cellData, null === cell || void 0 === cell ? void 0 : cell.position, currentDate, isDateAndTimeView(this.type), "vertical" === this.viewDirection)
    }
    ...
    getPanelDOMSize(panelName) {
        return "allDayPanel" === panelName ? this.cache.memo("allDayPanelSize", (() => getBoundingRect(this._$allDayPanel.get(0)))) : this.cache.memo("regularPanelSize", (() => getBoundingRect(this._getDateTable().get(0))))
    }
