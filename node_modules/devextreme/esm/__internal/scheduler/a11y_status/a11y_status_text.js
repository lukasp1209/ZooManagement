...
export const getA11yStatusText = (view, startDate, endDate, appointmentCount, indicatorTime) => {
    ...
    const intervalText = startDateText === endDateText ? `${startDateText}` : messageLocalization.format(KEYS.dateRange, startDateText, endDateText);
    const statusText = messageLocalization.format(KEYS.label, viewTypeLabel, intervalText, appointmentCount);
    if (indicatorTime) {
