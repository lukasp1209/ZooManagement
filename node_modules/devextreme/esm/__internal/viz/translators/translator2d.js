/**
 * DevExtreme (esm/__internal/viz/translators/translator2d.js)
 * Version: 25.2.3
...
import categoryTranslator from "../../viz/translators/category_translator";
import datetimeTranslator from "../../viz/translators/datetime_translator";
import intervalTranslator from "../../viz/translators/interval_translator";
import logarithmicTranslator from "../../viz/translators/logarithmic_translator";
import {
    Range
...
_Translator2d.prototype = {
    ...
    _prepareCanvasOptions() {
        ...
        canvasOptions.rangeDoubleError = 10 ** (getPower(canvasOptions.rangeMax - canvasOptions.rangeMin) - getPower(length) - 2);
