/**
 * DevExtreme (esm/__internal/viz/series/points/symbol_point.js)
 * Version: 25.2.3
...
export default {
    ...
    _checkImage: image => _isDefined(image) && ("string" === typeof image || _isDefined(image.url)),
    _fillStyle() {
    ...
    _isPointInVisibleArea: (visibleArea, graphicBBox) => visibleArea.minX <= graphicBBox.x + graphicBBox.width && visibleArea.maxX >= graphicBBox.x && visibleArea.minY <= graphicBBox.y + graphicBBox.height && visibleArea.maxY >= graphicBBox.y,
