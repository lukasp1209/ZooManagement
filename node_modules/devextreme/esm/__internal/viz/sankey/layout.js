/**
 * DevExtreme (esm/__internal/viz/sankey/layout.js)
 * Version: 25.2.3
 ...
 */
import validatorModule from "../../viz/sankey/data_validator";
import graphModule from "../../viz/sankey/graph";
...
export const layout = {
    ...
    overlap: (box1, box2) => !(box2.x > box1.x + box1.width || box2.x + box2.width < box1.x || box2.y >= box1.y + box1.height || box2.y + box2.height <= box1.y)
};
