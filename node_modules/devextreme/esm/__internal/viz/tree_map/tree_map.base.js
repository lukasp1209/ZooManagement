/**
 * DevExtreme (esm/__internal/viz/tree_map/tree_map.base.js)
 * Version: 25.2.3
...
const dxTreeMap = baseWidget.inherit({
    _handlers: {
        ...
        calculateState: options => _buildRectAppearance(options)
    },
