...
proto._createProxyType = function() {
    ...
    Proxy.prototype = {
        ...
        getAllChildren() {
            const _nodes = nodes[this._id].nodes;
            let i;
            const ii = null === _nodes || void 0 === _nodes ? void 0 : _nodes.length;
            const list = [];
            for (i = 0; i < ii; ++i) {
...
function collectNodes(node, list) {
    ...
    let i;
    const ii = null === nodes || void 0 === nodes ? void 0 : nodes.length;
    for (i = 0; i < ii; ++i) {
...
nodeProto.updateLabelStyle = function() {
    ...
    if (null !== custom && void 0 !== custom && custom.label) {
