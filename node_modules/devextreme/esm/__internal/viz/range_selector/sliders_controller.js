/**
 * DevExtreme (esm/__internal/viz/range_selector/sliders_controller.js)
 * Version: 25.2.3
...
import Slider from "../../viz/range_selector/slider";
...
SlidersController.prototype = {
    ...
    update(verticalRange, behavior, isCompactMode, sliderHandleOptions, sliderMarkerOptions, shutterOptions, rangeBounds, fullTicks, selectedRangeColor) {
        ...
        this._isOnMoving = "onhandlemove" === _normalizeEnum(behavior.valueChangeMode);
