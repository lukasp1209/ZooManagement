/**
 * DevExtreme (esm/__internal/viz/core/helpers.js)
 * Version: 25.2.3
...
export const replaceInherit = isServerSide ? function(widget) {
    ...
    widget.inherit = function() {
        ...
        ["_plugins", "_eventsMap", "_initialChanges", "_themeDependentChanges", "_optionChangesMap", "_optionChangesOrder", "_layoutChangesOrder", "_customChangesOrder", "_totalChangesOrder"].forEach((key => {
            proto[key] = {}
        }));
