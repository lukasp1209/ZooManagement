/**
 * DevExtreme (esm/__internal/viz/axes/polar_axes.js)
 * Version: 25.2.3
...
import xyAxes from "../../viz/axes/xy_axes";
import {
    convertPolarToXY,
    convertXYToPolar,
    getCosAndSin,
...
const circularAxes = {
    ...
    _validateOverlappingMode: mode => constants.validateOverlappingMode(mode),
...
export const circularSpider = extend({}, circularAxes, {
    ...
    _updateAxisElementPosition() {
        this._axisElement.attr({
            points: _map(this.getSpiderTicks(), (tick => ({
                x: tick.coords.x,
                y: tick.coords.y
            })))
        })
...
export const linearSpider = extend({}, linear, {
    ...
    _getGridPointsByRadius(radius) {
        ...
        return {
            points: _map(this._spiderTicks, (tick => {
