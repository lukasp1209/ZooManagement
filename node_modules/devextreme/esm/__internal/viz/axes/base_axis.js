/**
 * DevExtreme (esm/__internal/viz/axes/base_axis.js)
 * Version: 25.2.3
...
import {
    ...
    measureLabels
} from "../../viz/axes/axes_utils";
import createConstantLine from "../../viz/axes/constant_line";
import * as polarMethods from "../../viz/axes/polar_axes";
import {
    formatRange,
    smartFormatter as _format
} from "../../viz/axes/smart_formatter";
import createStrip from "../../viz/axes/strip";
import {
    tick
} from "../../viz/axes/tick";
import {
    tickGenerator
} from "../../viz/axes/tick_generator";
import xyMethods from "../../viz/axes/xy_axes";
import {
    getParser
} from "../../viz/components/parse_utils";
import {
    adjustVisualRange,
...
Axis.prototype = {
    ...
    getFullTicks() {
        ...
        if (this._options.type === constants.discrete) {
            ...
            return convertTicksToValues(majors.concat(this._minorTicks, this._boundaryTicks)).sort(((a, b) => valueOf(a) - valueOf(b)))
        }
    },
    ...
    _createTranslator: () => new Translator2D({}, {}, {}),
    _updateTranslator() {
        const translator = this._translator;
