/**
 * DevExtreme (esm/__internal/exporter/image_creator.js)
 * Version: 25.2.3
...
function parseUrl(urlString) {
    const matches = null === urlString || void 0 === urlString ? void 0 : urlString.match(/url\(.*#(.*?)["']?\)/i);
    return null === matches || void 0 === matches ? void 0 : matches[1]
}
...
function asyncEach(array, callback) {
    let d = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : Deferred();
    let i = 0;
...
function drawCanvasElements(elements, context, parentOptions, shared) {
    return asyncEach(elements, (element => {
        ...
        switch (null === (_element$tagName = element.tagName) || void 0 === _element$tagName ? void 0 : _element$tagName.toLowerCase()) {
            case "g":
            case "svg": {
                const options = extend({}, parentOptions, getElementOptions(element, shared.rootAppended));
                context.save();
...
function setLineDash(context, options) {
    ...
    if (null !== (_matches = matches) && void 0 !== _matches && _matches.length) {
        matches = _map(matches, (item => _number(item)));
...
export const imageCreator = {
    ...
    _getBase64: binaryData => window.btoa(binaryData),
