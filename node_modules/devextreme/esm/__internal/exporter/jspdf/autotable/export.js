...
export const Export = {
    ...
    export (options) {
        ...
        const initialLoadPanelEnabledOption = null === (_internalComponent$op = internalComponent.option("loadPanel")) || void 0 === _internalComponent$op ? void 0 : _internalComponent$op.enabled;
    ...
    _tryGetMergeRange(rowIndex, cellIndex, mergedCells, dataProvider) {
        ...
        if (!(null !== (_mergedCells$rowIndex = mergedCells[rowIndex]) && void 0 !== _mergedCells$rowIndex && _mergedCells$rowIndex[cellIndex])) {
            const {
                colspan: colspan,
                rowspan: rowspan
