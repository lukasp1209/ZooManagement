...
export declare class DxoFileManagerItemViewComponent extends NestedOption implements OnDestroy, OnInit {
    get details(): {
...
export declare class DxoFileManagerItemViewModule {
