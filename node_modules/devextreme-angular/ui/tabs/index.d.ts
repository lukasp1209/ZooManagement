...
import * as i2 from "devextreme-angular/ui/tabs/nested";
 ...
 */
export declare class DxTabsComponent<TItem = any, TKey = any> extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    dataSourceChange: EventEmitter<Array<any | dxTabsItem | string> | DataSource | DataSourceOptions | null | Store | string>;
    /**
     ...
     */
    itemsChange: EventEmitter<Array<any | dxTabsItem | string>>;
    /**
