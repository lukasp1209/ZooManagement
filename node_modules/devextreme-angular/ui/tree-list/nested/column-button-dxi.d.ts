...
export declare class DxiTreeListColumnButtonComponent extends CollectionNestedOption implements AfterViewInit, IDxTemplateHost {
    private renderer;
    private document;
    private element;
    get cssClass(): string;
...
export declare class DxiTreeListColumnButtonModule {
