...
export declare class DxoTreeListFilterPanelComponent extends NestedOption implements OnDestroy, OnInit {
    get customizeText(): ((e: {
...
export declare class DxoTreeListFilterPanelModule {
