...
export declare class DxoTreeListColumnFixingTextsComponent extends NestedOption implements OnDestroy, OnInit {
    get fix(): string;
...
export declare class DxoTreeListColumnFixingTextsModule {
