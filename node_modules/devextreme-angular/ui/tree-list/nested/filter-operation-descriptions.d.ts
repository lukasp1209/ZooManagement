...
export declare class DxoTreeListFilterOperationDescriptionsComponent extends NestedOption implements OnDestroy, OnInit {
    get between(): string;
...
export declare class DxoTreeListFilterOperationDescriptionsModule {
