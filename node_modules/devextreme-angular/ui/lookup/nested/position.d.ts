...
export declare class DxoLookupPositionComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoLookupPositionComponent, [{ host: true; skipSelf: true; }, { host: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoLookupPositionComponent, "dxo-lookup-position", never, { "at": { "alias": "at"; "required": false; }; "boundary": { "alias": "boundary"; "required": false; }; "boundaryOffset": { "alias": "boundaryOffset"; "required": false; }; "collision": { "alias": "collision"; "required": false; }; "my": { "alias": "my"; "required": false; }; "of": { "alias": "of"; "required": false; }; "offset": { "alias": "offset"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoLookupPositionModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoLookupPositionModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoLookupPositionModule, never, [typeof DxoLookupPositionComponent], [typeof DxoLookupPositionComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxoLookupPositionModule>;
}
