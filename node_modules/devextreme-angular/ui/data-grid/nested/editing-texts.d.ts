...
export declare class DxoDataGridEditingTextsComponent extends NestedOption implements OnDestroy, OnInit {
    get addRow(): string;
...
export declare class DxoDataGridEditingTextsModule {
