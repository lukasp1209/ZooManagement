...
export declare class DxoDataGridFilterPanelComponent extends NestedOption implements OnDestroy, OnInit {
    get customizeText(): ((e: {
...
export declare class DxoDataGridFilterPanelModule {
