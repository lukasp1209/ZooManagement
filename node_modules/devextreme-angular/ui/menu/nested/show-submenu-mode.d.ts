...
export declare class DxoMenuShowSubmenuModeComponent extends NestedOption implements OnDestroy, OnInit {
    get delay(): number | {
        hide?: number;
        show?: number;
    };
...
export declare class DxoMenuShowSubmenuModeModule {
