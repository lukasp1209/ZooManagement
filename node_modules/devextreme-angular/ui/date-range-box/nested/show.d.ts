...
export declare class DxoDateRangeBoxShowComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDateRangeBoxShowComponent, [{ host: true; skipSelf: true; }, { host: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoDateRangeBoxShowComponent, "dxo-date-range-box-show", never, { "complete": { "alias": "complete"; "required": false; }; "delay": { "alias": "delay"; "required": false; }; "direction": { "alias": "direction"; "required": false; }; "duration": { "alias": "duration"; "required": false; }; "easing": { "alias": "easing"; "required": false; }; "from": { "alias": "from"; "required": false; }; "staggerDelay": { "alias": "staggerDelay"; "required": false; }; "start": { "alias": "start"; "required": false; }; "to": { "alias": "to"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoDateRangeBoxShowModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDateRangeBoxShowModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoDateRangeBoxShowModule, never, [typeof DxoDateRangeBoxShowComponent], [typeof DxoDateRangeBoxShowComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxoDateRangeBoxShowModule>;
}
