...
export declare class DxoDateRangeBoxHideComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDateRangeBoxHideComponent, [{ host: true; skipSelf: true; }, { host: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoDateRangeBoxHideComponent, "dxo-date-range-box-hide", never, { "complete": { "alias": "complete"; "required": false; }; "delay": { "alias": "delay"; "required": false; }; "direction": { "alias": "direction"; "required": false; }; "duration": { "alias": "duration"; "required": false; }; "easing": { "alias": "easing"; "required": false; }; "from": { "alias": "from"; "required": false; }; "staggerDelay": { "alias": "staggerDelay"; "required": false; }; "start": { "alias": "start"; "required": false; }; "to": { "alias": "to"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoDateRangeBoxHideModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDateRangeBoxHideModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoDateRangeBoxHideModule, never, [typeof DxoDateRangeBoxHideComponent], [typeof DxoDateRangeBoxHideComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxoDateRangeBoxHideModule>;
}
