...
export declare class DxoDropDownBoxShowComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDropDownBoxShowComponent, [{ host: true; skipSelf: true; }, { host: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoDropDownBoxShowComponent, "dxo-drop-down-box-show", never, { "complete": { "alias": "complete"; "required": false; }; "delay": { "alias": "delay"; "required": false; }; "direction": { "alias": "direction"; "required": false; }; "duration": { "alias": "duration"; "required": false; }; "easing": { "alias": "easing"; "required": false; }; "from": { "alias": "from"; "required": false; }; "staggerDelay": { "alias": "staggerDelay"; "required": false; }; "start": { "alias": "start"; "required": false; }; "to": { "alias": "to"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoDropDownBoxShowModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDropDownBoxShowModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoDropDownBoxShowModule, never, [typeof DxoDropDownBoxShowComponent], [typeof DxoDropDownBoxShowComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxoDropDownBoxShowModule>;
}
