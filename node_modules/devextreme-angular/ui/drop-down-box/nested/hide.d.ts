...
export declare class DxoDropDownBoxHideComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDropDownBoxHideComponent, [{ host: true; skipSelf: true; }, { host: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoDropDownBoxHideComponent, "dxo-drop-down-box-hide", never, { "complete": { "alias": "complete"; "required": false; }; "delay": { "alias": "delay"; "required": false; }; "direction": { "alias": "direction"; "required": false; }; "duration": { "alias": "duration"; "required": false; }; "easing": { "alias": "easing"; "required": false; }; "from": { "alias": "from"; "required": false; }; "staggerDelay": { "alias": "staggerDelay"; "required": false; }; "start": { "alias": "start"; "required": false; }; "to": { "alias": "to"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoDropDownBoxHideModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDropDownBoxHideModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoDropDownBoxHideModule, never, [typeof DxoDropDownBoxHideComponent], [typeof DxoDropDownBoxHideComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxoDropDownBoxHideModule>;
}
