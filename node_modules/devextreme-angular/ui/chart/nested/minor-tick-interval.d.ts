...
export declare class DxoChartMinorTickIntervalComponent extends NestedOption implements OnDestroy, OnInit {
    get days(): number;
...
export declare class DxoChartMinorTickIntervalModule {
