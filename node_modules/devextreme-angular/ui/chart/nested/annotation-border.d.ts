...
export declare class DxoChartAnnotationBorderComponent extends NestedOption implements OnDestroy, OnInit {
    get color(): string;
...
export declare class DxoChartAnnotationBorderModule {
