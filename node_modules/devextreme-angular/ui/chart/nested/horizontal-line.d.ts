...
export declare class DxoChartHorizontalLineComponent extends NestedOption implements OnDestroy, OnInit {
    get color(): string;
...
export declare class DxoChartHorizontalLineModule {
