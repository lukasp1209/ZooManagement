...
export declare class DxoChartMinVisualRangeLengthComponent extends NestedOption implements OnDestroy, OnInit {
    get days(): number;
...
export declare class DxoChartMinVisualRangeLengthModule {
