...
export declare class DxoChartCommonSeriesSettingsSelectionStyleComponent extends NestedOption implements OnDestroy, OnInit {
    get border(): {
...
export declare class DxoChartCommonSeriesSettingsSelectionStyleModule {
