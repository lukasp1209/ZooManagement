...
export declare class DxoSankeyAdaptiveLayoutComponent extends NestedOption implements OnDestroy, OnInit {
    get height(): number;
...
export declare class DxoSankeyAdaptiveLayoutModule {
