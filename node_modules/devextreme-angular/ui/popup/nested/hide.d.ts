...
export declare class DxoPopupHideComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoPopupHideComponent, [{ host: true; skipSelf: true; }, { host: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoPopupHideComponent, "dxo-popup-hide", never, { "complete": { "alias": "complete"; "required": false; }; "delay": { "alias": "delay"; "required": false; }; "direction": { "alias": "direction"; "required": false; }; "duration": { "alias": "duration"; "required": false; }; "easing": { "alias": "easing"; "required": false; }; "from": { "alias": "from"; "required": false; }; "staggerDelay": { "alias": "staggerDelay"; "required": false; }; "start": { "alias": "start"; "required": false; }; "to": { "alias": "to"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoPopupHideModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoPopupHideModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoPopupHideModule, never, [typeof DxoPopupHideComponent], [typeof DxoPopupHideComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxoPopupHideModule>;
}
