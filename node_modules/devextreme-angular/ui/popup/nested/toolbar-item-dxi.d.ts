...
export declare class DxiPopupToolbarItemComponent extends CollectionNestedOption implements AfterViewInit, IDxTemplateHost {
    private renderer;
    private document;
    private element;
    ...
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxiPopupToolbarItemComponent, [{ host: true; skipSelf: true; }, { host: true; }, null, null, { host: true; }, null]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxiPopupToolbarItemComponent, "dxi-popup-toolbar-item", never, { "cssClass": { "alias": "cssClass"; "required": false; }; "disabled": { "alias": "disabled"; "required": false; }; "html": { "alias": "html"; "required": false; }; "locateInMenu": { "alias": "locateInMenu"; "required": false; }; "location": { "alias": "location"; "required": false; }; "menuItemTemplate": { "alias": "menuItemTemplate"; "required": false; }; "options": { "alias": "options"; "required": false; }; "showText": { "alias": "showText"; "required": false; }; "template": { "alias": "template"; "required": false; }; "text": { "alias": "text"; "required": false; }; "toolbar": { "alias": "toolbar"; "required": false; }; "visible": { "alias": "visible"; "required": false; }; "widget": { "alias": "widget"; "required": false; }; }, {}, never, ["*"], true, never>;
}
export declare class DxiPopupToolbarItemModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxiPopupToolbarItemModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxiPopupToolbarItemModule, never, [typeof DxiPopupToolbarItemComponent], [typeof DxiPopupToolbarItemComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxiPopupToolbarItemModule>;
}
