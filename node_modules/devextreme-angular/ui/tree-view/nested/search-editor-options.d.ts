...
export declare class DxoTreeViewSearchEditorOptionsComponent extends NestedOption implements OnDestroy, OnInit {
...
export declare class DxoTreeViewSearchEditorOptionsModule {
