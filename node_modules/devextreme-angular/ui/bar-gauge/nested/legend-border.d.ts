...
export declare class DxoBarGaugeLegendBorderComponent extends NestedOption implements OnDestroy, OnInit {
    get color(): string;
...
export declare class DxoBarGaugeLegendBorderModule {
