...
export declare class DxoBarGaugeItemTextFormatComponent extends NestedOption implements OnDestroy, OnInit {
    get currency(): string;
...
export declare class DxoBarGaugeItemTextFormatModule {
