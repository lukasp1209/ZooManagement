...
export declare class DxoBarGaugeBarGaugeTitleSubtitleComponent extends NestedOption implements OnDestroy, OnInit {
    get font(): Font;
    set font(value: Font);
    get offset(): number;
...
export declare class DxoBarGaugeBarGaugeTitleSubtitleModule {
