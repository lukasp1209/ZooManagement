...
export declare class DxoBarGaugeBarGaugeTitleComponent extends NestedOption implements OnDestroy, OnInit {
    get font(): Font;
    set font(value: Font);
...
export declare class DxoBarGaugeBarGaugeTitleModule {
