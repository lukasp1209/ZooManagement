...
export declare class DxoBarGaugeLegendTitleSubtitleComponent extends NestedOption implements OnDestroy, OnInit {
    get font(): Font;
    set font(value: Font);
    get offset(): number;
...
export declare class DxoBarGaugeLegendTitleSubtitleModule {
