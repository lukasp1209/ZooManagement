...
export declare class DxoLoadPanelBoundaryOffsetComponent extends NestedOption implements OnDestroy, OnInit {
    get x(): number;
    set x(value: number);
    get y(): number;
    set y(value: number);
...
export declare class DxoLoadPanelBoundaryOffsetModule {
