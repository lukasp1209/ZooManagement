...
export declare class DxoPieChartAdaptiveLayoutComponent extends NestedOption implements OnDestroy, OnInit {
    get height(): number;
...
export declare class DxoPieChartAdaptiveLayoutModule {
