...
export declare class DxoPieChartSmallValuesGroupingComponent extends NestedOption implements OnDestroy, OnInit {
...
export declare class DxoPieChartSmallValuesGroupingModule {
