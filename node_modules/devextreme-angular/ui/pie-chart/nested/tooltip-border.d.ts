...
export declare class DxoPieChartTooltipBorderComponent extends NestedOption implements OnDestroy, OnInit {
    get color(): string;
...
export declare class DxoPieChartTooltipBorderModule {
