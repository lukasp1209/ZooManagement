...
export declare class DxoDateBoxDisplayFormatComponent extends NestedOption implements OnDestroy, OnInit {
    get currency(): string;
...
export declare class DxoDateBoxDisplayFormatModule {
