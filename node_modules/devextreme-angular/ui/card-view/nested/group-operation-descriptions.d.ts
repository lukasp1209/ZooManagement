...
export declare class DxoCardViewGroupOperationDescriptionsComponent extends NestedOption implements OnDestroy, OnInit {
    get and(): string;
...
export declare class DxoCardViewGroupOperationDescriptionsModule {
