...
export declare class DxoCardViewFilterOperationDescriptionsComponent extends NestedOption implements OnDestroy, OnInit {
    get between(): string;
...
export declare class DxoCardViewFilterOperationDescriptionsModule {
