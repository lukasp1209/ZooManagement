...
export declare class DxoCardViewHeaderPanelComponent extends NestedOption implements OnDestroy, OnInit {
    get dragging(): {
...
export declare class DxoCardViewHeaderPanelModule {
