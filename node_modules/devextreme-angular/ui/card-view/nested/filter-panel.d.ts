...
export declare class DxoCardViewFilterPanelComponent extends NestedOption implements OnDestroy, OnInit {
    get customizeText(): ((e: {
...
export declare class DxoCardViewFilterPanelModule {
