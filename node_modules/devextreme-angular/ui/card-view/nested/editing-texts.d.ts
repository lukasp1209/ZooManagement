...
export declare class DxoCardViewEditingTextsComponent extends NestedOption implements OnDestroy, OnInit {
    get addCard(): string;
...
export declare class DxoCardViewEditingTextsModule {
