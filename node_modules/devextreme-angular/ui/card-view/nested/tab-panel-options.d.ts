...
export declare class DxoCardViewTabPanelOptionsComponent extends NestedOption implements OnDestroy, OnInit {
...
export declare class DxoCardViewTabPanelOptionsModule {
