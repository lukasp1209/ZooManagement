...
export declare class DxoRangeSelectorArgumentFormatComponent extends NestedOption implements OnDestroy, OnInit {
    get currency(): string;
...
export declare class DxoRangeSelectorArgumentFormatModule {
