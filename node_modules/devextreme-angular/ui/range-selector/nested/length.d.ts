...
export declare class DxoRangeSelectorLengthComponent extends NestedOption implements OnDestroy, OnInit {
    get days(): number;
...
export declare class DxoRangeSelectorLengthModule {
