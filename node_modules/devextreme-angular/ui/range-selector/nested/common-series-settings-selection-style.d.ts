...
export declare class DxoRangeSelectorCommonSeriesSettingsSelectionStyleComponent extends NestedOption implements OnDestroy, OnInit {
    get border(): {
...
export declare class DxoRangeSelectorCommonSeriesSettingsSelectionStyleModule {
