...
export declare class DxoRangeSelectorMarkerComponent extends NestedOption implements OnDestroy, OnInit {
    get label(): {
...
export declare class DxoRangeSelectorMarkerModule {
