...
export declare class DxoRangeSelectorSubtitleComponent extends NestedOption implements OnDestroy, OnInit {
    get font(): Font;
    set font(value: Font);
    get offset(): number;
...
export declare class DxoRangeSelectorSubtitleModule {
