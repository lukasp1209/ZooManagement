...
export declare class DxoRangeSelectorFormatComponent extends NestedOption implements OnDestroy, OnInit {
    get currency(): string;
...
export declare class DxoRangeSelectorFormatModule {
