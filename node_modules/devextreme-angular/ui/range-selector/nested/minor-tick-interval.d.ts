...
export declare class DxoRangeSelectorMinorTickIntervalComponent extends NestedOption implements OnDestroy, OnInit {
    get days(): number;
...
export declare class DxoRangeSelectorMinorTickIntervalModule {
