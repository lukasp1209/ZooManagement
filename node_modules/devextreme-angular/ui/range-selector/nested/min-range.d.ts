...
export declare class DxoRangeSelectorMinRangeComponent extends NestedOption implements OnDestroy, OnInit {
    get days(): number;
...
export declare class DxoRangeSelectorMinRangeModule {
