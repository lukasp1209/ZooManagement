...
export declare class DxoRangeSelectorPointImageComponent extends NestedOption implements OnDestroy, OnInit {
    get height(): number | {
...
export declare class DxoRangeSelectorPointImageModule {
