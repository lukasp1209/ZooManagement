...
export declare class DxoRangeSelectorCommonSeriesSettingsComponent extends NestedOption implements OnDestroy, OnInit {
    get aggregation(): {
...
export declare class DxoRangeSelectorCommonSeriesSettingsModule {
