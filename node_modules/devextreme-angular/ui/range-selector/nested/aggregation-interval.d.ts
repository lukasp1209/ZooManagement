...
export declare class DxoRangeSelectorAggregationIntervalComponent extends NestedOption implements OnDestroy, OnInit {
    get days(): number;
...
export declare class DxoRangeSelectorAggregationIntervalModule {
