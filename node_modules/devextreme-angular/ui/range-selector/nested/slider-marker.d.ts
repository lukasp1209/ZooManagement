...
export declare class DxoRangeSelectorSliderMarkerComponent extends NestedOption implements OnDestroy, OnInit {
    get color(): string;
...
export declare class DxoRangeSelectorSliderMarkerModule {
