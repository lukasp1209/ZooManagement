...
export declare class DxoDropDownButtonHideComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDropDownButtonHideComponent, [{ host: true; skipSelf: true; }, { host: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoDropDownButtonHideComponent, "dxo-drop-down-button-hide", never, { "complete": { "alias": "complete"; "required": false; }; "delay": { "alias": "delay"; "required": false; }; "direction": { "alias": "direction"; "required": false; }; "duration": { "alias": "duration"; "required": false; }; "easing": { "alias": "easing"; "required": false; }; "from": { "alias": "from"; "required": false; }; "staggerDelay": { "alias": "staggerDelay"; "required": false; }; "start": { "alias": "start"; "required": false; }; "to": { "alias": "to"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoDropDownButtonHideModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoDropDownButtonHideModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoDropDownButtonHideModule, never, [typeof DxoDropDownButtonHideComponent], [typeof DxoDropDownButtonHideComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxoDropDownButtonHideModule>;
}
