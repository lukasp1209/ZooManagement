...
export declare class DxoSchedulerButtonOptionsComponent extends NestedOption implements AfterViewInit, OnDestroy, OnInit, IDxTemplateHost {
    private renderer;
    private document;
    private element;
...
export declare class DxoSchedulerButtonOptionsModule {
