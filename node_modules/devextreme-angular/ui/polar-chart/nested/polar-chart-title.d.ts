...
export declare class DxoPolarChartPolarChartTitleComponent extends NestedOption implements OnDestroy, OnInit {
    get font(): Font;
    set font(value: Font);
...
export declare class DxoPolarChartPolarChartTitleModule {
