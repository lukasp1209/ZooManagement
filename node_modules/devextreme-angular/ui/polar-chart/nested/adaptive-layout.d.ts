...
export declare class DxoPolarChartAdaptiveLayoutComponent extends NestedOption implements OnDestroy, OnInit {
    get height(): number;
...
export declare class DxoPolarChartAdaptiveLayoutModule {
