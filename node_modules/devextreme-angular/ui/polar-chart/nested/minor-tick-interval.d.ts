...
export declare class DxoPolarChartMinorTickIntervalComponent extends NestedOption implements OnDestroy, OnInit {
    get days(): number;
...
export declare class DxoPolarChartMinorTickIntervalModule {
