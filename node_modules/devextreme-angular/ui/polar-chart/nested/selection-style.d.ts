...
export declare class DxoPolarChartSelectionStyleComponent extends NestedOption implements OnDestroy, OnInit {
    get border(): {
...
export declare class DxoPolarChartSelectionStyleModule {
