...
export declare class DxoPolarChartAnimationComponent extends NestedOption implements OnDestroy, OnInit {
    get duration(): number;
...
export declare class DxoPolarChartAnimationModule {
