...
export declare class DxoPolarChartArgumentAxisTickComponent extends NestedOption implements OnDestroy, OnInit {
    get color(): string;
...
export declare class DxoPolarChartArgumentAxisTickModule {
