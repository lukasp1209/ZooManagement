...
export declare class DxoPolarChartCommonAxisSettingsMinorTickComponent extends NestedOption implements OnDestroy, OnInit {
    get color(): string;
...
export declare class DxoPolarChartCommonAxisSettingsMinorTickModule {
