...
export declare class DxoPolarChartHoverStyleComponent extends NestedOption implements OnDestroy, OnInit {
    get border(): {
...
export declare class DxoPolarChartHoverStyleModule {
