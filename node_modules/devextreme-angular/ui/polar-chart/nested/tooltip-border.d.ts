...
export declare class DxoPolarChartTooltipBorderComponent extends NestedOption implements OnDestroy, OnInit {
    get color(): string;
...
export declare class DxoPolarChartTooltipBorderModule {
