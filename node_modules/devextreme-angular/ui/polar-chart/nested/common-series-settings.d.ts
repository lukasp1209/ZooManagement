...
export declare class DxoPolarChartCommonSeriesSettingsComponent extends NestedOption implements OnDestroy, OnInit {
    get area(): any;
    set area(value: any);
...
export declare class DxoPolarChartCommonSeriesSettingsModule {
