...
export declare class DxoPolarChartArgumentFormatComponent extends NestedOption implements OnDestroy, OnInit {
    get currency(): string;
...
export declare class DxoPolarChartArgumentFormatModule {
