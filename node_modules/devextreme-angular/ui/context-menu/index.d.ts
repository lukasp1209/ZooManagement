...
import * as i2 from "devextreme-angular/ui/context-menu/nested";
 ...
 */
export declare class DxContextMenuComponent<TItem = any, TKey = any> extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    dataSourceChange: EventEmitter<Array<dxContextMenuItem> | DataSource | DataSourceOptions | null | Store | string>;
    /**
     ...
     */
    itemsChange: EventEmitter<Array<any | dxContextMenuItem>>;
    /**
