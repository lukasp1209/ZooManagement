...
export declare class DxoFilterBuilderGroupOperationDescriptionsComponent extends NestedOption implements OnDestroy, OnInit {
    get and(): string;
...
export declare class DxoFilterBuilderGroupOperationDescriptionsModule {
