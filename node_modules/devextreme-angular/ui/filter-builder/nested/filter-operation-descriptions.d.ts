...
export declare class DxoFilterBuilderFilterOperationDescriptionsComponent extends NestedOption implements OnDestroy, OnInit {
    get between(): string;
...
export declare class DxoFilterBuilderFilterOperationDescriptionsModule {
