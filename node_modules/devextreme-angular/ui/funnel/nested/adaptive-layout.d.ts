...
export declare class DxoFunnelAdaptiveLayoutComponent extends NestedOption implements OnDestroy, OnInit {
    get height(): number;
...
export declare class DxoFunnelAdaptiveLayoutModule {
