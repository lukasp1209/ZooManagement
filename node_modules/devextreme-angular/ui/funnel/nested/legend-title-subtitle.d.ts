...
export declare class DxoFunnelLegendTitleSubtitleComponent extends NestedOption implements OnDestroy, OnInit {
    get font(): Font;
    set font(value: Font);
    get offset(): number;
...
export declare class DxoFunnelLegendTitleSubtitleModule {
