...
export declare class DxoAutocompleteToComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoAutocompleteToComponent, "dxo-autocomplete-to", never, { "left": { "alias": "left"; "required": false; }; "opacity": { "alias": "opacity"; "required": false; }; "position": { "alias": "position"; "required": false; }; "scale": { "alias": "scale"; "required": false; }; "top": { "alias": "top"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoAutocompleteToModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoAutocompleteToModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoAutocompleteToModule, never, [typeof DxoAutocompleteToComponent], [typeof DxoAutocompleteToComponent]>;
