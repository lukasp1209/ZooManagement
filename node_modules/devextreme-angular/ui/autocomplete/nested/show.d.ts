...
export declare class DxoAutocompleteShowComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoAutocompleteShowComponent, [{ host: true; skipSelf: true; }, { host: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoAutocompleteShowComponent, "dxo-autocomplete-show", never, { "complete": { "alias": "complete"; "required": false; }; "delay": { "alias": "delay"; "required": false; }; "direction": { "alias": "direction"; "required": false; }; "duration": { "alias": "duration"; "required": false; }; "easing": { "alias": "easing"; "required": false; }; "from": { "alias": "from"; "required": false; }; "staggerDelay": { "alias": "staggerDelay"; "required": false; }; "start": { "alias": "start"; "required": false; }; "to": { "alias": "to"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoAutocompleteShowModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoAutocompleteShowModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoAutocompleteShowModule, never, [typeof DxoAutocompleteShowComponent], [typeof DxoAutocompleteShowComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxoAutocompleteShowModule>;
}
