...
export declare class DxoAutocompleteHideComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoAutocompleteHideComponent, [{ host: true; skipSelf: true; }, { host: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoAutocompleteHideComponent, "dxo-autocomplete-hide", never, { "complete": { "alias": "complete"; "required": false; }; "delay": { "alias": "delay"; "required": false; }; "direction": { "alias": "direction"; "required": false; }; "duration": { "alias": "duration"; "required": false; }; "easing": { "alias": "easing"; "required": false; }; "from": { "alias": "from"; "required": false; }; "staggerDelay": { "alias": "staggerDelay"; "required": false; }; "start": { "alias": "start"; "required": false; }; "to": { "alias": "to"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoAutocompleteHideModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoAutocompleteHideModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoAutocompleteHideModule, never, [typeof DxoAutocompleteHideComponent], [typeof DxoAutocompleteHideComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxoAutocompleteHideModule>;
}
