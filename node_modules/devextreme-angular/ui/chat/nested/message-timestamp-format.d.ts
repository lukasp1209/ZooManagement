...
export declare class DxoChatMessageTimestampFormatComponent extends NestedOption implements OnDestroy, OnInit {
    get currency(): string;
...
export declare class DxoChatMessageTimestampFormatModule {
