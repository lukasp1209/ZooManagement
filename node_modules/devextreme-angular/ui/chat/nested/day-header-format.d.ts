...
export declare class DxoChatDayHeaderFormatComponent extends NestedOption implements OnDestroy, OnInit {
    get currency(): string;
...
export declare class DxoChatDayHeaderFormatModule {
