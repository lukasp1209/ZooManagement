...
export declare class DxoTagBoxShowComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoTagBoxShowComponent, [{ host: true; skipSelf: true; }, { host: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoTagBoxShowComponent, "dxo-tag-box-show", never, { "complete": { "alias": "complete"; "required": false; }; "delay": { "alias": "delay"; "required": false; }; "direction": { "alias": "direction"; "required": false; }; "duration": { "alias": "duration"; "required": false; }; "easing": { "alias": "easing"; "required": false; }; "from": { "alias": "from"; "required": false; }; "staggerDelay": { "alias": "staggerDelay"; "required": false; }; "start": { "alias": "start"; "required": false; }; "to": { "alias": "to"; "required": false; }; "type": { "alias": "type"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoTagBoxShowModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoTagBoxShowModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoTagBoxShowModule, never, [typeof DxoTagBoxShowComponent], [typeof DxoTagBoxShowComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxoTagBoxShowModule>;
}
