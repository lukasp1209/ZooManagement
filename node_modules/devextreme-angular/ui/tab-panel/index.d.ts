...
import * as i2 from "devextreme-angular/ui/tab-panel/nested";
...
export declare class DxTabPanelComponent<TItem = any, TKey = any> extends DxComponent implements OnDestroy, OnChanges, DoCheck {
     ...
     */
    dataSourceChange: EventEmitter<Array<any | dxTabPanelItem | string> | DataSource | DataSourceOptions | null | Store | string>;
    /**
