...
export declare class DxoVectorMapLegendTitleSubtitleComponent extends NestedOption implements OnDestroy, OnInit {
    get font(): Font;
    set font(value: Font);
    get offset(): number;
...
export declare class DxoVectorMapLegendTitleSubtitleModule {
