...
export declare class DxoVectorMapAnnotationBorderComponent extends NestedOption implements OnDestroy, OnInit {
    get color(): string;
...
export declare class DxoVectorMapAnnotationBorderModule {
