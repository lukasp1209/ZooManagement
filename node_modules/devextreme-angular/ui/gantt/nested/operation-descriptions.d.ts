...
export declare class DxoGanttOperationDescriptionsComponent extends NestedOption implements OnDestroy, OnInit {
    get between(): string;
...
export declare class DxoGanttOperationDescriptionsModule {
