...
export declare class DxoGanttAIComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    ngOnInit(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoGanttAIComponent, [{ host: true; skipSelf: true; }, { host: true; }]>;
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoGanttAIComponent, "dxo-gantt-ai", never, { "aiIntegration": { "alias": "aiIntegration"; "required": false; }; "editorOptions": { "alias": "editorOptions"; "required": false; }; "emptyText": { "alias": "emptyText"; "required": false; }; "mode": { "alias": "mode"; "required": false; }; "noDataText": { "alias": "noDataText"; "required": false; }; "popup": { "alias": "popup"; "required": false; }; "prompt": { "alias": "prompt"; "required": false; }; "showHeaderMenu": { "alias": "showHeaderMenu"; "required": false; }; }, {}, never, never, true, never>;
}
export declare class DxoGanttAIModule {
    static ɵfac: i0.ɵɵFactoryDeclaration<DxoGanttAIModule, never>;
    static ɵmod: i0.ɵɵNgModuleDeclaration<DxoGanttAIModule, never, [typeof DxoGanttAIComponent], [typeof DxoGanttAIComponent]>;
    static ɵinj: i0.ɵɵInjectorDeclaration<DxoGanttAIModule>;
}
