...
export declare class DxoGanttColumnHeaderFilterSearchComponent extends NestedOption implements OnDestroy, OnInit {
...
export declare class DxoGanttColumnHeaderFilterSearchModule {
