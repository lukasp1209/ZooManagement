...
export declare class DxoSpeechToTextCustomSpeechRecognizerComponent extends NestedOption implements OnDestroy, OnInit {
    get enabled(): boolean;
...
export declare class DxoSpeechToTextCustomSpeechRecognizerModule {
