 ...
 */
class DxPaginationComponent extends DxComponent {
    _watcherHelper;
    _idh;
    instance = null;
    /**
...
export { DxPaginationComponent, DxPaginationModule };
//# sourceMappingURL=devextreme-angular-ui-pagination.mjs.map
