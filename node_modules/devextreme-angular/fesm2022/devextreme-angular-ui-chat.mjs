...
import { DxiAlertModule, DxoDayHeaderFormatModule, DxoEditingModule, DxiItemModule, DxoAuthorModule, DxoMessageTimestampFormatModule, DxiTypingUserModule, DxoUserModule } from 'devextreme-angular/ui/nested';
import { DxiChatAlertModule, DxiChatAttachmentModule, DxoChatAuthorModule, DxoChatDayHeaderFormatModule, DxoChatEditingModule, DxoChatFileUploaderOptionsModule, DxiChatItemModule, DxoChatMessageTimestampFormatModule, DxiChatTypingUserModule, DxoChatUserModule } from 'devextreme-angular/ui/chat/nested';
...
class DxChatComponent extends DxComponent {
    _watcherHelper;
    _idh;
    set _alertsContentChildren(value) {
    ...
    set _typingUsersContentChildren(value) {
     ...
     */
    get emptyViewTemplate() {
        return this._getOption('emptyViewTemplate');
    }
    set emptyViewTemplate(value) {
     ...
     */
    emptyViewTemplateChange;
    /**
    
     * This member supports the internal infrastructure and is not intended to be used directly from your code.
    
     */
    fileUploaderOptionsChange;
    /**
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxChatComponent, decorators: [{
            ...
            args: [{
                    ...
                    type: Inject,
                    args: [PLATFORM_ID]
                }] }], propDecorators: { _alertsContentChildren: [{
                type: ContentChildren,
                args: [PROPERTY_TOKEN_alerts]
            }], _attachmentsContentChildren: [{
                type: ContentChildren,
                args: [PROPERTY_TOKEN_attachments]
            }], _itemsContentChildren: [{
                type: ContentChildren,
                args: [PROPERTY_TOKEN_items]
            }], _typingUsersContentChildren: [{
                type: ContentChildren,
                args: [PROPERTY_TOKEN_typingUsers]
            }], accessKey: [{
                type: Input
            }], activeStateEnabled: [{
                type: Input
