...
import { forwardRef, PLATFORM_ID, Component, Inject, ContentChildren, Input, Output, HostListener, NgModule } from '@angular/core';
import DxDropDownBox from 'devextreme/ui/drop_down_box';
import { NG_VALUE_ACCESSOR } from '@angular/forms';
import * as i1 from 'devextreme-angular/core';
import { DxComponent, DxTemplateHost, WatcherHelper, NestedOptionHost, IterableDifferHelper, DxIntegrationModule, DxTemplateModule } from 'devextreme-angular/core';
import { DxiButtonModule, DxoOptionsModule, DxoDropDownOptionsModule, DxoAnimationModule, DxoHideModule, DxoFromModule, DxoPositionModule, DxoAtModule, DxoBoundaryOffsetModule, DxoCollisionModule, DxoMyModule, DxoOffsetModule, DxoToModule, DxoShowModule, DxiItemModule } from 'devextreme-angular/ui/nested';
import { DxoDropDownBoxAnimationModule, DxoDropDownBoxAtModule, DxoDropDownBoxBoundaryOffsetModule, DxiDropDownBoxButtonModule, DxoDropDownBoxCollisionModule, DxoDropDownBoxDropDownOptionsModule, DxoDropDownBoxFieldAddonsModule, DxoDropDownBoxFromModule, DxoDropDownBoxHideModule, DxoDropDownBoxMyModule, DxoDropDownBoxOffsetModule, DxoDropDownBoxOptionsModule, DxoDropDownBoxPositionModule, DxoDropDownBoxShowModule, DxoDropDownBoxToModule, DxiDropDownBoxToolbarItemModule } from 'devextreme-angular/ui/drop-down-box/nested';
...
class DxDropDownBoxModule {
    /** @nocollapse */ static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxDropDownBoxModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxDropDownBoxModule, imports: [DxDropDownBoxComponent, DxiButtonModule,
            DxoOptionsModule,
            ...
            DxiDropDownBoxToolbarItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxDropDownBoxModule, imports: [DxDropDownBoxComponent,
            DxiButtonModule,
            DxoOptionsModule,
            DxoDropDownOptionsModule,
            DxoAnimationModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxDropDownBoxModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
...
//# sourceMappingURL=devextreme-angular-ui-drop-down-box.mjs.map
