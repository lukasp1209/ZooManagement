...
import { DxiButtonModule, DxoOptionsModule, DxoDropDownOptionsModule, DxoAnimationModule, DxoHideModule, DxoFromModule, DxoPositionModule, DxoAtModule, DxoBoundaryOffsetModule, DxoCollisionModule, DxoMyModule, DxoOffsetModule, DxoToModule, DxoShowModule } from 'devextreme-angular/ui/nested';
import { DxoColorBoxAnimationModule, DxoColorBoxAtModule, DxoColorBoxBoundaryOffsetModule, DxiColorBoxButtonModule, DxoColorBoxCollisionModule, DxoColorBoxDropDownOptionsModule, DxoColorBoxFieldAddonsModule, DxoColorBoxFromModule, DxoColorBoxHideModule, DxoColorBoxMyModule, DxoColorBoxOffsetModule, DxoColorBoxOptionsModule, DxoColorBoxPositionModule, DxoColorBoxShowModule, DxoColorBoxToModule, DxiColorBoxToolbarItemModule } from 'devextreme-angular/ui/color-box/nested';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxColorBoxComponent, decorators: [{
            type: Component,
            args: [{
...
class DxColorBoxModule {
    /** @nocollapse */ static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxColorBoxModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    /** @nocollapse */ static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.3.12", ngImport: i0, type: DxColorBoxModule, imports: [DxColorBoxComponent, DxiButtonModule,
            DxoOptionsModule,
            ...
            DxiColorBoxToolbarItemModule,
            DxTemplateModule] });
    /** @nocollapse */ static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxColorBoxModule, imports: [DxColorBoxComponent,
            DxiButtonModule,
            DxoOptionsModule,
            DxoDropDownOptionsModule,
            DxoAnimationModule,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.3.12", ngImport: i0, type: DxColorBoxModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        DxColorBoxComponent,
...
//# sourceMappingURL=devextreme-angular-ui-color-box.mjs.map
