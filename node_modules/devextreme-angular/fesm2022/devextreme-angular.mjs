...
import { Guid, config, setTemplateEngine } from 'devextreme/common';
...
import { ArrayStore, CustomStore, DataSource, EdmLiteral, EndpointSelector, LocalStore, ODataContext, ODataStore, applyChanges, base64_encode, compileGetter, compileSetter, errorHandler, isGroupItemsArray, isItemsArray, isLoadResultObject, keyConverters, query, setErrorHandler } from 'devextreme/common/data';
...
export { index as Common, DevExtremeModule };
