...
function resolveTypeScript() {
    ...
    try {
        ...
        errors.push(`Failed to import TypeScript from project: ${(err === null || err === void 0 ? void 0 : err.message) || err}`);
    }
    try {
        ...
        errors.push(`Failed to import TypeScript from global node_modules: ${(err === null || err === void 0 ? void 0 : err.message) || err}`);
    }
    try {
        ...
        errors.push(`Failed to import TypeScript from temporary installation (npm cache): ${(err === null || err === void 0 ? void 0 : err.message) || err}`);
    }
    return {
        ts: null,
