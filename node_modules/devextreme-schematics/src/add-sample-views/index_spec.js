...
describe('sample views', () => {
    ...
    it('should add sample views', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        tree = yield runner.runSchematic('add-sample-views', sampleViewsOptions, tree);
        ...
        expect(navigationContent).toContain(`type NavigationItem = { path?: string, text: string, icon?: string, items?: NavigationItem[] };
