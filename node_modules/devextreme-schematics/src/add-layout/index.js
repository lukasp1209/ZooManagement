...
function addPolyfills(host, project, polyfills) {
    return __awaiter(this, void 0, void 0, function* () {
        const projectName = yield (0, project_1.getProjectName)(host, project);
        (0, modify_json_file_1.modifyJSONFile)(host, './angular.json', config => {
...
function updateAppComponent(sourcePath, templateOptions = {}) {
...
function addPackagesToDependency(globalNgCliVersion) {
    ...
    return (host) => {
        const zonejs = (0, dependencies_1.getPackageJsonDependency)(host, 'zone.js');
