...
describe('layout', () => {
    ...
    it('should add layout with override', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const tree = yield runner.runSchematic('add-layout', options, appTree);
        expect(tree.files)
    ...
    it('should update budgets if updateBudgets option is true', () => __awaiter(void 0, void 0, void 0, function* () {
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        const tree = yield runner.runSchematic('add-layout', Object.assign(Object.assign({}, options), { updateBudgets: true }), appTree);
        const angularContent = JSON.parse(tree.readContent('/angular.json'));
    ...
    it('should add routing to layout', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(loginFormComponentMatch === null || loginFormComponentMatch === void 0 ? void 0 : loginFormComponentMatch.length).toBe(2);
        expect(resetPasswordFormComponentMatch === null || resetPasswordFormComponentMatch === void 0 ? void 0 : resetPasswordFormComponentMatch.length).toBe(2);
        expect(createAccountFormComponentMatch === null || createAccountFormComponentMatch === void 0 ? void 0 : createAccountFormComponentMatch.length).toBe(2);
        expect(changePasswordFormComponentMatch === null || changePasswordFormComponentMatch === void 0 ? void 0 : changePasswordFormComponentMatch.length).toBe(2);
        expect(routesContent)
    ...
    it('should consider the `project` option', () => __awaiter(void 0, void 0, void 0, function* () {
        appTree = yield schematicRunner.runSchematic('application', Object.assign(Object.assign({}, appOptions), { name: 'testApp2', projectRoot: 'projects/testApp2', standalone: false }), appTree);
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        const tree = yield runner.runSchematic('add-layout', Object.assign(Object.assign({}, options), { project: 'testApp2' }), appTree);
        expect(tree.files)
            .toContain('/devextreme.json');
        expect(tree.files)
    ...
    it('should merge build commands in devextreme.json file', () => __awaiter(void 0, void 0, void 0, function* () {
        appTree = yield schematicRunner.runSchematic('application', Object.assign(Object.assign({}, appOptions), { name: 'testApp2', prefix: 'app2', projectRoot: 'projects/testApp2', standalone: false }), appTree);
        const runner = new testing_1.SchematicTestRunner('schematics', collectionPath);
        let tree = yield runner.runSchematic('add-layout', options, appTree);
        tree = yield runner.runSchematic('add-layout', Object.assign(Object.assign({}, options), { project: 'testApp2' }), appTree);
