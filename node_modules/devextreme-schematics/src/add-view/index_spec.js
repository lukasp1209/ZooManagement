...
describe('view', () => {
    ...
    it('should add view to navigation', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(moduleContent).toContain(`type NavigationItem = { path?: string, text: string, icon?: string, items?: NavigationItem[] };
